 ...
 *
 */
public class OracleDBImpl extends DatabaseImpl
{
	private static final Log log = LogFactory.getLog(OracleDBImpl.class);
	...
	public DBCallResult callSql(java.sql.Connection connection,String strCommand, SqlParamList list, int nTimeOut)
	{
		...
		try
		{
			...
			OracleDataSetImpl dataSet = new OracleDataSetImpl(conn,cstmt);
			while (true)
			{
