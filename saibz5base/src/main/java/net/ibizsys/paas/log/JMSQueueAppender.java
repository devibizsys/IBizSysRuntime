...
//			TextMessage message = session.createTextMessage(getTextMessage(event));
...
//	
	...
	/**
	 * @param strLoggerParam
	 *            the strLoggerParam to set
	 */
	...
	/**
	 * @param strLoggerParam2
	 *            the strLoggerParam2 to set
	 */
	...
	/**
	 * @param strLoggerParam3
	 *            the strLoggerParam3 to set
	 */
	...
	/**
	 * @param strLoggerParam4
	 *            the strLoggerParam4 to set
	 */
