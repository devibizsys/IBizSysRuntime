...
public class CtrlItemHandlerBase implements ICtrlItemHandler
{
	...
	/**
	 * 设置部件处理对象
	 * @param iCtrlHandler the iCtrlHandler to set
	 */
	...
	protected Object getBean(String strName)
	{
		WebApplicationContext ctx = WebApplicationContextUtils.  
				getRequiredWebApplicationContext(getWebContext().getRequest().getSession().getServletContext()); 
