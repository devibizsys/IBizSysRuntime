...
public abstract class BackendServiceBase extends TimerTask  implements IBackendService
{
	...
	public void init(Service service) throws Exception
	{
		...
		try
		{
			if(!StringHelper.isNullOrEmpty(service.getServiceParam()))
				serviceParams = PropertiesHelper.load(service.getServiceParam());
		}
		catch (Exception e)
		{
	 ...
	 */
	@Override
	public boolean isStarted(){return this.bStart;}
	
	/* (non-Javadoc)
	 * @see net.ibizsys.paas.sysmodel.IBackendService#getServiceId()
	 */
	@Override
	public String getServiceId(){return this.service.getServiceId();}
	 ...
	 */
	@Override
	public String getServiceName(){return this.service.getServiceName();}
