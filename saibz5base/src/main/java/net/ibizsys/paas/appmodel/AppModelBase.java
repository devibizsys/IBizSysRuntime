...
public abstract class AppModelBase extends ModelBaseImpl implements IApplicationModel
{
	 ...
	 */
	@Override
	public AjaxActionResult doFilterViewAction(IViewController iViewController, HttpServletRequest request, HttpServletResponse response, String strAction, AjaxActionResult ajaxActionResult)
			throws Exception
	{
