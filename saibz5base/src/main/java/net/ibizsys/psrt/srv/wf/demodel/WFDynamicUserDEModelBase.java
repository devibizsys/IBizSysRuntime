...
import net.ibizsys.psrt.srv.wf.demodel.wfdynamicuser.ac.*;
import net.ibizsys.psrt.srv.wf.demodel.wfdynamicuser.dataset.*;
import net.ibizsys.psrt.srv.wf.demodel.wfdynamicuser.dataquery.*;

import net.ibizsys.psrt.srv.wf.entity.WFDynamicUser;
import net.ibizsys.psrt.srv.wf.service.WFDynamicUserService;

/**
 * 实体[WFDYNAMICUSER]模型对象基类
 */
public abstract class WFDynamicUserDEModelBase extends net.ibizsys.paas.demodel.DataEntityModelBase<WFDynamicUser>  {
    ...
    public  WFDynamicUserService getRealService() {
        if(this.wFDynamicUserService==null) {
            try {
                this.wFDynamicUserService = (WFDynamicUserService)ServiceGlobal.getService(getServiceId());
            } catch(Exception ex) {
            }
        }
    ...
    */
    ...
    protected void onFillFetchQuickSearchConditions(DEDataSetCond groupCondImpl,String strQuickSearch)  throws Exception {
        ...
        //放入属性 WFDYNAMICUSERNAME - 工作流动态用户名称
        if(true) {
            DEDataSetCond deDataSetCondImpl = new DEDataSetCond();
            deDataSetCondImpl.setCondType(IDEDataSetCond.CONDTYPE_DEFIELD);
            deDataSetCondImpl.setCondOp(ICondition.CONDOP_LIKE);
            deDataSetCondImpl.setDEFName(WFDynamicUser.FIELD_WFDYNAMICUSERNAME);
