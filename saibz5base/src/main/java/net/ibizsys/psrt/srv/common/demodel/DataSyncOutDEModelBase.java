...
import net.ibizsys.psrt.srv.common.demodel.datasyncout.ac.*;
import net.ibizsys.psrt.srv.common.demodel.datasyncout.dataset.*;
import net.ibizsys.psrt.srv.common.demodel.datasyncout.dataquery.*;

import net.ibizsys.psrt.srv.common.entity.DataSyncOut;
import net.ibizsys.psrt.srv.common.service.DataSyncOutService;

/**
 * 实体[DATASYNCOUT]模型对象基类
 */
public abstract class DataSyncOutDEModelBase extends net.ibizsys.paas.demodel.DataEntityModelBase<DataSyncOut>  {
    ...
    public  DataSyncOutService getRealService() {
        if(this.dataSyncOutService==null) {
            try {
                this.dataSyncOutService = (DataSyncOutService)ServiceGlobal.getService(getServiceId());
            } catch(Exception ex) {
            }
        }
    ...
    protected void prepareDEFields() throws Exception {
        ...
        if(iDEField==null) {
            ...
            deFieldModel.setLogicName("数据同步发送队列名称");
            deFieldModel.setDataType("TEXT");
            deFieldModel.setStdDataType(25);
    ...
    */
    ...
    protected void onFillFetchQuickSearchConditions(DEDataSetCond groupCondImpl,String strQuickSearch)  throws Exception {
        ...
        //放入属性 DATASYNCOUTNAME - 数据同步发送队列名称
        if(true) {
            DEDataSetCond deDataSetCondImpl = new DEDataSetCond();
            deDataSetCondImpl.setCondType(IDEDataSetCond.CONDTYPE_DEFIELD);
            deDataSetCondImpl.setCondOp(ICondition.CONDOP_LIKE);
            deDataSetCondImpl.setDEFName(DataSyncOut.FIELD_DATASYNCOUTNAME);
