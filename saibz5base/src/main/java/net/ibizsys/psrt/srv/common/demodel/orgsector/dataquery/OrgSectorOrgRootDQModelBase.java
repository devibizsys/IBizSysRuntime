...
@DEDataQuery(id="6ACE493E-3CE2-4285-AC2D-D94775248FF4",name="OrgRoot")
@DEDataQueryCodes({
    ...
    conds={
        @DEDataQueryCodeCond(condition="( t1.ORGID =  ${srfdatacontext('nodeid','{\"defname\":\"ORGID\",\"dename\":\"ORGSECTOR\"}')}  AND  t1.PORGSECTORID IS NULL )")
    }),
 ...
 *  实体数据查询 [组织根部门]模型基类
 */
public abstract class OrgSectorOrgRootDQModelBase extends net.ibizsys.paas.demodel.DEDataQueryModelBase {

    public OrgSectorOrgRootDQModelBase() {
        super();

        this.initAnnotation(OrgSectorOrgRootDQModelBase.class);
    }
