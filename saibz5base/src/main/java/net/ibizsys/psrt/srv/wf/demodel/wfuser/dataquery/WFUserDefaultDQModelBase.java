...
@DEDataQueryCodes({
    @DEDataQueryCode(querycode="SELECT t1.CREATEDATE AS CREATEDATE, t1.CREATEMAN AS CREATEMAN, t1.ISRECVWORK AS ISRECVWORK, t1.MEMO AS MEMO, t1.RECVINFORM AS RECVINFORM, t1.UPDATEDATE AS UPDATEDATE, t1.UPDATEMAN AS UPDATEMAN, t1.VALIDFLAG AS VALIDFLAG, t1.WFUSERID AS WFUSERID, t1.WFUSERNAME AS WFUSERNAME FROM T_SRFWFUSER t1 ",querycodetemp="",declarecode="",dbtype="DB2",
    fieldexps={
    ...
    conds={}),
    @DEDataQueryCode(querycode="SELECT t1.CREATEDATE AS CREATEDATE, t1.CREATEMAN AS CREATEMAN, t1.ISRECVWORK AS ISRECVWORK, t1.MEMO AS MEMO, t1.RECVINFORM AS RECVINFORM, t1.UPDATEDATE AS UPDATEDATE, t1.UPDATEMAN AS UPDATEMAN, t1.VALIDFLAG AS VALIDFLAG, t1.WFUSERID AS WFUSERID, t1.WFUSERNAME AS WFUSERNAME FROM T_SRFWFUSER t1 ",querycodetemp="",declarecode="",dbtype="MYSQL5",
    fieldexps={
        @DEDataQueryCodeExp(name="CREATEDATE",expression="t1.CREATEDATE")
        ,@DEDataQueryCodeExp(name="CREATEMAN",expression="t1.CREATEMAN")
        ,@DEDataQueryCodeExp(name="ISRECVWORK",expression="t1.ISRECVWORK")
    ...
    conds={}),
    @DEDataQueryCode(querycode="SELECT t1.CREATEDATE AS CREATEDATE, t1.CREATEMAN AS CREATEMAN, t1.ISRECVWORK AS ISRECVWORK, t1.MEMO AS MEMO, t1.RECVINFORM AS RECVINFORM, t1.UPDATEDATE AS UPDATEDATE, t1.UPDATEMAN AS UPDATEMAN, t1.VALIDFLAG AS VALIDFLAG, t1.WFUSERID AS WFUSERID, t1.WFUSERNAME AS WFUSERNAME FROM T_SRFWFUSER t1 ",querycodetemp="",declarecode="",dbtype="ORACLE",
    fieldexps={
        @DEDataQueryCodeExp(name="CREATEDATE",expression="t1.CREATEDATE")
        ,@DEDataQueryCodeExp(name="CREATEMAN",expression="t1.CREATEMAN")
        ,@DEDataQueryCodeExp(name="ISRECVWORK",expression="t1.ISRECVWORK")
    ...
    conds={}),
    @DEDataQueryCode(querycode="SELECT t1.CREATEDATE AS CREATEDATE, t1.CREATEMAN AS CREATEMAN, t1.ISRECVWORK AS ISRECVWORK, t1.MEMO AS MEMO, t1.RECVINFORM AS RECVINFORM, t1.UPDATEDATE AS UPDATEDATE, t1.UPDATEMAN AS UPDATEMAN, t1.VALIDFLAG AS VALIDFLAG, t1.WFUSERID AS WFUSERID, t1.WFUSERNAME AS WFUSERNAME FROM T_SRFWFUSER t1 ",querycodetemp="",declarecode="",dbtype="SQLSERVER",
    fieldexps={
        @DEDataQueryCodeExp(name="CREATEDATE",expression="t1.CREATEDATE")
        ,@DEDataQueryCodeExp(name="CREATEMAN",expression="t1.CREATEMAN")
        ,@DEDataQueryCodeExp(name="ISRECVWORK",expression="t1.ISRECVWORK")
