...
/**
 * 实体[UserRoleData] DAO对象基类
 */
public abstract class UserRoleDataDAOBase extends net.ibizsys.psrt.srv.PSRuntimeSysDAOBase<UserRoleData> {

    private static final long serialVersionUID = -1L;

    public UserRoleDataDAOBase() {
        super();
