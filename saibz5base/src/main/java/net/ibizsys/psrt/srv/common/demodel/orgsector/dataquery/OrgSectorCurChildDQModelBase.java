...
@DEDataQuery(id="737DF19D-614C-4DFE-9E6A-277CFC934EF8",name="CurChild")
@DEDataQueryCodes({
    ...
    conds={
        @DEDataQueryCodeCond(condition="( t1.PORGSECTORID =  ${srfdatacontext('nodeid','{\"defname\":\"PORGSECTORID\",\"dename\":\"ORGSECTOR\"}')} )")
    }),
 ...
 *  实体数据查询 [当前子部门]模型基类
 */
public abstract class OrgSectorCurChildDQModelBase extends net.ibizsys.paas.demodel.DEDataQueryModelBase {

    public OrgSectorCurChildDQModelBase() {
        super();

        this.initAnnotation(OrgSectorCurChildDQModelBase.class);
    }
