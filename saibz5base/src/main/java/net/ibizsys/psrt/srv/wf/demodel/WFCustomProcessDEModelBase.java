...
import net.ibizsys.psrt.srv.wf.demodel.wfcustomprocess.ac.*;
import net.ibizsys.psrt.srv.wf.demodel.wfcustomprocess.dataset.*;
import net.ibizsys.psrt.srv.wf.demodel.wfcustomprocess.dataquery.*;

import net.ibizsys.psrt.srv.wf.entity.WFCustomProcess;
import net.ibizsys.psrt.srv.wf.service.WFCustomProcessService;

/**
 * 实体[WFCUSTOMPROCESS]模型对象基类
 */
public abstract class WFCustomProcessDEModelBase extends net.ibizsys.paas.demodel.DataEntityModelBase<WFCustomProcess>  {
    ...
    public  WFCustomProcessService getRealService() {
        if(this.wFCustomProcessService==null) {
            try {
                this.wFCustomProcessService = (WFCustomProcessService)ServiceGlobal.getService(getServiceId());
            } catch(Exception ex) {
            }
        }
    ...
    */
    ...
    protected void onFillFetchQuickSearchConditions(DEDataSetCond groupCondImpl,String strQuickSearch)  throws Exception {
        ...
        //放入属性 WFCUSTOMPROCESSNAME - 工作流预定义处理名称
        if(true) {
            DEDataSetCond deDataSetCondImpl = new DEDataSetCond();
            deDataSetCondImpl.setCondType(IDEDataSetCond.CONDTYPE_DEFIELD);
            deDataSetCondImpl.setCondOp(ICondition.CONDOP_LIKE);
            deDataSetCondImpl.setDEFName(WFCustomProcess.FIELD_WFCUSTOMPROCESSNAME);
