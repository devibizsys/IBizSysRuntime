...
import net.ibizsys.psrt.srv.wf.demodel.wfactor.ac.*;
import net.ibizsys.psrt.srv.wf.demodel.wfactor.dataset.*;
import net.ibizsys.psrt.srv.wf.demodel.wfactor.dataquery.*;
 ...
 * 实体[WFACTOR]模型对象基类
 */
public abstract class WFActorDEModelBase extends net.ibizsys.paas.demodel.DataEntityModelBase<WFActor>  {
    ...
    */
    ...
    protected void onFillFetchQuickSearchConditions(DEDataSetCond groupCondImpl,String strQuickSearch)  throws Exception {
        ...
        //放入属性 WFACTORNAME - 工作流操作者名称
        if(true) {
            DEDataSetCond deDataSetCondImpl = new DEDataSetCond();
            deDataSetCondImpl.setCondType(IDEDataSetCond.CONDTYPE_DEFIELD);
            deDataSetCondImpl.setCondOp(ICondition.CONDOP_LIKE);
            deDataSetCondImpl.setDEFName(WFActor.FIELD_WFACTORNAME);
