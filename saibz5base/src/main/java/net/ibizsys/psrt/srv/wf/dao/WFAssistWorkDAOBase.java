...
/**
 * 实体[WFAssistWork] DAO对象基类
 */
public abstract class WFAssistWorkDAOBase extends net.ibizsys.psrt.srv.PSRuntimeSysDAOBase<WFAssistWork> {

    private static final long serialVersionUID = -1L;

    public WFAssistWorkDAOBase() {
        super();
