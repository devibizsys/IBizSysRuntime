...
@DEDataQueryCodes({
    @DEDataQueryCode(querycode="SELECT t1.CREATEDATE AS CREATEDATE, t1.CREATEMAN AS CREATEMAN, t1.DATAKEY AS DATAKEY, t1.DEDATACHG2ID AS DEDATACHG2ID, t1.DEDATACHG2NAME AS DEDATACHG2NAME, t1.DEID AS DEID, t1.DENAME AS DENAME, t1.ERROR AS ERROR, t1.EVENTTYPE AS EVENTTYPE, t1.UPDATEDATE AS UPDATEDATE, t1.UPDATEMAN AS UPDATEMAN FROM T_SRFDEDATACHG2 t1 ",querycodetemp="",declarecode="",dbtype="DB2",
    fieldexps={
    ...
    conds={}),
    @DEDataQueryCode(querycode="SELECT t1.`CREATEDATE` AS `CREATEDATE`, t1.`CREATEMAN` AS `CREATEMAN`, t1.`DATAKEY` AS `DATAKEY`, t1.`DEDATACHG2ID` AS `DEDATACHG2ID`, t1.`DEDATACHG2NAME` AS `DEDATACHG2NAME`, t1.`DEID` AS `DEID`, t1.`DENAME` AS `DENAME`, t1.`ERROR` AS `ERROR`, t1.`EVENTTYPE` AS `EVENTTYPE`, t1.`UPDATEDATE` AS `UPDATEDATE`, t1.`UPDATEMAN` AS `UPDATEMAN` FROM `T_SRFDEDATACHG2` t1 ",querycodetemp="",declarecode="",dbtype="MYSQL5",
    fieldexps={
        @DEDataQueryCodeExp(name="DATA",expression="t1.`DATA`")
        ,@DEDataQueryCodeExp(name="DISPERROR",expression="t1.`DISPERROR`")
        ,@DEDataQueryCodeExp(name="LOGICDATA",expression="t1.`LOGICDATA`")
    ...
    conds={}),
    @DEDataQueryCode(querycode="SELECT t1.CREATEDATE AS CREATEDATE, t1.CREATEMAN AS CREATEMAN, t1.DATAKEY AS DATAKEY, t1.DEDATACHG2ID AS DEDATACHG2ID, t1.DEDATACHG2NAME AS DEDATACHG2NAME, t1.DEID AS DEID, t1.DENAME AS DENAME, t1.ERROR AS ERROR, t1.EVENTTYPE AS EVENTTYPE, t1.UPDATEDATE AS UPDATEDATE, t1.UPDATEMAN AS UPDATEMAN FROM T_SRFDEDATACHG2 t1 ",querycodetemp="",declarecode="",dbtype="ORACLE",
    fieldexps={
        @DEDataQueryCodeExp(name="DATA",expression="t1.DATA")
        ,@DEDataQueryCodeExp(name="DISPERROR",expression="t1.DISPERROR")
        ,@DEDataQueryCodeExp(name="LOGICDATA",expression="t1.LOGICDATA")
    ...
    conds={}),
    @DEDataQueryCode(querycode="SELECT t1.[CREATEDATE] AS [CREATEDATE], t1.[CREATEMAN] AS [CREATEMAN], t1.[DATAKEY] AS [DATAKEY], t1.[DEDATACHG2ID] AS [DEDATACHG2ID], t1.[DEDATACHG2NAME] AS [DEDATACHG2NAME], t1.[DEID] AS [DEID], t1.[DENAME] AS [DENAME], t1.[ERROR] AS [ERROR], t1.[EVENTTYPE] AS [EVENTTYPE], t1.[UPDATEDATE] AS [UPDATEDATE], t1.[UPDATEMAN] AS [UPDATEMAN] FROM [T_SRFDEDATACHG2] t1 ",querycodetemp="",declarecode="",dbtype="SQLSERVER",
    fieldexps={
        @DEDataQueryCodeExp(name="DATA",expression="t1.[DATA]")
        ,@DEDataQueryCodeExp(name="DISPERROR",expression="t1.[DISPERROR]")
        ,@DEDataQueryCodeExp(name="LOGICDATA",expression="t1.[LOGICDATA]")
