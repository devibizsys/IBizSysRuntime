...
import net.ibizsys.psrt.srv.wf.demodel.wfstepactor.ac.*;
import net.ibizsys.psrt.srv.wf.demodel.wfstepactor.dataset.*;
import net.ibizsys.psrt.srv.wf.demodel.wfstepactor.dataquery.*;

import net.ibizsys.psrt.srv.wf.entity.WFStepActor;
import net.ibizsys.psrt.srv.wf.service.WFStepActorService;

/**
 * 实体[WFSTEPACTOR]模型对象基类
 */
public abstract class WFStepActorDEModelBase extends net.ibizsys.paas.demodel.DataEntityModelBase<WFStepActor>  {
    ...
    public  WFStepActorService getRealService() {
        if(this.wFStepActorService==null) {
            try {
                this.wFStepActorService = (WFStepActorService)ServiceGlobal.getService(getServiceId());
            } catch(Exception ex) {
            }
        }
    ...
    */
    ...
    protected void onFillFetchQuickSearchConditions(DEDataSetCond groupCondImpl,String strQuickSearch)  throws Exception {
        ...
        //放入属性 WFSTEPACTORNAME - 工作流步骤操作者名称
        if(true) {
            DEDataSetCond deDataSetCondImpl = new DEDataSetCond();
            deDataSetCondImpl.setCondType(IDEDataSetCond.CONDTYPE_DEFIELD);
            deDataSetCondImpl.setCondOp(ICondition.CONDOP_LIKE);
            deDataSetCondImpl.setDEFName(WFStepActor.FIELD_WFSTEPACTORNAME);
