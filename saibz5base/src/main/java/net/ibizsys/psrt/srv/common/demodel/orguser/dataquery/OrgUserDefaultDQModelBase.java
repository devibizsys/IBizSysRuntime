...
@DEDataQuery(id="D2073767-B9E5-423A-8A27-65844044FD86",name="DEFAULT")
@DEDataQueryCodes({
 ...
 *  实体数据查询 [DEFAULT]模型基类
 */
public abstract class OrgUserDefaultDQModelBase extends net.ibizsys.paas.demodel.DEDataQueryModelBase {

    public OrgUserDefaultDQModelBase() {
        super();

        this.initAnnotation(OrgUserDefaultDQModelBase.class);
    }
