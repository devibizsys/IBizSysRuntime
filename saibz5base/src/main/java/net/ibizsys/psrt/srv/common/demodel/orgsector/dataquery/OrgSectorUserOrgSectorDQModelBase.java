...
@DEDataQuery(id="483F5C10-A1FB-45CC-810F-DFBB9E379404",name="UserOrgSector")
@DEDataQueryCodes({
    ...
    conds={
        @DEDataQueryCodeCond(condition="( t1.PORGSECTORID =  ${srfsessioncontext('SRFORGSECTORID','{\"defname\":\"PORGSECTORID\",\"dename\":\"ORGSECTOR\"}')} )")
    }),
 ...
 *  实体数据查询 [用户部门子部门]模型基类
 */
public abstract class OrgSectorUserOrgSectorDQModelBase extends net.ibizsys.paas.demodel.DEDataQueryModelBase {

    public OrgSectorUserOrgSectorDQModelBase() {
        super();

        this.initAnnotation(OrgSectorUserOrgSectorDQModelBase.class);
    }
