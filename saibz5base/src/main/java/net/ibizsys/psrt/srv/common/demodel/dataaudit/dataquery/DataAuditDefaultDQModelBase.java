...
@DEDataQueryCodes({
    @DEDataQueryCode(querycode="SELECT t1.AUDITTYPE AS AUDITTYPE, t1.CREATEDATE AS CREATEDATE, t1.CREATEMAN AS CREATEMAN, t1.DATAAUDITID AS DATAAUDITID, t1.DATAAUDITNAME AS DATAAUDITNAME, t1.IPADDRESS AS IPADDRESS, t1.OBJECTID AS OBJECTID, t1.OBJECTTYPE AS OBJECTTYPE, t1.OPPERSONID AS OPPERSONID, t1.OPPERSONNAME AS OPPERSONNAME, t1.SESSIONID AS SESSIONID, t1.UPDATEDATE AS UPDATEDATE, t1.UPDATEMAN AS UPDATEMAN FROM T_SRFDATAAUDIT t1 ",querycodetemp="",declarecode="",dbtype="DB2",
    fieldexps={
    ...
    conds={}),
    @DEDataQueryCode(querycode="SELECT t1.AUDITTYPE AS AUDITTYPE, t1.CREATEDATE AS CREATEDATE, t1.CREATEMAN AS CREATEMAN, t1.DATAAUDITID AS DATAAUDITID, t1.DATAAUDITNAME AS DATAAUDITNAME, t1.IPADDRESS AS IPADDRESS, t1.OBJECTID AS OBJECTID, t1.OBJECTTYPE AS OBJECTTYPE, t1.OPPERSONID AS OPPERSONID, t1.OPPERSONNAME AS OPPERSONNAME, t1.SESSIONID AS SESSIONID, t1.UPDATEDATE AS UPDATEDATE, t1.UPDATEMAN AS UPDATEMAN FROM T_SRFDATAAUDIT t1 ",querycodetemp="",declarecode="",dbtype="MYSQL5",
    fieldexps={
        @DEDataQueryCodeExp(name="AUDITINFO",expression="t1.AUDITINFO")
        ,@DEDataQueryCodeExp(name="AUDITTYPE",expression="t1.AUDITTYPE")
        ,@DEDataQueryCodeExp(name="CREATEDATE",expression="t1.CREATEDATE")
    ...
    conds={}),
    @DEDataQueryCode(querycode="SELECT t1.AUDITTYPE AS AUDITTYPE, t1.CREATEDATE AS CREATEDATE, t1.CREATEMAN AS CREATEMAN, t1.DATAAUDITID AS DATAAUDITID, t1.DATAAUDITNAME AS DATAAUDITNAME, t1.IPADDRESS AS IPADDRESS, t1.OBJECTID AS OBJECTID, t1.OBJECTTYPE AS OBJECTTYPE, t1.OPPERSONID AS OPPERSONID, t1.OPPERSONNAME AS OPPERSONNAME, t1.SESSIONID AS SESSIONID, t1.UPDATEDATE AS UPDATEDATE, t1.UPDATEMAN AS UPDATEMAN FROM T_SRFDATAAUDIT t1 ",querycodetemp="",declarecode="",dbtype="ORACLE",
    fieldexps={
        @DEDataQueryCodeExp(name="AUDITINFO",expression="t1.AUDITINFO")
        ,@DEDataQueryCodeExp(name="AUDITTYPE",expression="t1.AUDITTYPE")
        ,@DEDataQueryCodeExp(name="CREATEDATE",expression="t1.CREATEDATE")
    ...
    conds={}),
    @DEDataQueryCode(querycode="SELECT t1.AUDITTYPE AS AUDITTYPE, t1.CREATEDATE AS CREATEDATE, t1.CREATEMAN AS CREATEMAN, t1.DATAAUDITID AS DATAAUDITID, t1.DATAAUDITNAME AS DATAAUDITNAME, t1.IPADDRESS AS IPADDRESS, t1.OBJECTID AS OBJECTID, t1.OBJECTTYPE AS OBJECTTYPE, t1.OPPERSONID AS OPPERSONID, t1.OPPERSONNAME AS OPPERSONNAME, t1.SESSIONID AS SESSIONID, t1.UPDATEDATE AS UPDATEDATE, t1.UPDATEMAN AS UPDATEMAN FROM T_SRFDATAAUDIT t1 ",querycodetemp="",declarecode="",dbtype="SQLSERVER",
    fieldexps={
        @DEDataQueryCodeExp(name="AUDITINFO",expression="t1.AUDITINFO")
        ,@DEDataQueryCodeExp(name="AUDITTYPE",expression="t1.AUDITTYPE")
        ,@DEDataQueryCodeExp(name="CREATEDATE",expression="t1.CREATEDATE")
