...
@DEDataQueryCodes({
    @DEDataQueryCode(querycode="SELECT t1.AURLOGINADDR AS AURLOGINADDR, t1.AURLOGOUTADDR AS AURLOGOUTADDR, t1.BIGICON AS BIGICON, t1.CREATEDATE AS CREATEDATE, t1.CREATEMAN AS CREATEMAN, t1.FUNLIC AS FUNLIC, t1.SERVICE AS SERVICE, t1.SYSTEMADDR AS SYSTEMADDR, t1.SYSTEMFUN AS SYSTEMFUN, t1.SYSTEMID AS SYSTEMID, t1.SYSTEMNAME AS SYSTEMNAME, t1.SYSTEMTYPE AS SYSTEMTYPE, t1.UPDATEDATE AS UPDATEDATE, t1.UPDATEMAN AS UPDATEMAN FROM T_SRFSYSTEM t1 ",querycodetemp="",declarecode="",dbtype="DB2",
    fieldexps={
    ...
    conds={}),
    @DEDataQueryCode(querycode="SELECT t1.AURLOGINADDR AS AURLOGINADDR, t1.AURLOGOUTADDR AS AURLOGOUTADDR, t1.BIGICON AS BIGICON, t1.CREATEDATE AS CREATEDATE, t1.CREATEMAN AS CREATEMAN, t1.FUNLIC AS FUNLIC, t1.SERVICE AS SERVICE, t1.SYSTEMADDR AS SYSTEMADDR, t1.SYSTEMFUN AS SYSTEMFUN, t1.SYSTEMID AS SYSTEMID, t1.SYSTEMNAME AS SYSTEMNAME, t1.SYSTEMTYPE AS SYSTEMTYPE, t1.UPDATEDATE AS UPDATEDATE, t1.UPDATEMAN AS UPDATEMAN FROM T_SRFSYSTEM t1 ",querycodetemp="",declarecode="",dbtype="MYSQL5",
    fieldexps={
        @DEDataQueryCodeExp(name="SYSTEMPARAM",expression="t1.SYSTEMPARAM")
        ,@DEDataQueryCodeExp(name="AURLOGINADDR",expression="t1.AURLOGINADDR")
        ,@DEDataQueryCodeExp(name="AURLOGOUTADDR",expression="t1.AURLOGOUTADDR")
    ...
    conds={}),
    @DEDataQueryCode(querycode="SELECT t1.AURLOGINADDR AS AURLOGINADDR, t1.AURLOGOUTADDR AS AURLOGOUTADDR, t1.BIGICON AS BIGICON, t1.CREATEDATE AS CREATEDATE, t1.CREATEMAN AS CREATEMAN, t1.FUNLIC AS FUNLIC, t1.SERVICE AS SERVICE, t1.SYSTEMADDR AS SYSTEMADDR, t1.SYSTEMFUN AS SYSTEMFUN, t1.SYSTEMID AS SYSTEMID, t1.SYSTEMNAME AS SYSTEMNAME, t1.SYSTEMTYPE AS SYSTEMTYPE, t1.UPDATEDATE AS UPDATEDATE, t1.UPDATEMAN AS UPDATEMAN FROM T_SRFSYSTEM t1 ",querycodetemp="",declarecode="",dbtype="ORACLE",
    fieldexps={
        @DEDataQueryCodeExp(name="SYSTEMPARAM",expression="t1.SYSTEMPARAM")
        ,@DEDataQueryCodeExp(name="AURLOGINADDR",expression="t1.AURLOGINADDR")
        ,@DEDataQueryCodeExp(name="AURLOGOUTADDR",expression="t1.AURLOGOUTADDR")
    ...
    conds={}),
    @DEDataQueryCode(querycode="SELECT t1.AURLOGINADDR AS AURLOGINADDR, t1.AURLOGOUTADDR AS AURLOGOUTADDR, t1.BIGICON AS BIGICON, t1.CREATEDATE AS CREATEDATE, t1.CREATEMAN AS CREATEMAN, t1.FUNLIC AS FUNLIC, t1.SERVICE AS SERVICE, t1.SYSTEMADDR AS SYSTEMADDR, t1.SYSTEMFUN AS SYSTEMFUN, t1.SYSTEMID AS SYSTEMID, t1.SYSTEMNAME AS SYSTEMNAME, t1.SYSTEMTYPE AS SYSTEMTYPE, t1.UPDATEDATE AS UPDATEDATE, t1.UPDATEMAN AS UPDATEMAN FROM T_SRFSYSTEM t1 ",querycodetemp="",declarecode="",dbtype="SQLSERVER",
    fieldexps={
        @DEDataQueryCodeExp(name="SYSTEMPARAM",expression="t1.SYSTEMPARAM")
        ,@DEDataQueryCodeExp(name="AURLOGINADDR",expression="t1.AURLOGINADDR")
        ,@DEDataQueryCodeExp(name="AURLOGOUTADDR",expression="t1.AURLOGOUTADDR")
