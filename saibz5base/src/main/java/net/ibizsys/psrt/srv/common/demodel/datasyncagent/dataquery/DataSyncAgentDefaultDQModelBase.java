...
@DEDataQueryCodes({
    @DEDataQueryCode(querycode="SELECT t1.AGENTTYPE AS AGENTTYPE, t1.CLIENTID AS CLIENTID, t1.CREATEDATE AS CREATEDATE, t1.CREATEMAN AS CREATEMAN, t1.DATASYNCAGENTID AS DATASYNCAGENTID, t1.DATASYNCAGENTNAME AS DATASYNCAGENTNAME, t1.ENABLE AS ENABLE, t1.MEMO AS MEMO, t1.PWD AS PWD, t1.SERVERPATH AS SERVERPATH, t1.SERVICENAME AS SERVICENAME, t1.SYNCDIR AS SYNCDIR, t1.UPDATEDATE AS UPDATEDATE, t1.UPDATEMAN AS UPDATEMAN, t1.USERNAME AS USERNAME FROM T_SRFDATASYNCAGENT t1 ",querycodetemp="",declarecode="",dbtype="DB2",
    fieldexps={
    ...
    @DEDataQueryCode(querycode="SELECT t1.`AGENTTYPE` AS `AGENTTYPE`, t1.`CLIENTID` AS `CLIENTID`, t1.`CREATEDATE` AS `CREATEDATE`, t1.`CREATEMAN` AS `CREATEMAN`, t1.`DATASYNCAGENTID` AS `DATASYNCAGENTID`, t1.`DATASYNCAGENTNAME` AS `DATASYNCAGENTNAME`, t1.`ENABLE` AS `ENABLE`, t1.`MEMO` AS `MEMO`, t1.`PWD` AS `PWD`, t1.`SERVERPATH` AS `SERVERPATH`, t1.`SERVICENAME` AS `SERVICENAME`, t1.`SYNCDIR` AS `SYNCDIR`, t1.`UPDATEDATE` AS `UPDATEDATE`, t1.`UPDATEMAN` AS `UPDATEMAN`, t1.`USERNAME` AS `USERNAME` FROM `T_SRFDATASYNCAGENT` t1 ",querycodetemp="",declarecode="",dbtype="MYSQL5",
    fieldexps={
        @DEDataQueryCodeExp(name="AGENTPARAM",expression="t1.`AGENTPARAM`")
        ,@DEDataQueryCodeExp(name="AGENTTYPE",expression="t1.`AGENTTYPE`")
        ,@DEDataQueryCodeExp(name="CLIENTID",expression="t1.`CLIENTID`")
    ...
    @DEDataQueryCode(querycode="SELECT t1.AGENTTYPE AS AGENTTYPE, t1.CLIENTID AS CLIENTID, t1.CREATEDATE AS CREATEDATE, t1.CREATEMAN AS CREATEMAN, t1.DATASYNCAGENTID AS DATASYNCAGENTID, t1.DATASYNCAGENTNAME AS DATASYNCAGENTNAME, t1.ENABLE AS ENABLE, t1.MEMO AS MEMO, t1.PWD AS PWD, t1.SERVERPATH AS SERVERPATH, t1.SERVICENAME AS SERVICENAME, t1.SYNCDIR AS SYNCDIR, t1.UPDATEDATE AS UPDATEDATE, t1.UPDATEMAN AS UPDATEMAN, t1.USERNAME AS USERNAME FROM T_SRFDATASYNCAGENT t1 ",querycodetemp="",declarecode="",dbtype="ORACLE",
    fieldexps={
        @DEDataQueryCodeExp(name="AGENTPARAM",expression="t1.AGENTPARAM")
        ,@DEDataQueryCodeExp(name="AGENTTYPE",expression="t1.AGENTTYPE")
        ,@DEDataQueryCodeExp(name="CLIENTID",expression="t1.CLIENTID")
    ...
    @DEDataQueryCode(querycode="SELECT t1.[AGENTTYPE] AS [AGENTTYPE], t1.[CLIENTID] AS [CLIENTID], t1.[CREATEDATE] AS [CREATEDATE], t1.[CREATEMAN] AS [CREATEMAN], t1.[DATASYNCAGENTID] AS [DATASYNCAGENTID], t1.[DATASYNCAGENTNAME] AS [DATASYNCAGENTNAME], t1.[ENABLE] AS [ENABLE], t1.[MEMO] AS [MEMO], t1.[PWD] AS [PWD], t1.[SERVERPATH] AS [SERVERPATH], t1.[SERVICENAME] AS [SERVICENAME], t1.[SYNCDIR] AS [SYNCDIR], t1.[UPDATEDATE] AS [UPDATEDATE], t1.[UPDATEMAN] AS [UPDATEMAN], t1.[USERNAME] AS [USERNAME] FROM [T_SRFDATASYNCAGENT] t1 ",querycodetemp="",declarecode="",dbtype="SQLSERVER",
    fieldexps={
        @DEDataQueryCodeExp(name="AGENTPARAM",expression="t1.[AGENTPARAM]")
        ,@DEDataQueryCodeExp(name="AGENTTYPE",expression="t1.[AGENTTYPE]")
        ,@DEDataQueryCodeExp(name="CLIENTID",expression="t1.[CLIENTID]")
