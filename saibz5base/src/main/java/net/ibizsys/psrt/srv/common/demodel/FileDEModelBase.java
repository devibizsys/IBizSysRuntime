...
import net.ibizsys.psrt.srv.common.demodel.file.ac.*;
import net.ibizsys.psrt.srv.common.demodel.file.dataset.*;
import net.ibizsys.psrt.srv.common.demodel.file.dataquery.*;
 ...
 * 实体[FILE]模型对象基类
 */
public abstract class FileDEModelBase extends net.ibizsys.paas.demodel.DataEntityModelBase<File>  {
    ...
    public  FileService getRealService() {
        if(this.fileService==null) {
            try {
                this.fileService = (FileService)ServiceGlobal.getService(getServiceId());
            } catch(Exception ex) {
            }
        }
    ...
    */
    ...
    protected void onFillFetchQuickSearchConditions(DEDataSetCond groupCondImpl,String strQuickSearch)  throws Exception {
        ...
        if(true) {
            ...
            deDataSetCondImpl.setDEFName(File.FIELD_FILENAME);
