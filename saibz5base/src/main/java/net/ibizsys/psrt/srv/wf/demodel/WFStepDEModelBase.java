...
import net.ibizsys.psrt.srv.wf.demodel.wfstep.ac.*;
import net.ibizsys.psrt.srv.wf.demodel.wfstep.dataset.*;
import net.ibizsys.psrt.srv.wf.demodel.wfstep.dataquery.*;
 ...
 * 实体[WFSTEP]模型对象基类
 */
public abstract class WFStepDEModelBase extends net.ibizsys.paas.demodel.DataEntityModelBase<WFStep>  {
    ...
    public  WFStepService getRealService() {
        if(this.wFStepService==null) {
            try {
                this.wFStepService = (WFStepService)ServiceGlobal.getService(getServiceId());
            } catch(Exception ex) {
            }
        }
    ...
    */
    ...
    protected void onFillFetchQuickSearchConditions(DEDataSetCond groupCondImpl,String strQuickSearch)  throws Exception {
        ...
        //放入属性 WFPLOGICNAME - 步骤名称
        if(true) {
            DEDataSetCond deDataSetCondImpl = new DEDataSetCond();
            deDataSetCondImpl.setCondType(IDEDataSetCond.CONDTYPE_DEFIELD);
            deDataSetCondImpl.setCondOp(ICondition.CONDOP_LIKE);
            deDataSetCondImpl.setDEFName(WFStep.FIELD_WFPLOGICNAME);
            deDataSetCondImpl.setCondValue(strQuickSearch);
            groupCondImpl.addChildDEDataQueryCond(deDataSetCondImpl);
        }
        //放入属性 WFSTEPNAME - 工作流步骤名称
        if(true) {
            DEDataSetCond deDataSetCondImpl = new DEDataSetCond();
            deDataSetCondImpl.setCondType(IDEDataSetCond.CONDTYPE_DEFIELD);
            deDataSetCondImpl.setCondOp(ICondition.CONDOP_LIKE);
            deDataSetCondImpl.setDEFName(WFStep.FIELD_WFSTEPNAME);
            deDataSetCondImpl.setCondValue(strQuickSearch);
            groupCondImpl.addChildDEDataQueryCond(deDataSetCondImpl);
        }
    }
