...
@DEDataQueryCodes({
    @DEDataQueryCode(querycode="SELECT t1.CREATEDATE AS CREATEDATE, t1.CREATEMAN AS CREATEMAN, t1.ENABLECTX AS ENABLECTX, t1.MEMO AS MEMO, t1.PORTALPAGEID AS PORTALPAGEID, t1.PORTALPAGEMEMO AS PORTALPAGEMEMO, t1.PORTALPAGENAME AS PORTALPAGENAME, t1.UPDATEDATE AS UPDATEDATE, t1.UPDATEMAN AS UPDATEMAN FROM T_SRFPORTALPAGE t1 ",querycodetemp="",declarecode="",dbtype="DB2",
    fieldexps={
    ...
    conds={}),
    @DEDataQueryCode(querycode="SELECT t1.CREATEDATE AS CREATEDATE, t1.CREATEMAN AS CREATEMAN, t1.ENABLECTX AS ENABLECTX, t1.MEMO AS MEMO, t1.PORTALPAGEID AS PORTALPAGEID, t1.PORTALPAGEMEMO AS PORTALPAGEMEMO, t1.PORTALPAGENAME AS PORTALPAGENAME, t1.UPDATEDATE AS UPDATEDATE, t1.UPDATEMAN AS UPDATEMAN FROM T_SRFPORTALPAGE t1 ",querycodetemp="",declarecode="",dbtype="MYSQL5",
    fieldexps={
        @DEDataQueryCodeExp(name="CREATEDATE",expression="t1.CREATEDATE")
        ,@DEDataQueryCodeExp(name="CREATEMAN",expression="t1.CREATEMAN")
        ,@DEDataQueryCodeExp(name="ENABLECTX",expression="t1.ENABLECTX")
    ...
    conds={}),
    @DEDataQueryCode(querycode="SELECT t1.CREATEDATE AS CREATEDATE, t1.CREATEMAN AS CREATEMAN, t1.ENABLECTX AS ENABLECTX, t1.MEMO AS MEMO, t1.PORTALPAGEID AS PORTALPAGEID, t1.PORTALPAGEMEMO AS PORTALPAGEMEMO, t1.PORTALPAGENAME AS PORTALPAGENAME, t1.UPDATEDATE AS UPDATEDATE, t1.UPDATEMAN AS UPDATEMAN FROM T_SRFPORTALPAGE t1 ",querycodetemp="",declarecode="",dbtype="ORACLE",
    fieldexps={
        @DEDataQueryCodeExp(name="CREATEDATE",expression="t1.CREATEDATE")
        ,@DEDataQueryCodeExp(name="CREATEMAN",expression="t1.CREATEMAN")
        ,@DEDataQueryCodeExp(name="ENABLECTX",expression="t1.ENABLECTX")
    ...
    conds={}),
    @DEDataQueryCode(querycode="SELECT t1.CREATEDATE AS CREATEDATE, t1.CREATEMAN AS CREATEMAN, t1.ENABLECTX AS ENABLECTX, t1.MEMO AS MEMO, t1.PORTALPAGEID AS PORTALPAGEID, t1.PORTALPAGEMEMO AS PORTALPAGEMEMO, t1.PORTALPAGENAME AS PORTALPAGENAME, t1.UPDATEDATE AS UPDATEDATE, t1.UPDATEMAN AS UPDATEMAN FROM T_SRFPORTALPAGE t1 ",querycodetemp="",declarecode="",dbtype="SQLSERVER",
    fieldexps={
        @DEDataQueryCodeExp(name="CREATEDATE",expression="t1.CREATEDATE")
        ,@DEDataQueryCodeExp(name="CREATEMAN",expression="t1.CREATEMAN")
        ,@DEDataQueryCodeExp(name="ENABLECTX",expression="t1.ENABLECTX")
