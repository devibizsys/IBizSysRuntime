...
import net.ibizsys.psrt.srv.wf.demodel.wfuiwizard.ac.*;
import net.ibizsys.psrt.srv.wf.demodel.wfuiwizard.dataset.*;
import net.ibizsys.psrt.srv.wf.demodel.wfuiwizard.dataquery.*;

import net.ibizsys.psrt.srv.wf.entity.WFUIWizard;
import net.ibizsys.psrt.srv.wf.service.WFUIWizardService;

/**
 * 实体[WFUIWIZARD]模型对象基类
 */
public abstract class WFUIWizardDEModelBase extends net.ibizsys.paas.demodel.DataEntityModelBase<WFUIWizard>  {
    ...
    */
    ...
    protected void onFillFetchQuickSearchConditions(DEDataSetCond groupCondImpl,String strQuickSearch)  throws Exception {
        ...
        //放入属性 WFUIWIZARDNAME - 工作流操作界面名称
        if(true) {
            DEDataSetCond deDataSetCondImpl = new DEDataSetCond();
            deDataSetCondImpl.setCondType(IDEDataSetCond.CONDTYPE_DEFIELD);
            deDataSetCondImpl.setCondOp(ICondition.CONDOP_LIKE);
            deDataSetCondImpl.setDEFName(WFUIWizard.FIELD_WFUIWIZARDNAME);
