...
import net.ibizsys.psrt.srv.common.demodel.loginlog.ac.*;
import net.ibizsys.psrt.srv.common.demodel.loginlog.dataset.*;
import net.ibizsys.psrt.srv.common.demodel.loginlog.dataquery.*;
 ...
 * 实体[LOGINLOG]模型对象基类
 */
public abstract class LoginLogDEModelBase extends net.ibizsys.paas.demodel.DataEntityModelBase<LoginLog>  {
    ...
    */
    ...
    protected void onFillFetchQuickSearchConditions(DEDataSetCond groupCondImpl,String strQuickSearch)  throws Exception {
        ...
        //放入属性 LOGINLOGNAME - 帐户使用记录名称
        if(true) {
            DEDataSetCond deDataSetCondImpl = new DEDataSetCond();
            deDataSetCondImpl.setCondType(IDEDataSetCond.CONDTYPE_DEFIELD);
            deDataSetCondImpl.setCondOp(ICondition.CONDOP_LIKE);
            deDataSetCondImpl.setDEFName(LoginLog.FIELD_LOGINLOGNAME);
