...
/**
 * 实体[DEDataChgDisp] DAO对象基类
 */
public abstract class DEDataChgDispDAOBase extends net.ibizsys.psrt.srv.PSRuntimeSysDAOBase<DEDataChgDisp> {

    private static final long serialVersionUID = -1L;

    public DEDataChgDispDAOBase() {
        super();
