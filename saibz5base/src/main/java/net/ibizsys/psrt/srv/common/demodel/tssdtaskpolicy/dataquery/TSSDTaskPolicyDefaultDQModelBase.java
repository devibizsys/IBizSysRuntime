...
@DEDataQueryCodes({
    @DEDataQueryCode(querycode="SELECT t1.CREATEDATE AS CREATEDATE, t1.CREATEMAN AS CREATEMAN, t1.TSSDPOLICYID AS TSSDPOLICYID, t11.TSSDPOLICYNAME AS TSSDPOLICYNAME, t1.TSSDTASKID AS TSSDTASKID, t21.TSSDTASKNAME AS TSSDTASKNAME, t1.TSSDTASKPOLICYID AS TSSDTASKPOLICYID, t1.TSSDTASKPOLICYNAME AS TSSDTASKPOLICYNAME, t1.UPDATEDATE AS UPDATEDATE, t1.UPDATEMAN AS UPDATEMAN FROM T_SRFTSSDTASKPOLICY t1  LEFT JOIN T_SRFTSSDPOLICY t11 ON t1.TSSDPOLICYID = t11.TSSDPOLICYID  LEFT JOIN T_SRFTSSDTASK t21 ON t1.TSSDTASKID = t21.TSSDTASKID ",querycodetemp="",declarecode="",dbtype="DB2",
    fieldexps={
