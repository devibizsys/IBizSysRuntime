...
public abstract class ServiceBase extends net.ibizsys.paas.entity.EntityBase implements Serializable {
    ...
    private final static int INDEX_RUNORDER = 5;
    private final static int INDEX_SERVICEID = 6;
    private final static int INDEX_SERVICENAME = 7;
    private final static int INDEX_SERVICEOBJECT = 8;
    private final static int INDEX_SERVICEPARAM = 9;
    private final static int INDEX_SERVICESTATE = 10;
    private final static int INDEX_STARTMODE = 11;
    ...
    private static  void fillJSONObject(ServiceBase et,JSONObject json, boolean bIncEmpty) throws Exception {
        if(bIncEmpty||et.getContainer()!=null) {
            json.put("container", getJSONValue(et.getContainer()));
        }
        ...
        if(bIncEmpty||et.getRunOrder()!=null) {
            json.put("runorder", getJSONValue(et.getRunOrder()));
        }
        if(bIncEmpty||et.getServiceId()!=null) {
            json.put("serviceid", getJSONValue(et.getServiceId()));
        }
        if(bIncEmpty||et.getServiceName()!=null) {
            json.put("servicename", getJSONValue(et.getServiceName()));
        }
        if(bIncEmpty||et.getServiceObject()!=null) {
            json.put("serviceobject", getJSONValue(et.getServiceObject()));
        }
        if(bIncEmpty||et.getServiceParam()!=null) {
            json.put("serviceparam", getJSONValue(et.getServiceParam()));
        }
        if(bIncEmpty||et.getServiceState()!=null) {
            json.put("servicestate", getJSONValue(et.getServiceState()));
        }
        if(bIncEmpty||et.getStartMode()!=null) {
            json.put("startmode", getJSONValue(et.getStartMode()));
        }
    ...
    private static void copyTo(ServiceBase et,IDataObject dst,boolean bIncEmpty) throws Exception {
        if(et.isContainerDirty() && (bIncEmpty||et.getContainer()!=null)) {
            Object obj = et.getContainer();
            if(obj==null) {
                dst.set(FIELD_CONTAINER,null);
            } else {
                dst.set(FIELD_CONTAINER,obj);
            }
        }
        ...
        if(et.isRunOrderDirty() && (bIncEmpty||et.getRunOrder()!=null)) {
            Object obj = et.getRunOrder();
            if(obj==null) {
                dst.set(FIELD_RUNORDER,null);
            } else {
                dst.set(FIELD_RUNORDER,obj);
            }
        }
        if(et.isServiceIdDirty() && (bIncEmpty||et.getServiceId()!=null)) {
            Object obj = et.getServiceId();
            if(obj==null) {
                dst.set(FIELD_SERVICEID,null);
            } else {
                dst.set(FIELD_SERVICEID,obj);
            }
        }
        if(et.isServiceNameDirty() && (bIncEmpty||et.getServiceName()!=null)) {
            Object obj = et.getServiceName();
            if(obj==null) {
                dst.set(FIELD_SERVICENAME,null);
            } else {
                dst.set(FIELD_SERVICENAME,obj);
            }
        }
        if(et.isServiceObjectDirty() && (bIncEmpty||et.getServiceObject()!=null)) {
            Object obj = et.getServiceObject();
            if(obj==null) {
                dst.set(FIELD_SERVICEOBJECT,null);
            } else {
                dst.set(FIELD_SERVICEOBJECT,obj);
            }
        }
        if(et.isServiceParamDirty() && (bIncEmpty||et.getServiceParam()!=null)) {
            Object obj = et.getServiceParam();
            if(obj==null) {
                dst.set(FIELD_SERVICEPARAM,null);
            } else {
                dst.set(FIELD_SERVICEPARAM,obj);
            }
        }
        if(et.isServiceStateDirty() && (bIncEmpty||et.getServiceState()!=null)) {
            Object obj = et.getServiceState();
            if(obj==null) {
                dst.set(FIELD_SERVICESTATE,null);
            } else {
                dst.set(FIELD_SERVICESTATE,obj);
            }
        }
        if(et.isStartModeDirty() && (bIncEmpty||et.getStartMode()!=null)) {
            Object obj = et.getStartMode();
            if(obj==null) {
                dst.set(FIELD_STARTMODE,null);
            } else {
                dst.set(FIELD_STARTMODE,obj);
            }
        }
