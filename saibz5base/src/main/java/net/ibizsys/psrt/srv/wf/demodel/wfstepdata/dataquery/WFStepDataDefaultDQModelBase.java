...
@DEDataQueryCodes({
    @DEDataQueryCode(querycode="SELECT t1.CREATEDATE AS ACTIONTIME, t1.ACTORID AS ACTORID, t1.ACTORNAME AS ACTORNAME, t1.ACTORNAME2 AS ACTORNAME2, t1.CONNECTIONNAME AS CONNECTIONNAME, t1.CREATEDATE AS CREATEDATE, t1.CREATEMAN AS CREATEMAN, t1.MEMO AS MEMO, t1.NEXTTO AS NEXTTO, t1.ORIGINALWFUSERID AS ORIGINALWFUSERID, t1.ORIGINALWFUSERNAME AS ORIGINALWFUSERNAME, t1.SDPARAM AS SDPARAM, t1.SDPARAM2 AS SDPARAM2, t1.UPDATEDATE AS UPDATEDATE, t1.UPDATEMAN AS UPDATEMAN, t1.USERDATA AS USERDATA, t1.USERDATADESC AS USERDATADESC, t1.WFINSTANCEID AS WFINSTANCEID, t1.WFINSTANCENAME AS WFINSTANCENAME, t1.WFPLOGICNAME AS WFPLOGICNAME, t1.WFSTEPDATAID AS WFSTEPDATAID, t1.WFSTEPDATANAME AS WFSTEPDATANAME, t1.WFSTEPID AS WFSTEPID, t1.WFSTEPNAME AS WFSTEPNAME FROM T_SRFWFSTEPDATA t1 ",querycodetemp="",declarecode="",dbtype="DB2",
    fieldexps={
    ...
    conds={}),
    @DEDataQueryCode(querycode="SELECT t1.CREATEDATE AS ACTIONTIME, t1.ACTORID AS ACTORID, t1.ACTORNAME AS ACTORNAME, t1.ACTORNAME2 AS ACTORNAME2, t1.CONNECTIONNAME AS CONNECTIONNAME, t1.CREATEDATE AS CREATEDATE, t1.CREATEMAN AS CREATEMAN, t1.MEMO AS MEMO, t1.NEXTTO AS NEXTTO, t1.ORIGINALWFUSERID AS ORIGINALWFUSERID, t1.ORIGINALWFUSERNAME AS ORIGINALWFUSERNAME, t1.SDPARAM AS SDPARAM, t1.SDPARAM2 AS SDPARAM2, t1.UPDATEDATE AS UPDATEDATE, t1.UPDATEMAN AS UPDATEMAN, t1.USERDATA AS USERDATA, t1.USERDATADESC AS USERDATADESC, t1.WFINSTANCEID AS WFINSTANCEID, t1.WFINSTANCENAME AS WFINSTANCENAME, t1.WFPLOGICNAME AS WFPLOGICNAME, t1.WFSTEPDATAID AS WFSTEPDATAID, t1.WFSTEPDATANAME AS WFSTEPDATANAME, t1.WFSTEPID AS WFSTEPID, t1.WFSTEPNAME AS WFSTEPNAME FROM T_SRFWFSTEPDATA t1 ",querycodetemp="",declarecode="",dbtype="MYSQL5",
    fieldexps={
        @DEDataQueryCodeExp(name="ACTIONTIME",expression="t1.CREATEDATE")
        ,@DEDataQueryCodeExp(name="ACTORID",expression="t1.ACTORID")
        ,@DEDataQueryCodeExp(name="ACTORNAME",expression="t1.ACTORNAME")
    ...
    conds={}),
    @DEDataQueryCode(querycode="SELECT t1.CREATEDATE AS ACTIONTIME, t1.ACTORID AS ACTORID, t1.ACTORNAME AS ACTORNAME, t1.ACTORNAME2 AS ACTORNAME2, t1.CONNECTIONNAME AS CONNECTIONNAME, t1.CREATEDATE AS CREATEDATE, t1.CREATEMAN AS CREATEMAN, t1.MEMO AS MEMO, t1.NEXTTO AS NEXTTO, t1.ORIGINALWFUSERID AS ORIGINALWFUSERID, t1.ORIGINALWFUSERNAME AS ORIGINALWFUSERNAME, t1.SDPARAM AS SDPARAM, t1.SDPARAM2 AS SDPARAM2, t1.UPDATEDATE AS UPDATEDATE, t1.UPDATEMAN AS UPDATEMAN, t1.USERDATA AS USERDATA, t1.USERDATADESC AS USERDATADESC, t1.WFINSTANCEID AS WFINSTANCEID, t1.WFINSTANCENAME AS WFINSTANCENAME, t1.WFPLOGICNAME AS WFPLOGICNAME, t1.WFSTEPDATAID AS WFSTEPDATAID, t1.WFSTEPDATANAME AS WFSTEPDATANAME, t1.WFSTEPID AS WFSTEPID, t1.WFSTEPNAME AS WFSTEPNAME FROM T_SRFWFSTEPDATA t1 ",querycodetemp="",declarecode="",dbtype="ORACLE",
    fieldexps={
        @DEDataQueryCodeExp(name="ACTIONTIME",expression="t1.CREATEDATE")
        ,@DEDataQueryCodeExp(name="ACTORID",expression="t1.ACTORID")
        ,@DEDataQueryCodeExp(name="ACTORNAME",expression="t1.ACTORNAME")
    ...
    conds={}),
    @DEDataQueryCode(querycode="SELECT t1.CREATEDATE AS ACTIONTIME, t1.ACTORID AS ACTORID, t1.ACTORNAME AS ACTORNAME, t1.ACTORNAME2 AS ACTORNAME2, t1.CONNECTIONNAME AS CONNECTIONNAME, t1.CREATEDATE AS CREATEDATE, t1.CREATEMAN AS CREATEMAN, t1.MEMO AS MEMO, t1.NEXTTO AS NEXTTO, t1.ORIGINALWFUSERID AS ORIGINALWFUSERID, t1.ORIGINALWFUSERNAME AS ORIGINALWFUSERNAME, t1.SDPARAM AS SDPARAM, t1.SDPARAM2 AS SDPARAM2, t1.UPDATEDATE AS UPDATEDATE, t1.UPDATEMAN AS UPDATEMAN, t1.USERDATA AS USERDATA, t1.USERDATADESC AS USERDATADESC, t1.WFINSTANCEID AS WFINSTANCEID, t1.WFINSTANCENAME AS WFINSTANCENAME, t1.WFPLOGICNAME AS WFPLOGICNAME, t1.WFSTEPDATAID AS WFSTEPDATAID, t1.WFSTEPDATANAME AS WFSTEPDATANAME, t1.WFSTEPID AS WFSTEPID, t1.WFSTEPNAME AS WFSTEPNAME FROM T_SRFWFSTEPDATA t1 ",querycodetemp="",declarecode="",dbtype="SQLSERVER",
    fieldexps={
        @DEDataQueryCodeExp(name="ACTIONTIME",expression="t1.CREATEDATE")
        ,@DEDataQueryCodeExp(name="ACTORID",expression="t1.ACTORID")
        ,@DEDataQueryCodeExp(name="ACTORNAME",expression="t1.ACTORNAME")
