...
@DEDataQuery(id="0C9246F0-AC3C-4B23-AF88-FC389089C14B",name="DEFAULT")
@DEDataQueryCodes({
 ...
 *  实体数据查询 [DEFAULT]模型基类
 */
public abstract class QueryModelDefaultDQModelBase extends net.ibizsys.paas.demodel.DEDataQueryModelBase {

    public QueryModelDefaultDQModelBase() {
        super();

        this.initAnnotation(QueryModelDefaultDQModelBase.class);
    }
