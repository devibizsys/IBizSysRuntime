 ...
 * 实体[System] 服务对象基类
 */
public abstract class SystemServiceBase extends net.ibizsys.psrt.srv.PSRuntimeSysServiceBase<System> {
    ...
    protected void onCheckEntity(boolean bBaseMode,System  et, boolean bCreate, boolean bTempMode,EntityError entityError) throws Exception {
        ...
        //检查属性 认证请求地址
        entityFieldError = onCheckField_AURLoginAddr( bBaseMode,  et,  bCreate,  bTempMode);
        if(entityFieldError!=null) {
            entityError.register(entityFieldError);
        }
        //检查属性 认证注销地址
        entityFieldError = onCheckField_AURLogoutAddr( bBaseMode,  et,  bCreate,  bTempMode);
        if(entityFieldError!=null) {
            entityError.register(entityFieldError);
        }
        //检查属性 图标
        ...
        //检查属性 集成服务授权码
        entityFieldError = onCheckField_FunLic( bBaseMode,  et,  bCreate,  bTempMode);
        if(entityFieldError!=null) {
            entityError.register(entityFieldError);
        }
        //检查属性 厂商备注
        entityFieldError = onCheckField_Service( bBaseMode,  et,  bCreate,  bTempMode);
        if(entityFieldError!=null) {
            entityError.register(entityFieldError);
        }
        //检查属性 系统地址
        entityFieldError = onCheckField_SystemAddr( bBaseMode,  et,  bCreate,  bTempMode);
        if(entityFieldError!=null) {
            entityError.register(entityFieldError);
        }
        //检查属性 系统集成功能
        entityFieldError = onCheckField_SystemFun( bBaseMode,  et,  bCreate,  bTempMode);
        if(entityFieldError!=null) {
            entityError.register(entityFieldError);
        }
        //检查属性 系统标识
        entityFieldError = onCheckField_SystemId( bBaseMode,  et,  bCreate,  bTempMode);
        if(entityFieldError!=null) {
            entityError.register(entityFieldError);
        }
        //检查属性 系统名称
        entityFieldError = onCheckField_SystemName( bBaseMode,  et,  bCreate,  bTempMode);
        if(entityFieldError!=null) {
            entityError.register(entityFieldError);
        }
        //检查属性 系统参数
        entityFieldError = onCheckField_SystemParam( bBaseMode,  et,  bCreate,  bTempMode);
        if(entityFieldError!=null) {
            entityError.register(entityFieldError);
        }
        //检查属性 系统类型
        entityFieldError = onCheckField_SystemType( bBaseMode,  et,  bCreate,  bTempMode);
        if(entityFieldError!=null) {
            entityError.register(entityFieldError);
        }
    ...
    protected EntityFieldError onCheckField_AURLoginAddr(boolean bBaseMode,System et, boolean bCreate, boolean bTempMode) throws Exception {
        ...
        if(bBaseMode) {
            ...
            //检查值规则[默认规则]
            strRuleInfo =onTestValueRule_AURLoginAddr_Default( et,  bCreate,  bTempMode);
            if(!StringHelper.isNullOrEmpty(strRuleInfo)) {
                EntityFieldError entityFieldError = new EntityFieldError();
                entityFieldError.setFieldName(System.FIELD_AURLOGINADDR);
    ...
    protected EntityFieldError onCheckField_AURLogoutAddr(boolean bBaseMode,System et, boolean bCreate, boolean bTempMode) throws Exception {
        ...
        if(bBaseMode) {
            ...
            String strRuleInfo  = null;
            //检查值规则[默认规则]
            strRuleInfo =onTestValueRule_AURLogoutAddr_Default( et,  bCreate,  bTempMode);
            if(!StringHelper.isNullOrEmpty(strRuleInfo)) {
                EntityFieldError entityFieldError = new EntityFieldError();
                entityFieldError.setFieldName(System.FIELD_AURLOGOUTADDR);
                entityFieldError.setErrorType(EntityFieldError.ERROR_VALUERULE);
                entityFieldError.setErrorInfo(strRuleInfo);
                return entityFieldError;
            }
    ...
    protected EntityFieldError onCheckField_BigIcon(boolean bBaseMode,System et, boolean bCreate, boolean bTempMode) throws Exception {
        ...
        if(bBaseMode) {
            ...
            if(!StringHelper.isNullOrEmpty(strRuleInfo)) {
                EntityFieldError entityFieldError = new EntityFieldError();
                entityFieldError.setFieldName(System.FIELD_BIGICON);
                entityFieldError.setErrorType(EntityFieldError.ERROR_VALUERULE);
                entityFieldError.setErrorInfo(strRuleInfo);
                return entityFieldError;
            }
    ...
    protected EntityFieldError onCheckField_FunLic(boolean bBaseMode,System et, boolean bCreate, boolean bTempMode) throws Exception {
        ...
        if(bBaseMode) {
            ...
            String strRuleInfo  = null;
            //检查值规则[默认规则]
            strRuleInfo =onTestValueRule_FunLic_Default( et,  bCreate,  bTempMode);
            if(!StringHelper.isNullOrEmpty(strRuleInfo)) {
                EntityFieldError entityFieldError = new EntityFieldError();
                entityFieldError.setFieldName(System.FIELD_FUNLIC);
                entityFieldError.setErrorType(EntityFieldError.ERROR_VALUERULE);
                entityFieldError.setErrorInfo(strRuleInfo);
                return entityFieldError;
            }
    ...
    protected EntityFieldError onCheckField_Service(boolean bBaseMode,System et, boolean bCreate, boolean bTempMode) throws Exception {
        ...
        if(bBaseMode) {
            ...
            String strRuleInfo  = null;
            //检查值规则[默认规则]
            strRuleInfo =onTestValueRule_Service_Default( et,  bCreate,  bTempMode);
            if(!StringHelper.isNullOrEmpty(strRuleInfo)) {
                EntityFieldError entityFieldError = new EntityFieldError();
                entityFieldError.setFieldName(System.FIELD_SERVICE);
                entityFieldError.setErrorType(EntityFieldError.ERROR_VALUERULE);
                entityFieldError.setErrorInfo(strRuleInfo);
                return entityFieldError;
            }
    ...
    protected EntityFieldError onCheckField_SystemAddr(boolean bBaseMode,System et, boolean bCreate, boolean bTempMode) throws Exception {
        ...
        if(bBaseMode) {
            ...
            String strRuleInfo  = null;
            //检查值规则[默认规则]
            strRuleInfo =onTestValueRule_SystemAddr_Default( et,  bCreate,  bTempMode);
            if(!StringHelper.isNullOrEmpty(strRuleInfo)) {
                EntityFieldError entityFieldError = new EntityFieldError();
                entityFieldError.setFieldName(System.FIELD_SYSTEMADDR);
                entityFieldError.setErrorType(EntityFieldError.ERROR_VALUERULE);
                entityFieldError.setErrorInfo(strRuleInfo);
                return entityFieldError;
            }
    ...
    protected EntityFieldError onCheckField_SystemFun(boolean bBaseMode,System et, boolean bCreate, boolean bTempMode) throws Exception {
        ...
        if(bBaseMode) {
            ...
            String strRuleInfo  = null;
            //检查值规则[默认规则]
            strRuleInfo =onTestValueRule_SystemFun_Default( et,  bCreate,  bTempMode);
            if(!StringHelper.isNullOrEmpty(strRuleInfo)) {
                EntityFieldError entityFieldError = new EntityFieldError();
                entityFieldError.setFieldName(System.FIELD_SYSTEMFUN);
                entityFieldError.setErrorType(EntityFieldError.ERROR_VALUERULE);
                entityFieldError.setErrorInfo(strRuleInfo);
                return entityFieldError;
            }
        ...
        if(bBaseMode) {
            if(bCreate) {
                if(StringHelper.isNullOrEmpty(value)) {
                    EntityFieldError entityFieldError = new EntityFieldError();
                    entityFieldError.setFieldName(System.FIELD_SYSTEMID);
            ...
            String strRuleInfo  = null;
            //检查值规则[默认规则]
            strRuleInfo =onTestValueRule_SystemId_Default( et,  bCreate,  bTempMode);
            if(!StringHelper.isNullOrEmpty(strRuleInfo)) {
                EntityFieldError entityFieldError = new EntityFieldError();
                entityFieldError.setFieldName(System.FIELD_SYSTEMID);
                entityFieldError.setErrorType(EntityFieldError.ERROR_VALUERULE);
    ...
    protected EntityFieldError onCheckField_SystemName(boolean bBaseMode,System et, boolean bCreate, boolean bTempMode) throws Exception {
        ...
        if(bBaseMode) {
            if(bCreate) {
                if(StringHelper.isNullOrEmpty(value)) {
                    EntityFieldError entityFieldError = new EntityFieldError();
                    entityFieldError.setFieldName(System.FIELD_SYSTEMNAME);
                    entityFieldError.setErrorType(EntityFieldError.ERROR_EMPTY);
                    return entityFieldError;
                }
            }
            ...
            String strRuleInfo  = null;
            //检查值规则[默认规则]
            strRuleInfo =onTestValueRule_SystemName_Default( et,  bCreate,  bTempMode);
            if(!StringHelper.isNullOrEmpty(strRuleInfo)) {
                EntityFieldError entityFieldError = new EntityFieldError();
                entityFieldError.setFieldName(System.FIELD_SYSTEMNAME);
                entityFieldError.setErrorType(EntityFieldError.ERROR_VALUERULE);
    ...
    protected EntityFieldError onCheckField_SystemParam(boolean bBaseMode,System et, boolean bCreate, boolean bTempMode) throws Exception {
        ...
        if(bBaseMode) {
            ...
            String strRuleInfo  = null;
            //检查值规则[默认规则]
            strRuleInfo =onTestValueRule_SystemParam_Default( et,  bCreate,  bTempMode);
            if(!StringHelper.isNullOrEmpty(strRuleInfo)) {
                EntityFieldError entityFieldError = new EntityFieldError();
                entityFieldError.setFieldName(System.FIELD_SYSTEMPARAM);
                entityFieldError.setErrorType(EntityFieldError.ERROR_VALUERULE);
                entityFieldError.setErrorInfo(strRuleInfo);
                return entityFieldError;
            }
    ...
    protected EntityFieldError onCheckField_SystemType(boolean bBaseMode,System et, boolean bCreate, boolean bTempMode) throws Exception {
        ...
        if(bBaseMode) {
            ...
            String strRuleInfo  = null;
            //检查值规则[默认规则]
            strRuleInfo =onTestValueRule_SystemType_Default( et,  bCreate,  bTempMode);
            if(!StringHelper.isNullOrEmpty(strRuleInfo)) {
                EntityFieldError entityFieldError = new EntityFieldError();
                entityFieldError.setFieldName(System.FIELD_SYSTEMTYPE);
                entityFieldError.setErrorType(EntityFieldError.ERROR_VALUERULE);
                entityFieldError.setErrorInfo(strRuleInfo);
                return entityFieldError;
            }
    ...
    protected String onTestValueRule(String strDEFieldName,String strRule,IEntity et,boolean bCreate,boolean bTempMode) throws Exception {
        if((StringHelper.compare(strDEFieldName,System.FIELD_SYSTEMFUN,true)==0)
                &&(StringHelper.compare(strRule,"DEFAULT",true)==0))
            return onTestValueRule_SystemFun_Default(et,bCreate,bTempMode);
        if((StringHelper.compare(strDEFieldName,System.FIELD_SYSTEMTYPE,true)==0)
                &&(StringHelper.compare(strRule,"DEFAULT",true)==0))
            return onTestValueRule_SystemType_Default(et,bCreate,bTempMode);
        if((StringHelper.compare(strDEFieldName,System.FIELD_SYSTEMID,true)==0)
                &&(StringHelper.compare(strRule,"DEFAULT",true)==0))
            return onTestValueRule_SystemId_Default(et,bCreate,bTempMode);
        if((StringHelper.compare(strDEFieldName,System.FIELD_SYSTEMNAME,true)==0)
                &&(StringHelper.compare(strRule,"DEFAULT",true)==0))
            return onTestValueRule_SystemName_Default(et,bCreate,bTempMode);
        if((StringHelper.compare(strDEFieldName,System.FIELD_CREATEMAN,true)==0)
                &&(StringHelper.compare(strRule,"DEFAULT",true)==0))
            return onTestValueRule_CreateMan_Default(et,bCreate,bTempMode);
        if((StringHelper.compare(strDEFieldName,System.FIELD_CREATEDATE,true)==0)
                &&(StringHelper.compare(strRule,"DEFAULT",true)==0))
            return onTestValueRule_CreateDate_Default(et,bCreate,bTempMode);
        if((StringHelper.compare(strDEFieldName,System.FIELD_UPDATEMAN,true)==0)
                &&(StringHelper.compare(strRule,"DEFAULT",true)==0))
            return onTestValueRule_UpdateMan_Default(et,bCreate,bTempMode);
        if((StringHelper.compare(strDEFieldName,System.FIELD_UPDATEDATE,true)==0)
                &&(StringHelper.compare(strRule,"DEFAULT",true)==0))
            return onTestValueRule_UpdateDate_Default(et,bCreate,bTempMode);
        if((StringHelper.compare(strDEFieldName,System.FIELD_SERVICE,true)==0)
                &&(StringHelper.compare(strRule,"DEFAULT",true)==0))
            return onTestValueRule_Service_Default(et,bCreate,bTempMode);
        if((StringHelper.compare(strDEFieldName,System.FIELD_FUNLIC,true)==0)
                &&(StringHelper.compare(strRule,"DEFAULT",true)==0))
            return onTestValueRule_FunLic_Default(et,bCreate,bTempMode);
        if((StringHelper.compare(strDEFieldName,System.FIELD_SYSTEMADDR,true)==0)
                &&(StringHelper.compare(strRule,"DEFAULT",true)==0))
            return onTestValueRule_SystemAddr_Default(et,bCreate,bTempMode);
        if((StringHelper.compare(strDEFieldName,System.FIELD_AURLOGINADDR,true)==0)
                &&(StringHelper.compare(strRule,"DEFAULT",true)==0))
            return onTestValueRule_AURLoginAddr_Default(et,bCreate,bTempMode);
        if((StringHelper.compare(strDEFieldName,System.FIELD_AURLOGOUTADDR,true)==0)
                &&(StringHelper.compare(strRule,"DEFAULT",true)==0))
            return onTestValueRule_AURLogoutAddr_Default(et,bCreate,bTempMode);
        if((StringHelper.compare(strDEFieldName,System.FIELD_BIGICON,true)==0)
                &&(StringHelper.compare(strRule,"DEFAULT",true)==0))
            return onTestValueRule_BigIcon_Default(et,bCreate,bTempMode);
        if((StringHelper.compare(strDEFieldName,System.FIELD_SYSTEMPARAM,true)==0)
                &&(StringHelper.compare(strRule,"DEFAULT",true)==0))
            return onTestValueRule_SystemParam_Default(et,bCreate,bTempMode);
    ...
    protected String onTestValueRule_SystemType_Default(IEntity et,boolean bCreate,boolean bTempMode) throws Exception {
        try {
            if((checkFieldStringLengthRule("SYSTEMTYPE", et, bTempMode,null,false,200,true,"内容长度必须小于等于[200]")))
                return null;
    ...
    protected String onTestValueRule_SystemId_Default(IEntity et,boolean bCreate,boolean bTempMode) throws Exception {
        try {
            if((checkFieldStringLengthRule("SYSTEMID", et, bTempMode,null,false,100,true,"内容长度必须小于等于[100]")))
                return null;
    ...
    protected String onTestValueRule_SystemName_Default(IEntity et,boolean bCreate,boolean bTempMode) throws Exception {
        try {
            if((checkFieldStringLengthRule("SYSTEMNAME", et, bTempMode,null,false,200,true,"内容长度必须小于等于[200]")))
                return null;
            return "内容长度必须小于等于[200]";
        } catch(Exception ex) {
            return ex.getMessage();
    ...
    protected String onTestValueRule_Service_Default(IEntity et,boolean bCreate,boolean bTempMode) throws Exception {
        try {
            if((checkFieldStringLengthRule("SERVICE", et, bTempMode,null,false,1000,true,"内容长度必须小于等于[1000]")))
                return null;
    ...
    protected String onTestValueRule_FunLic_Default(IEntity et,boolean bCreate,boolean bTempMode) throws Exception {
        try {
            if((checkFieldStringLengthRule("FUNLIC", et, bTempMode,null,false,200,true,"内容长度必须小于等于[200]")))
                return null;
            return "内容长度必须小于等于[200]";
        } catch(Exception ex) {
            return ex.getMessage();
    ...
    protected String onTestValueRule_SystemAddr_Default(IEntity et,boolean bCreate,boolean bTempMode) throws Exception {
        try {
            if((checkFieldStringLengthRule("SYSTEMADDR", et, bTempMode,null,false,200,true,"内容长度必须小于等于[200]")))
                return null;
            return "内容长度必须小于等于[200]";
        } catch(Exception ex) {
            return ex.getMessage();
    ...
    protected String onTestValueRule_AURLoginAddr_Default(IEntity et,boolean bCreate,boolean bTempMode) throws Exception {
        try {
            if((checkFieldStringLengthRule("AURLOGINADDR", et, bTempMode,null,false,200,true,"内容长度必须小于等于[200]")))
                return null;
            return "内容长度必须小于等于[200]";
        } catch(Exception ex) {
            return ex.getMessage();
    ...
    protected String onTestValueRule_AURLogoutAddr_Default(IEntity et,boolean bCreate,boolean bTempMode) throws Exception {
        try {
            if((checkFieldStringLengthRule("AURLOGOUTADDR", et, bTempMode,null,false,200,true,"内容长度必须小于等于[200]")))
                return null;
            return "内容长度必须小于等于[200]";
        } catch(Exception ex) {
            return ex.getMessage();
    ...
    protected String onTestValueRule_BigIcon_Default(IEntity et,boolean bCreate,boolean bTempMode) throws Exception {
        try {
            if((checkFieldStringLengthRule("BIGICON", et, bTempMode,null,false,200,true,"内容长度必须小于等于[200]")))
                return null;
            return "内容长度必须小于等于[200]";
        } catch(Exception ex) {
            return ex.getMessage();
    ...
    protected String onTestValueRule_SystemParam_Default(IEntity et,boolean bCreate,boolean bTempMode) throws Exception {
        try {
            if((checkFieldStringLengthRule("SYSTEMPARAM", et, bTempMode,null,false,1048576,true,"内容长度必须小于等于[1048576]")))
                return null;
