...
import net.ibizsys.psrt.srv.common.demodel.dalog.ac.*;
import net.ibizsys.psrt.srv.common.demodel.dalog.dataset.*;
import net.ibizsys.psrt.srv.common.demodel.dalog.dataquery.*;
 ...
 * 实体[DALOG]模型对象基类
 */
public abstract class DALogDEModelBase extends net.ibizsys.paas.demodel.DataEntityModelBase<DALog>  {
    ...
    public  DALogService getRealService() {
        if(this.dALogService==null) {
            try {
                this.dALogService = (DALogService)ServiceGlobal.getService(getServiceId());
            } catch(Exception ex) {
            }
        }
    ...
    */
    ...
    protected void onFillFetchQuickSearchConditions(DEDataSetCond groupCondImpl,String strQuickSearch)  throws Exception {
        ...
        //放入属性 DALOG_NAME - DA日志名称
        if(true) {
            DEDataSetCond deDataSetCondImpl = new DEDataSetCond();
            deDataSetCondImpl.setCondType(IDEDataSetCond.CONDTYPE_DEFIELD);
            deDataSetCondImpl.setCondOp(ICondition.CONDOP_LIKE);
            deDataSetCondImpl.setDEFName(DALog.FIELD_DALOG_NAME);
