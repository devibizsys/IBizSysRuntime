...
@DEDataQuery(id="930FE9D9-C1A7-4ECE-9D12-167D9A06D693",name="UserOrg")
@DEDataQueryCodes({
    ...
    conds={
        @DEDataQueryCodeCond(condition="( t1.ORGID =  ${srfsessioncontext('SRFORGID','{\"defname\":\"ORGID\",\"dename\":\"ORGUSER\"}')} )")
    }),
...
/**
 *  实体数据查询 [当前用户组织范围]模型基类
 */
public abstract class OrgUserUserOrgDQModelBase extends net.ibizsys.paas.demodel.DEDataQueryModelBase {

    public OrgUserUserOrgDQModelBase() {
        super();

        this.initAnnotation(OrgUserUserOrgDQModelBase.class);
    }
