...
import net.ibizsys.psrt.srv.common.demodel.userobject.ac.*;
import net.ibizsys.psrt.srv.common.demodel.userobject.dataset.*;
import net.ibizsys.psrt.srv.common.demodel.userobject.dataquery.*;

import net.ibizsys.psrt.srv.common.entity.UserObject;
import net.ibizsys.psrt.srv.common.service.UserObjectService;

/**
 * 实体[USEROBJECT]模型对象基类
 */
public abstract class UserObjectDEModelBase extends net.ibizsys.paas.demodel.DataEntityModelBase<UserObject>  {
    ...
    public  UserObjectService getRealService() {
        if(this.userObjectService==null) {
            try {
                this.userObjectService = (UserObjectService)ServiceGlobal.getService(getServiceId());
            } catch(Exception ex) {
            }
        }
    ...
    */
    ...
    protected void onFillFetchQuickSearchConditions(DEDataSetCond groupCondImpl,String strQuickSearch)  throws Exception {
        ...
        //放入属性 USEROBJECTNAME - 用户对象名称
        if(true) {
            DEDataSetCond deDataSetCondImpl = new DEDataSetCond();
            deDataSetCondImpl.setCondType(IDEDataSetCond.CONDTYPE_DEFIELD);
            deDataSetCondImpl.setCondOp(ICondition.CONDOP_LIKE);
            deDataSetCondImpl.setDEFName(UserObject.FIELD_USEROBJECTNAME);
