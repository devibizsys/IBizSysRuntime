...
import net.ibizsys.psrt.srv.wf.demodel.wfassistwork.ac.*;
import net.ibizsys.psrt.srv.wf.demodel.wfassistwork.dataset.*;
import net.ibizsys.psrt.srv.wf.demodel.wfassistwork.dataquery.*;

import net.ibizsys.psrt.srv.wf.entity.WFAssistWork;
import net.ibizsys.psrt.srv.wf.service.WFAssistWorkService;

/**
 * 实体[WFASSISTWORK]模型对象基类
 */
public abstract class WFAssistWorkDEModelBase extends net.ibizsys.paas.demodel.DataEntityModelBase<WFAssistWork>  {
    ...
    */
    ...
    protected void onFillFetchQuickSearchConditions(DEDataSetCond groupCondImpl,String strQuickSearch)  throws Exception {
        ...
        //放入属性 WFASSISTWORKNAME - 工作流代办工作名称
        if(true) {
            DEDataSetCond deDataSetCondImpl = new DEDataSetCond();
            deDataSetCondImpl.setCondType(IDEDataSetCond.CONDTYPE_DEFIELD);
            deDataSetCondImpl.setCondOp(ICondition.CONDOP_LIKE);
            deDataSetCondImpl.setDEFName(WFAssistWork.FIELD_WFASSISTWORKNAME);
