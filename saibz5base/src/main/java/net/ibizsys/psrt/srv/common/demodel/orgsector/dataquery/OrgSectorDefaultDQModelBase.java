...
@DEDataQuery(id="8DB0771C-B1C2-44FA-89B0-FB20C693258E",name="DEFAULT")
@DEDataQueryCodes({
 ...
 *  实体数据查询 [DEFAULT]模型基类
 */
public abstract class OrgSectorDefaultDQModelBase extends net.ibizsys.paas.demodel.DEDataQueryModelBase {

    public OrgSectorDefaultDQModelBase() {
        super();

        this.initAnnotation(OrgSectorDefaultDQModelBase.class);
    }
