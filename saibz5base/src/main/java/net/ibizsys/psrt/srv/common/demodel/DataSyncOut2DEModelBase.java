...
import net.ibizsys.psrt.srv.common.demodel.datasyncout2.ac.*;
import net.ibizsys.psrt.srv.common.demodel.datasyncout2.dataset.*;
import net.ibizsys.psrt.srv.common.demodel.datasyncout2.dataquery.*;

import net.ibizsys.psrt.srv.common.entity.DataSyncOut2;
import net.ibizsys.psrt.srv.common.service.DataSyncOut2Service;

/**
 * 实体[DATASYNCOUT2]模型对象基类
 */
public abstract class DataSyncOut2DEModelBase extends net.ibizsys.paas.demodel.DataEntityModelBase<DataSyncOut2>  {
    ...
    protected void prepareDEFields() throws Exception {
        ...
        if(iDEField==null) {
            ...
            deFieldModel.setLogicName("数据同步发送队列2名称");
            deFieldModel.setDataType("TEXT");
            deFieldModel.setStdDataType(25);
    ...
    */
    ...
    protected void onFillFetchQuickSearchConditions(DEDataSetCond groupCondImpl,String strQuickSearch)  throws Exception {
        ...
        //放入属性 DATASYNCOUT2NAME - 数据同步发送队列2名称
        if(true) {
            DEDataSetCond deDataSetCondImpl = new DEDataSetCond();
            deDataSetCondImpl.setCondType(IDEDataSetCond.CONDTYPE_DEFIELD);
            deDataSetCondImpl.setCondOp(ICondition.CONDOP_LIKE);
            deDataSetCondImpl.setDEFName(DataSyncOut2.FIELD_DATASYNCOUT2NAME);
