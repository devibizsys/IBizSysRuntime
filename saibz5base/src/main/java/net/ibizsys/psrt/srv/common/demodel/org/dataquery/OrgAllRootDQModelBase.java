...
@DEDataQuery(id="2F63AE0F-9A22-46CB-A46F-6DC2BA62B9E3",name="AllRoot")
@DEDataQueryCodes({
    ...
    conds={
        @DEDataQueryCodeCond(condition="( t1.PORGID IS NULL )")
    }),
 ...
 *  实体数据查询 [全部根组织]模型基类
 */
public abstract class OrgAllRootDQModelBase extends net.ibizsys.paas.demodel.DEDataQueryModelBase {

    public OrgAllRootDQModelBase() {
        super();

        this.initAnnotation(OrgAllRootDQModelBase.class);
    }
