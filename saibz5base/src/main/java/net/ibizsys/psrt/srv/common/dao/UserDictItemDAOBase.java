...
/**
 * 实体[UserDictItem] DAO对象基类
 */
public abstract class UserDictItemDAOBase extends net.ibizsys.psrt.srv.PSRuntimeSysDAOBase<UserDictItem> {

    private static final long serialVersionUID = -1L;

    public UserDictItemDAOBase() {
        super();
