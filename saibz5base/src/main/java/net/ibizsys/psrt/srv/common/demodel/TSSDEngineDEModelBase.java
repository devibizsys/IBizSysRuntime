...
import net.ibizsys.psrt.srv.common.demodel.tssdengine.ac.*;
import net.ibizsys.psrt.srv.common.demodel.tssdengine.dataset.*;
import net.ibizsys.psrt.srv.common.demodel.tssdengine.dataquery.*;

import net.ibizsys.psrt.srv.common.entity.TSSDEngine;
import net.ibizsys.psrt.srv.common.service.TSSDEngineService;

/**
 * 实体[TSSDENGINE]模型对象基类
 */
public abstract class TSSDEngineDEModelBase extends net.ibizsys.paas.demodel.DataEntityModelBase<TSSDEngine>  {
    ...
    public  TSSDEngineService getRealService() {
        if(this.tSSDEngineService==null) {
            try {
                this.tSSDEngineService = (TSSDEngineService)ServiceGlobal.getService(getServiceId());
            } catch(Exception ex) {
            }
        }
    ...
    */
    ...
    protected void onFillFetchQuickSearchConditions(DEDataSetCond groupCondImpl,String strQuickSearch)  throws Exception {
        ...
        //放入属性 TSSDENGINENAME - 任务调度引擎名称
        if(true) {
            DEDataSetCond deDataSetCondImpl = new DEDataSetCond();
            deDataSetCondImpl.setCondType(IDEDataSetCond.CONDTYPE_DEFIELD);
            deDataSetCondImpl.setCondOp(ICondition.CONDOP_LIKE);
            deDataSetCondImpl.setDEFName(TSSDEngine.FIELD_TSSDENGINENAME);
