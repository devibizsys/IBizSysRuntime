...
import net.ibizsys.psrt.srv.common.demodel.service.ac.*;
import net.ibizsys.psrt.srv.common.demodel.service.dataset.*;
import net.ibizsys.psrt.srv.common.demodel.service.dataquery.*;
import net.ibizsys.psrt.srv.common.demodel.service.uiaction.*;
 ...
 * 实体[SERVICE]模型对象基类
 */
public abstract class ServiceDEModelBase extends net.ibizsys.paas.demodel.DataEntityModelBase<Service>  {
    ...
    public  ServiceService getRealService() {
        if(this.serviceService==null) {
            try {
                this.serviceService = (ServiceService)ServiceGlobal.getService(getServiceId());
            } catch(Exception ex) {
            }
        }
    ...
    */
    ...
    protected void onFillFetchQuickSearchConditions(DEDataSetCond groupCondImpl,String strQuickSearch)  throws Exception {
        ...
        //放入属性 SERVICENAME - 服务名称
        if(true) {
            DEDataSetCond deDataSetCondImpl = new DEDataSetCond();
            deDataSetCondImpl.setCondType(IDEDataSetCond.CONDTYPE_DEFIELD);
            deDataSetCondImpl.setCondOp(ICondition.CONDOP_LIKE);
            deDataSetCondImpl.setDEFName(Service.FIELD_SERVICENAME);
