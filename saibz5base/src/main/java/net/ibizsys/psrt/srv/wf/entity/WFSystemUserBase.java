...
/**
 * 实体[WFSystemUser] 数据对象基类
 */
public abstract class WFSystemUserBase extends net.ibizsys.paas.entity.EntityBase implements Serializable {
     ...
     *   实体属性标识[工作流系统用户标识]
     */
    public final static String FIELD_WFSYSTEMUSERID = "WFSYSTEMUSERID";
    /**
     *   实体属性标识[工作流系统用户名称]
     */
    public final static String FIELD_WFSYSTEMUSERNAME = "WFSYSTEMUSERNAME";

    private final static int INDEX_CREATEDATE = 0;
    private final static int INDEX_CREATEMAN = 1;
    private final static int INDEX_UPDATEDATE = 2;
    private final static int INDEX_UPDATEMAN = 3;
    private final static int INDEX_WFSYSTEMUSERID = 4;
    private final static int INDEX_WFSYSTEMUSERNAME = 5;
    ...
    static {
        ...
        fieldIndexMap.put( FIELD_WFSYSTEMUSERID, INDEX_WFSYSTEMUSERID);
        fieldIndexMap.put( FIELD_WFSYSTEMUSERNAME, INDEX_WFSYSTEMUSERNAME);
    }

    private WFSystemUserBase proxyWFSystemUserBase = null;

    public WFSystemUserBase() {
        super();
    }
    ...
    public void setWFSystemUserId(String wfsystemuserid) {
        ...
        if(wfsystemuserid!=null) {
            wfsystemuserid = StringHelper.trimRight(wfsystemuserid);
            if(wfsystemuserid.length()==0) {
                wfsystemuserid = null;
            }
        }
    ...
    public void setWFSystemUserName(String wfsystemusername) {
        ...
        if(wfsystemusername!=null) {
            wfsystemusername = StringHelper.trimRight(wfsystemusername);
            if(wfsystemusername.length()==0) {
    ...
    protected void onFillMap(HashMap<String, Object> params, boolean bDirtyOnly) {
        ...
        if(!bDirtyOnly || isWFSystemUserIdDirty()) {
            params.put(FIELD_WFSYSTEMUSERID,getWFSystemUserId());
        }
        if(!bDirtyOnly || isWFSystemUserNameDirty()) {
            params.put(FIELD_WFSYSTEMUSERNAME,getWFSystemUserName());
        }
    ...
    private static Object get(WFSystemUserBase et,int index) throws Exception {
        ...
        case INDEX_WFSYSTEMUSERID:
            return et.getWFSystemUserId();
        case INDEX_WFSYSTEMUSERNAME:
    ...
    private static  void fillJSONObject(WFSystemUserBase et,JSONObject json, boolean bIncEmpty) throws Exception {
        ...
        if(bIncEmpty||et.getWFSystemUserId()!=null) {
            json.put("wfsystemuserid", getJSONValue(et.getWFSystemUserId()));
        }
        if(bIncEmpty||et.getWFSystemUserName()!=null) {
            json.put("wfsystemusername", getJSONValue(et.getWFSystemUserName()));
        }
    }
    ...
    private static void fillXmlNode(WFSystemUserBase et,XmlNode node,boolean bIncEmpty) throws Exception {
        ...
        if(bIncEmpty||et.getWFSystemUserId()!=null) {
            Object obj = et.getWFSystemUserId();
            node.setAttribute("WFSYSTEMUSERID",(obj==null)?"":(String)obj);
        }
        if(bIncEmpty||et.getWFSystemUserName()!=null) {
            Object obj = et.getWFSystemUserName();
            node.setAttribute("WFSYSTEMUSERNAME",(obj==null)?"":(String)obj);
        }
    ...
    private static void copyTo(WFSystemUserBase et,IDataObject dst,boolean bIncEmpty) throws Exception {
        ...
        if(et.isWFSystemUserIdDirty() && (bIncEmpty||et.getWFSystemUserId()!=null)) {
            Object obj = et.getWFSystemUserId();
            if(obj==null) {
                dst.set(FIELD_WFSYSTEMUSERID,null);
            } else {
                dst.set(FIELD_WFSYSTEMUSERID,obj);
            }
        }
        if(et.isWFSystemUserNameDirty() && (bIncEmpty||et.getWFSystemUserName()!=null)) {
            Object obj = et.getWFSystemUserName();
            if(obj==null) {
                dst.set(FIELD_WFSYSTEMUSERNAME,null);
            } else {
                dst.set(FIELD_WFSYSTEMUSERNAME,obj);
            }
        }
    }
