...
@DEDataQuery(id="4B265798-E90E-4DE7-B2E7-7F577A1FEF99",name="UserOrgSector")
@DEDataQueryCodes({
    ...
    conds={
        @DEDataQueryCodeCond(condition="( t1.ORGSECTORID =  ${srfsessioncontext('SRFORGSECTORID','{\"defname\":\"ORGSECTORID\",\"dename\":\"ORGUSER\"}')} )")
    }),
...
/**
 *  实体数据查询 [当前用户部门范围]模型基类
 */
public abstract class OrgUserUserOrgSectorDQModelBase extends net.ibizsys.paas.demodel.DEDataQueryModelBase {

    public OrgUserUserOrgSectorDQModelBase() {
        super();

        this.initAnnotation(OrgUserUserOrgSectorDQModelBase.class);
    }
