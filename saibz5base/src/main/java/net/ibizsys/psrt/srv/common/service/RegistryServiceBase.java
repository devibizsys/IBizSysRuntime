 ...
 * 实体[Registry] 服务对象基类
 */
public abstract class RegistryServiceBase extends net.ibizsys.psrt.srv.PSRuntimeSysServiceBase<Registry> {
    ...
    * 填充主键
    ...
    protected boolean onFillEntityKeyValue(Registry et,boolean bTempMode) throws Exception {
        ...
        //属性 RegistryName - 系统目录
        Object objRegistryName = et.get(Registry.FIELD_REGISTRYNAME);
        if(objRegistryName==null)
            objRegistryName = "__EMTPY__";
        sb.append("%1$s", objRegistryName);
        //属性 Sector - 目录
        sb.append("||");
        Object objSector = et.get(Registry.FIELD_SECTOR);
        if(objSector==null)
            objSector = "__EMTPY__";
        sb.append("%1$s", objSector);
        String strValue = sb.toString();
        et.set(this.getRegistryDEModel().getKeyDEField().getName(),KeyValueHelper.genUniqueId(strValue));
        return true;
    }
    ...
    protected void onCheckEntity(boolean bBaseMode,Registry  et, boolean bCreate, boolean bTempMode,EntityError entityError) throws Exception {
        ...
        //检查属性 参数1
        entityFieldError = onCheckField_Param1( bBaseMode,  et,  bCreate,  bTempMode);
        if(entityFieldError!=null) {
            entityError.register(entityFieldError);
        }
        //检查属性 参数2
        entityFieldError = onCheckField_Param2( bBaseMode,  et,  bCreate,  bTempMode);
        if(entityFieldError!=null) {
            entityError.register(entityFieldError);
        }
        //检查属性 参数3(250)
        entityFieldError = onCheckField_Param3( bBaseMode,  et,  bCreate,  bTempMode);
        if(entityFieldError!=null) {
            entityError.register(entityFieldError);
        }
        //检查属性 参数4(250)
        entityFieldError = onCheckField_Param4( bBaseMode,  et,  bCreate,  bTempMode);
        if(entityFieldError!=null) {
            entityError.register(entityFieldError);
        }
        //检查属性 参数5(500)
        entityFieldError = onCheckField_Param5( bBaseMode,  et,  bCreate,  bTempMode);
        if(entityFieldError!=null) {
            entityError.register(entityFieldError);
        }
        //检查属性 参数6(500)
        entityFieldError = onCheckField_Param6( bBaseMode,  et,  bCreate,  bTempMode);
        if(entityFieldError!=null) {
            entityError.register(entityFieldError);
        }
        //检查属性 参数7(500)
        entityFieldError = onCheckField_Param7( bBaseMode,  et,  bCreate,  bTempMode);
        if(entityFieldError!=null) {
            entityError.register(entityFieldError);
        }
        //检查属性 参数8(500)
        entityFieldError = onCheckField_Param8( bBaseMode,  et,  bCreate,  bTempMode);
        if(entityFieldError!=null) {
            entityError.register(entityFieldError);
        }
        //检查属性 参数9
        entityFieldError = onCheckField_Param9( bBaseMode,  et,  bCreate,  bTempMode);
        if(entityFieldError!=null) {
            entityError.register(entityFieldError);
        }
        //检查属性 注册表标识
        entityFieldError = onCheckField_RegistryId( bBaseMode,  et,  bCreate,  bTempMode);
        if(entityFieldError!=null) {
            entityError.register(entityFieldError);
        }
        //检查属性 系统目录
        entityFieldError = onCheckField_RegistryName( bBaseMode,  et,  bCreate,  bTempMode);
        if(entityFieldError!=null) {
            entityError.register(entityFieldError);
        }
        //检查属性 目录
        entityFieldError = onCheckField_Sector( bBaseMode,  et,  bCreate,  bTempMode);
        if(entityFieldError!=null) {
            entityError.register(entityFieldError);
        }
    ...
    protected EntityFieldError onCheckField_Memo(boolean bBaseMode,Registry et, boolean bCreate, boolean bTempMode) throws Exception {
        ...
        if(bBaseMode) {
            ...
            if(!StringHelper.isNullOrEmpty(strRuleInfo)) {
                ...
                entityFieldError.setFieldName(Registry.FIELD_MEMO);
    ...
    protected EntityFieldError onCheckField_Param1(boolean bBaseMode,Registry et, boolean bCreate, boolean bTempMode) throws Exception {
        ...
        if(bBaseMode) {
            ...
            String strRuleInfo  = null;
            //检查值规则[默认规则]
            strRuleInfo =onTestValueRule_Param1_Default( et,  bCreate,  bTempMode);
            if(!StringHelper.isNullOrEmpty(strRuleInfo)) {
                EntityFieldError entityFieldError = new EntityFieldError();
                entityFieldError.setFieldName(Registry.FIELD_PARAM1);
                entityFieldError.setErrorType(EntityFieldError.ERROR_VALUERULE);
                entityFieldError.setErrorInfo(strRuleInfo);
                return entityFieldError;
            }
    ...
    protected EntityFieldError onCheckField_Param2(boolean bBaseMode,Registry et, boolean bCreate, boolean bTempMode) throws Exception {
        ...
        if(bBaseMode) {
            ...
            String strRuleInfo  = null;
            //检查值规则[默认规则]
            strRuleInfo =onTestValueRule_Param2_Default( et,  bCreate,  bTempMode);
            if(!StringHelper.isNullOrEmpty(strRuleInfo)) {
                EntityFieldError entityFieldError = new EntityFieldError();
                entityFieldError.setFieldName(Registry.FIELD_PARAM2);
                entityFieldError.setErrorType(EntityFieldError.ERROR_VALUERULE);
                entityFieldError.setErrorInfo(strRuleInfo);
                return entityFieldError;
            }
    ...
    protected EntityFieldError onCheckField_Param3(boolean bBaseMode,Registry et, boolean bCreate, boolean bTempMode) throws Exception {
        ...
        if(bBaseMode) {
            ...
            String strRuleInfo  = null;
            //检查值规则[默认规则]
            strRuleInfo =onTestValueRule_Param3_Default( et,  bCreate,  bTempMode);
            if(!StringHelper.isNullOrEmpty(strRuleInfo)) {
                EntityFieldError entityFieldError = new EntityFieldError();
                entityFieldError.setFieldName(Registry.FIELD_PARAM3);
                entityFieldError.setErrorType(EntityFieldError.ERROR_VALUERULE);
                entityFieldError.setErrorInfo(strRuleInfo);
                return entityFieldError;
            }
    ...
    protected EntityFieldError onCheckField_Param4(boolean bBaseMode,Registry et, boolean bCreate, boolean bTempMode) throws Exception {
        ...
        if(bBaseMode) {
            ...
            String strRuleInfo  = null;
            //检查值规则[默认规则]
            strRuleInfo =onTestValueRule_Param4_Default( et,  bCreate,  bTempMode);
            if(!StringHelper.isNullOrEmpty(strRuleInfo)) {
                EntityFieldError entityFieldError = new EntityFieldError();
                entityFieldError.setFieldName(Registry.FIELD_PARAM4);
                entityFieldError.setErrorType(EntityFieldError.ERROR_VALUERULE);
                entityFieldError.setErrorInfo(strRuleInfo);
                return entityFieldError;
            }
    ...
    protected EntityFieldError onCheckField_Param5(boolean bBaseMode,Registry et, boolean bCreate, boolean bTempMode) throws Exception {
        ...
        if(bBaseMode) {
            ...
            String strRuleInfo  = null;
            //检查值规则[默认规则]
            strRuleInfo =onTestValueRule_Param5_Default( et,  bCreate,  bTempMode);
            if(!StringHelper.isNullOrEmpty(strRuleInfo)) {
                EntityFieldError entityFieldError = new EntityFieldError();
                entityFieldError.setFieldName(Registry.FIELD_PARAM5);
                entityFieldError.setErrorType(EntityFieldError.ERROR_VALUERULE);
                entityFieldError.setErrorInfo(strRuleInfo);
                return entityFieldError;
            }
    ...
    protected EntityFieldError onCheckField_Param6(boolean bBaseMode,Registry et, boolean bCreate, boolean bTempMode) throws Exception {
        ...
        if(bBaseMode) {
            ...
            String strRuleInfo  = null;
            //检查值规则[默认规则]
            strRuleInfo =onTestValueRule_Param6_Default( et,  bCreate,  bTempMode);
            if(!StringHelper.isNullOrEmpty(strRuleInfo)) {
                EntityFieldError entityFieldError = new EntityFieldError();
                entityFieldError.setFieldName(Registry.FIELD_PARAM6);
                entityFieldError.setErrorType(EntityFieldError.ERROR_VALUERULE);
                entityFieldError.setErrorInfo(strRuleInfo);
                return entityFieldError;
            }
    ...
    protected EntityFieldError onCheckField_Param7(boolean bBaseMode,Registry et, boolean bCreate, boolean bTempMode) throws Exception {
        ...
        if(bBaseMode) {
            ...
            String strRuleInfo  = null;
            //检查值规则[默认规则]
            strRuleInfo =onTestValueRule_Param7_Default( et,  bCreate,  bTempMode);
            if(!StringHelper.isNullOrEmpty(strRuleInfo)) {
                EntityFieldError entityFieldError = new EntityFieldError();
                entityFieldError.setFieldName(Registry.FIELD_PARAM7);
                entityFieldError.setErrorType(EntityFieldError.ERROR_VALUERULE);
                entityFieldError.setErrorInfo(strRuleInfo);
                return entityFieldError;
            }
    ...
    protected EntityFieldError onCheckField_Param8(boolean bBaseMode,Registry et, boolean bCreate, boolean bTempMode) throws Exception {
        ...
        if(bBaseMode) {
            ...
            String strRuleInfo  = null;
            //检查值规则[默认规则]
            strRuleInfo =onTestValueRule_Param8_Default( et,  bCreate,  bTempMode);
            if(!StringHelper.isNullOrEmpty(strRuleInfo)) {
                EntityFieldError entityFieldError = new EntityFieldError();
                entityFieldError.setFieldName(Registry.FIELD_PARAM8);
                entityFieldError.setErrorType(EntityFieldError.ERROR_VALUERULE);
                entityFieldError.setErrorInfo(strRuleInfo);
                return entityFieldError;
            }
    ...
    protected EntityFieldError onCheckField_Param9(boolean bBaseMode,Registry et, boolean bCreate, boolean bTempMode) throws Exception {
        ...
        if(bBaseMode) {
            ...
            String strRuleInfo  = null;
            //检查值规则[默认规则]
            strRuleInfo =onTestValueRule_Param9_Default( et,  bCreate,  bTempMode);
            if(!StringHelper.isNullOrEmpty(strRuleInfo)) {
                EntityFieldError entityFieldError = new EntityFieldError();
                entityFieldError.setFieldName(Registry.FIELD_PARAM9);
                entityFieldError.setErrorType(EntityFieldError.ERROR_VALUERULE);
                entityFieldError.setErrorInfo(strRuleInfo);
                return entityFieldError;
            }
        ...
        if(bBaseMode) {
            if(bCreate) {
                if(StringHelper.isNullOrEmpty(value)) {
                    EntityFieldError entityFieldError = new EntityFieldError();
                    entityFieldError.setFieldName(Registry.FIELD_REGISTRYID);
            ...
            String strRuleInfo  = null;
            //检查值规则[默认规则]
            strRuleInfo =onTestValueRule_RegistryId_Default( et,  bCreate,  bTempMode);
            if(!StringHelper.isNullOrEmpty(strRuleInfo)) {
                EntityFieldError entityFieldError = new EntityFieldError();
                entityFieldError.setFieldName(Registry.FIELD_REGISTRYID);
                entityFieldError.setErrorType(EntityFieldError.ERROR_VALUERULE);
    ...
    protected EntityFieldError onCheckField_RegistryName(boolean bBaseMode,Registry et, boolean bCreate, boolean bTempMode) throws Exception {
        ...
        if(bBaseMode) {
            if(bCreate) {
                if(StringHelper.isNullOrEmpty(value)) {
                    EntityFieldError entityFieldError = new EntityFieldError();
                    entityFieldError.setFieldName(Registry.FIELD_REGISTRYNAME);
                    entityFieldError.setErrorType(EntityFieldError.ERROR_EMPTY);
                    return entityFieldError;
                }
            }
            ...
            String strRuleInfo  = null;
            //检查值规则[默认规则]
            strRuleInfo =onTestValueRule_RegistryName_Default( et,  bCreate,  bTempMode);
            if(!StringHelper.isNullOrEmpty(strRuleInfo)) {
                EntityFieldError entityFieldError = new EntityFieldError();
                entityFieldError.setFieldName(Registry.FIELD_REGISTRYNAME);
                entityFieldError.setErrorType(EntityFieldError.ERROR_VALUERULE);
    ...
    protected EntityFieldError onCheckField_Sector(boolean bBaseMode,Registry et, boolean bCreate, boolean bTempMode) throws Exception {
        ...
        if(bBaseMode) {
            if(bCreate) {
                if(StringHelper.isNullOrEmpty(value)) {
                    EntityFieldError entityFieldError = new EntityFieldError();
                    entityFieldError.setFieldName(Registry.FIELD_SECTOR);
                    entityFieldError.setErrorType(EntityFieldError.ERROR_EMPTY);
                    return entityFieldError;
                }
            }
            ...
            String strRuleInfo  = null;
            //检查值规则[默认规则]
            strRuleInfo =onTestValueRule_Sector_Default( et,  bCreate,  bTempMode);
            if(!StringHelper.isNullOrEmpty(strRuleInfo)) {
                EntityFieldError entityFieldError = new EntityFieldError();
                entityFieldError.setFieldName(Registry.FIELD_SECTOR);
                entityFieldError.setErrorType(EntityFieldError.ERROR_VALUERULE);
    ...
    protected String onTestValueRule(String strDEFieldName,String strRule,IEntity et,boolean bCreate,boolean bTempMode) throws Exception {
        if((StringHelper.compare(strDEFieldName,Registry.FIELD_REGISTRYID,true)==0)
                &&(StringHelper.compare(strRule,"DEFAULT",true)==0))
            return onTestValueRule_RegistryId_Default(et,bCreate,bTempMode);
        if((StringHelper.compare(strDEFieldName,Registry.FIELD_REGISTRYNAME,true)==0)
                &&(StringHelper.compare(strRule,"DEFAULT",true)==0))
            return onTestValueRule_RegistryName_Default(et,bCreate,bTempMode);
        if((StringHelper.compare(strDEFieldName,Registry.FIELD_CREATEMAN,true)==0)
                &&(StringHelper.compare(strRule,"DEFAULT",true)==0))
            return onTestValueRule_CreateMan_Default(et,bCreate,bTempMode);
        if((StringHelper.compare(strDEFieldName,Registry.FIELD_CREATEDATE,true)==0)
                &&(StringHelper.compare(strRule,"DEFAULT",true)==0))
            return onTestValueRule_CreateDate_Default(et,bCreate,bTempMode);
        if((StringHelper.compare(strDEFieldName,Registry.FIELD_UPDATEMAN,true)==0)
                &&(StringHelper.compare(strRule,"DEFAULT",true)==0))
            return onTestValueRule_UpdateMan_Default(et,bCreate,bTempMode);
        if((StringHelper.compare(strDEFieldName,Registry.FIELD_UPDATEDATE,true)==0)
                &&(StringHelper.compare(strRule,"DEFAULT",true)==0))
            return onTestValueRule_UpdateDate_Default(et,bCreate,bTempMode);
        if((StringHelper.compare(strDEFieldName,Registry.FIELD_SECTOR,true)==0)
                &&(StringHelper.compare(strRule,"DEFAULT",true)==0))
            return onTestValueRule_Sector_Default(et,bCreate,bTempMode);
        if((StringHelper.compare(strDEFieldName,Registry.FIELD_PARAM1,true)==0)
                &&(StringHelper.compare(strRule,"DEFAULT",true)==0))
            return onTestValueRule_Param1_Default(et,bCreate,bTempMode);
        if((StringHelper.compare(strDEFieldName,Registry.FIELD_PARAM2,true)==0)
                &&(StringHelper.compare(strRule,"DEFAULT",true)==0))
            return onTestValueRule_Param2_Default(et,bCreate,bTempMode);
        if((StringHelper.compare(strDEFieldName,Registry.FIELD_PARAM3,true)==0)
                &&(StringHelper.compare(strRule,"DEFAULT",true)==0))
            return onTestValueRule_Param3_Default(et,bCreate,bTempMode);
        if((StringHelper.compare(strDEFieldName,Registry.FIELD_PARAM4,true)==0)
                &&(StringHelper.compare(strRule,"DEFAULT",true)==0))
            return onTestValueRule_Param4_Default(et,bCreate,bTempMode);
        if((StringHelper.compare(strDEFieldName,Registry.FIELD_PARAM5,true)==0)
                &&(StringHelper.compare(strRule,"DEFAULT",true)==0))
            return onTestValueRule_Param5_Default(et,bCreate,bTempMode);
        if((StringHelper.compare(strDEFieldName,Registry.FIELD_PARAM6,true)==0)
                &&(StringHelper.compare(strRule,"DEFAULT",true)==0))
            return onTestValueRule_Param6_Default(et,bCreate,bTempMode);
        if((StringHelper.compare(strDEFieldName,Registry.FIELD_PARAM7,true)==0)
                &&(StringHelper.compare(strRule,"DEFAULT",true)==0))
            return onTestValueRule_Param7_Default(et,bCreate,bTempMode);
        if((StringHelper.compare(strDEFieldName,Registry.FIELD_PARAM8,true)==0)
                &&(StringHelper.compare(strRule,"DEFAULT",true)==0))
            return onTestValueRule_Param8_Default(et,bCreate,bTempMode);
        if((StringHelper.compare(strDEFieldName,Registry.FIELD_PARAM9,true)==0)
                &&(StringHelper.compare(strRule,"DEFAULT",true)==0))
            return onTestValueRule_Param9_Default(et,bCreate,bTempMode);
        if((StringHelper.compare(strDEFieldName,Registry.FIELD_MEMO,true)==0)
                &&(StringHelper.compare(strRule,"DEFAULT",true)==0))
    ...
    protected String onTestValueRule_RegistryId_Default(IEntity et,boolean bCreate,boolean bTempMode) throws Exception {
        try {
            if((checkFieldStringLengthRule("REGISTRYID", et, bTempMode,null,false,100,true,"内容长度必须小于等于[100]")))
                return null;
    ...
    protected String onTestValueRule_RegistryName_Default(IEntity et,boolean bCreate,boolean bTempMode) throws Exception {
        try {
            if((checkFieldStringLengthRule("REGISTRYNAME", et, bTempMode,null,false,200,true,"内容长度必须小于等于[200]")))
                return null;
    ...
    protected String onTestValueRule_Sector_Default(IEntity et,boolean bCreate,boolean bTempMode) throws Exception {
        try {
            if((checkFieldStringLengthRule("SECTION", et, bTempMode,null,false,200,true,"内容长度必须小于等于[200]")))
                return null;
            return "内容长度必须小于等于[200]";
        } catch(Exception ex) {
            return ex.getMessage();
    ...
    protected String onTestValueRule_Param1_Default(IEntity et,boolean bCreate,boolean bTempMode) throws Exception {
        try {
            if((checkFieldStringLengthRule("PARAM1", et, bTempMode,null,false,100,true,"内容长度必须小于等于[100]")))
                return null;
            return "内容长度必须小于等于[100]";
        } catch(Exception ex) {
            return ex.getMessage();
    ...
    protected String onTestValueRule_Param2_Default(IEntity et,boolean bCreate,boolean bTempMode) throws Exception {
        try {
            if((checkFieldStringLengthRule("PARAM2", et, bTempMode,null,false,100,true,"内容长度必须小于等于[100]")))
                return null;
            return "内容长度必须小于等于[100]";
        } catch(Exception ex) {
            return ex.getMessage();
    ...
    protected String onTestValueRule_Param3_Default(IEntity et,boolean bCreate,boolean bTempMode) throws Exception {
        try {
            if((checkFieldStringLengthRule("PARAM3", et, bTempMode,null,false,500,true,"内容长度必须小于等于[500]")))
                return null;
    ...
    protected String onTestValueRule_Param4_Default(IEntity et,boolean bCreate,boolean bTempMode) throws Exception {
        try {
            if((checkFieldStringLengthRule("PARAM4", et, bTempMode,null,false,500,true,"内容长度必须小于等于[500]")))
                return null;
            return "内容长度必须小于等于[500]";
        } catch(Exception ex) {
            return ex.getMessage();
    ...
    protected String onTestValueRule_Param5_Default(IEntity et,boolean bCreate,boolean bTempMode) throws Exception {
        try {
            if((checkFieldStringLengthRule("PARAM5", et, bTempMode,null,false,1000,true,"内容长度必须小于等于[1000]")))
                return null;
    ...
    protected String onTestValueRule_Param6_Default(IEntity et,boolean bCreate,boolean bTempMode) throws Exception {
        try {
            if((checkFieldStringLengthRule("PARAM6", et, bTempMode,null,false,1000,true,"内容长度必须小于等于[1000]")))
                return null;
            return "内容长度必须小于等于[1000]";
        } catch(Exception ex) {
            return ex.getMessage();
    ...
    protected String onTestValueRule_Param7_Default(IEntity et,boolean bCreate,boolean bTempMode) throws Exception {
        try {
            if((checkFieldStringLengthRule("PARAM7", et, bTempMode,null,false,1000,true,"内容长度必须小于等于[1000]")))
                return null;
            return "内容长度必须小于等于[1000]";
        } catch(Exception ex) {
            return ex.getMessage();
    ...
    protected String onTestValueRule_Param8_Default(IEntity et,boolean bCreate,boolean bTempMode) throws Exception {
        try {
            if((checkFieldStringLengthRule("PARAM8", et, bTempMode,null,false,1000,true,"内容长度必须小于等于[1000]")))
                return null;
            return "内容长度必须小于等于[1000]";
        } catch(Exception ex) {
            return ex.getMessage();
    ...
    protected String onTestValueRule_Param9_Default(IEntity et,boolean bCreate,boolean bTempMode) throws Exception {
        try {
            if((checkFieldStringLengthRule("PARAM9", et, bTempMode,null,false,1048576,true,"内容长度必须小于等于[1048576]")))
                return null;
