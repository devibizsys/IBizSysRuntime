...
/**
 * 实体[DEDataChg2] 数据对象基类
 */
public abstract class DEDataChg2Base extends net.ibizsys.paas.entity.EntityBase implements Serializable {
     ...
     *   实体属性标识[实体数据变更2标识]
     */
    public final static String FIELD_DEDATACHG2ID = "DEDATACHG2ID";
    /**
     *   实体属性标识[实体数据变更2名称]
     */
    public final static String FIELD_DEDATACHG2NAME = "DEDATACHG2NAME";
    /**
     *   实体属性标识[数据实体]
     */
     ...
     *   实体属性标识[分发错误]
     */
    public final static String FIELD_DISPERROR = "DISPERROR";
    /**
     *   实体属性标识[处理错误]
     */
    ...
    private final static int INDEX_DEDATACHG2ID = 4;
    private final static int INDEX_DEDATACHG2NAME = 5;
    private final static int INDEX_DEID = 6;
    private final static int INDEX_DENAME = 7;
    private final static int INDEX_DISPERROR = 8;
    private final static int INDEX_ERROR = 9;
    private final static int INDEX_EVENTTYPE = 10;
    ...
    static {
        ...
        fieldIndexMap.put( FIELD_DEDATACHG2ID, INDEX_DEDATACHG2ID);
        fieldIndexMap.put( FIELD_DEDATACHG2NAME, INDEX_DEDATACHG2NAME);
        fieldIndexMap.put( FIELD_DEID, INDEX_DEID);
        fieldIndexMap.put( FIELD_DENAME, INDEX_DENAME);
        fieldIndexMap.put( FIELD_DISPERROR, INDEX_DISPERROR);
    ...
    public void setDEDataChg2Id(String dedatachg2id) {
        ...
        if(dedatachg2id!=null) {
            dedatachg2id = StringHelper.trimRight(dedatachg2id);
            if(dedatachg2id.length()==0) {
                dedatachg2id = null;
            }
        }
    ...
    public void setDEDataChg2Name(String dedatachg2name) {
        ...
        if(dedatachg2name!=null) {
            dedatachg2name = StringHelper.trimRight(dedatachg2name);
            if(dedatachg2name.length()==0) {
                dedatachg2name = null;
            }
        }
    ...
    public void setDISPError(String disperror) {
        ...
        if(disperror!=null) {
            disperror = StringHelper.trimRight(disperror);
    ...
    protected void onFillMap(HashMap<String, Object> params, boolean bDirtyOnly) {
        ...
        if(!bDirtyOnly || isDEDataChg2IdDirty()) {
            params.put(FIELD_DEDATACHG2ID,getDEDataChg2Id());
        }
        if(!bDirtyOnly || isDEDataChg2NameDirty()) {
            params.put(FIELD_DEDATACHG2NAME,getDEDataChg2Name());
        }
        ...
        if(!bDirtyOnly || isDISPErrorDirty()) {
            params.put(FIELD_DISPERROR,getDISPError());
        }
    ...
    private static Object get(DEDataChg2Base et,int index) throws Exception {
        ...
        case INDEX_DEDATACHG2ID:
            return et.getDEDataChg2Id();
        case INDEX_DEDATACHG2NAME:
            return et.getDEDataChg2Name();
        case INDEX_DEID:
            return et.getDEId();
        case INDEX_DENAME:
            return et.getDEName();
        case INDEX_DISPERROR:
    ...
    private static  void fillJSONObject(DEDataChg2Base et,JSONObject json, boolean bIncEmpty) throws Exception {
        ...
        if(bIncEmpty||et.getDEDataChg2Id()!=null) {
            json.put("dedatachg2id", getJSONValue(et.getDEDataChg2Id()));
        }
        if(bIncEmpty||et.getDEDataChg2Name()!=null) {
            json.put("dedatachg2name", getJSONValue(et.getDEDataChg2Name()));
        }
        ...
        if(bIncEmpty||et.getDISPError()!=null) {
            json.put("disperror", getJSONValue(et.getDISPError()));
        }
    ...
    private static void fillXmlNode(DEDataChg2Base et,XmlNode node,boolean bIncEmpty) throws Exception {
        ...
        if(bIncEmpty||et.getDEDataChg2Id()!=null) {
            Object obj = et.getDEDataChg2Id();
            node.setAttribute("DEDATACHG2ID",(obj==null)?"":(String)obj);
        }
        if(bIncEmpty||et.getDEDataChg2Name()!=null) {
            Object obj = et.getDEDataChg2Name();
            node.setAttribute("DEDATACHG2NAME",(obj==null)?"":(String)obj);
        }
        if(bIncEmpty||et.getDEId()!=null) {
        ...
        if(bIncEmpty||et.getDISPError()!=null) {
            Object obj = et.getDISPError();
            node.setAttribute("DISPERROR",(obj==null)?"":(String)obj);
        }
        if(bIncEmpty||et.getError()!=null) {
    ...
    private static void copyTo(DEDataChg2Base et,IDataObject dst,boolean bIncEmpty) throws Exception {
        ...
        if(et.isDEDataChg2IdDirty() && (bIncEmpty||et.getDEDataChg2Id()!=null)) {
            Object obj = et.getDEDataChg2Id();
            if(obj==null) {
                dst.set(FIELD_DEDATACHG2ID,null);
            } else {
                dst.set(FIELD_DEDATACHG2ID,obj);
            }
        }
        if(et.isDEDataChg2NameDirty() && (bIncEmpty||et.getDEDataChg2Name()!=null)) {
            Object obj = et.getDEDataChg2Name();
            if(obj==null) {
                dst.set(FIELD_DEDATACHG2NAME,null);
            } else {
                dst.set(FIELD_DEDATACHG2NAME,obj);
            }
        }
        ...
        if(et.isDISPErrorDirty() && (bIncEmpty||et.getDISPError()!=null)) {
            Object obj = et.getDISPError();
            if(obj==null) {
                dst.set(FIELD_DISPERROR,null);
            } else {
                dst.set(FIELD_DISPERROR,obj);
            }
        }
