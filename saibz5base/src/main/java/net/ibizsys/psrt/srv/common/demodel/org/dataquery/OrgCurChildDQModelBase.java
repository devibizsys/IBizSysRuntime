...
@DEDataQuery(id="32FD68B7-A570-4C25-B60D-4A7A8BFC8177",name="CurChild")
@DEDataQueryCodes({
 ...
 *  实体数据查询 [当前子组织]模型基类
 */
public abstract class OrgCurChildDQModelBase extends net.ibizsys.paas.demodel.DEDataQueryModelBase {

    public OrgCurChildDQModelBase() {
        super();

        this.initAnnotation(OrgCurChildDQModelBase.class);
    }
