...
/**
 * 实体[UserRoleDEField] DAO对象基类
 */
public abstract class UserRoleDEFieldDAOBase extends net.ibizsys.psrt.srv.PSRuntimeSysDAOBase<UserRoleDEField> {

    private static final long serialVersionUID = -1L;

    public UserRoleDEFieldDAOBase() {
        super();
