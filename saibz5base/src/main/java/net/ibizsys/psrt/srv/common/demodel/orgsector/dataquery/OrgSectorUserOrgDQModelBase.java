...
@DEDataQuery(id="5B383DBE-5B1F-40EF-8F40-8FD4E62525A9",name="UserOrg")
@DEDataQueryCodes({
    ...
    conds={
        @DEDataQueryCodeCond(condition="( t1.ORGID =  ${srfsessioncontext('SRFORGID','{\"defname\":\"ORGID\",\"dename\":\"ORGSECTOR\"}')} )")
    }),
 ...
 *  实体数据查询 [用户组织部门]模型基类
 */
public abstract class OrgSectorUserOrgDQModelBase extends net.ibizsys.paas.demodel.DEDataQueryModelBase {

    public OrgSectorUserOrgDQModelBase() {
        super();

        this.initAnnotation(OrgSectorUserOrgDQModelBase.class);
    }
