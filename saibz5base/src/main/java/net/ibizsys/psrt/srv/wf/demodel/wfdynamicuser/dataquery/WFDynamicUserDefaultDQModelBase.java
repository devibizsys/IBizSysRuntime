...
@DEDataQueryCodes({
    @DEDataQueryCode(querycode="SELECT t1.CREATEDATE AS CREATEDATE, t1.CREATEMAN AS CREATEMAN, t1.UPDATEDATE AS UPDATEDATE, t1.UPDATEMAN AS UPDATEMAN, t1.USEROBJECT AS USEROBJECT, t1.USERTYPE AS USERTYPE, t1.WFDYNAMICUSERID AS WFDYNAMICUSERID, t1.WFDYNAMICUSERNAME AS WFDYNAMICUSERNAME FROM T_SRFWFDYNAMICUSER t1 ",querycodetemp="",declarecode="",dbtype="DB2",
    fieldexps={
    ...
    conds={}),
    @DEDataQueryCode(querycode="SELECT t1.CREATEDATE AS CREATEDATE, t1.CREATEMAN AS CREATEMAN, t1.UPDATEDATE AS UPDATEDATE, t1.UPDATEMAN AS UPDATEMAN, t1.USEROBJECT AS USEROBJECT, t1.USERTYPE AS USERTYPE, t1.WFDYNAMICUSERID AS WFDYNAMICUSERID, t1.WFDYNAMICUSERNAME AS WFDYNAMICUSERNAME FROM T_SRFWFDYNAMICUSER t1 ",querycodetemp="",declarecode="",dbtype="MYSQL5",
    fieldexps={
        @DEDataQueryCodeExp(name="PARAMS",expression="t1.PARAMS")
        ,@DEDataQueryCodeExp(name="CREATEDATE",expression="t1.CREATEDATE")
        ,@DEDataQueryCodeExp(name="CREATEMAN",expression="t1.CREATEMAN")
    ...
    conds={}),
    @DEDataQueryCode(querycode="SELECT t1.CREATEDATE AS CREATEDATE, t1.CREATEMAN AS CREATEMAN, t1.UPDATEDATE AS UPDATEDATE, t1.UPDATEMAN AS UPDATEMAN, t1.USEROBJECT AS USEROBJECT, t1.USERTYPE AS USERTYPE, t1.WFDYNAMICUSERID AS WFDYNAMICUSERID, t1.WFDYNAMICUSERNAME AS WFDYNAMICUSERNAME FROM T_SRFWFDYNAMICUSER t1 ",querycodetemp="",declarecode="",dbtype="ORACLE",
    fieldexps={
        @DEDataQueryCodeExp(name="PARAMS",expression="t1.PARAMS")
        ,@DEDataQueryCodeExp(name="CREATEDATE",expression="t1.CREATEDATE")
        ,@DEDataQueryCodeExp(name="CREATEMAN",expression="t1.CREATEMAN")
    ...
    conds={}),
    @DEDataQueryCode(querycode="SELECT t1.CREATEDATE AS CREATEDATE, t1.CREATEMAN AS CREATEMAN, t1.UPDATEDATE AS UPDATEDATE, t1.UPDATEMAN AS UPDATEMAN, t1.USEROBJECT AS USEROBJECT, t1.USERTYPE AS USERTYPE, t1.WFDYNAMICUSERID AS WFDYNAMICUSERID, t1.WFDYNAMICUSERNAME AS WFDYNAMICUSERNAME FROM T_SRFWFDYNAMICUSER t1 ",querycodetemp="",declarecode="",dbtype="SQLSERVER",
    fieldexps={
        @DEDataQueryCodeExp(name="PARAMS",expression="t1.PARAMS")
        ,@DEDataQueryCodeExp(name="CREATEDATE",expression="t1.CREATEDATE")
        ,@DEDataQueryCodeExp(name="CREATEMAN",expression="t1.CREATEMAN")
