...
public abstract class DataEntityBase extends net.ibizsys.paas.entity.EntityBase implements Serializable {
    ...
    private static  void fillJSONObject(DataEntityBase et,JSONObject json, boolean bIncEmpty) throws Exception {
        if(bIncEmpty||et.getACEnableDP()!=null) {
            json.put("acenabledp", getJSONValue(et.getACEnableDP()));
        }
        if(bIncEmpty||et.getACExtInfo()!=null) {
            json.put("acextinfo", getJSONValue(et.getACExtInfo()));
        }
        if(bIncEmpty||et.getACInfoFormat()!=null) {
            json.put("acinfoformat", getJSONValue(et.getACInfoFormat()));
        }
        if(bIncEmpty||et.getACInfoParam()!=null) {
            json.put("acinfoparam", getJSONValue(et.getACInfoParam()));
        }
        if(bIncEmpty||et.getACMaxCnt()!=null) {
            json.put("acmaxcnt", getJSONValue(et.getACMaxCnt()));
        }
        if(bIncEmpty||et.getACObject()!=null) {
            json.put("acobject", getJSONValue(et.getACObject()));
        }
        if(bIncEmpty||et.getACQueryModelId()!=null) {
            json.put("acquerymodelid", getJSONValue(et.getACQueryModelId()));
        }
        if(bIncEmpty||et.getACQueryModelName()!=null) {
            json.put("acquerymodelname", getJSONValue(et.getACQueryModelName()));
        }
        if(bIncEmpty||et.getACSortDir()!=null) {
            json.put("acsortdir", getJSONValue(et.getACSortDir()));
        }
        if(bIncEmpty||et.getACSortField()!=null) {
            json.put("acsortfield", getJSONValue(et.getACSortField()));
        }
        if(bIncEmpty||et.getBigIcon()!=null) {
            json.put("bigicon", getJSONValue(et.getBigIcon()));
        }
        if(bIncEmpty||et.getConfigHelper()!=null) {
            json.put("confighelper", getJSONValue(et.getConfigHelper()));
        }
        ...
        if(bIncEmpty||et.getDataAccObject()!=null) {
            json.put("dataaccobject", getJSONValue(et.getDataAccObject()));
        }
        if(bIncEmpty||et.getDataChgLogMode()!=null) {
            json.put("datachglogmode", getJSONValue(et.getDataChgLogMode()));
        }
        if(bIncEmpty||et.getDataCtrlInt()!=null) {
            json.put("datactrlint", getJSONValue(et.getDataCtrlInt()));
        }
        if(bIncEmpty||et.getDataCtrlObject()!=null) {
            json.put("datactrlobject", getJSONValue(et.getDataCtrlObject()));
        }
        if(bIncEmpty||et.getDataNotifyHelper()!=null) {
            json.put("datanotifyhelper", getJSONValue(et.getDataNotifyHelper()));
        }
        if(bIncEmpty||et.getDBStorage()!=null) {
            json.put("dbstorage", getJSONValue(et.getDBStorage()));
        }
        if(bIncEmpty||et.getDBVersion()!=null) {
            json.put("dbversion", getJSONValue(et.getDBVersion()));
        }
        if(bIncEmpty||et.getDEGroup()!=null) {
            json.put("degroup", getJSONValue(et.getDEGroup()));
        }
        if(bIncEmpty||et.getDEHelper()!=null) {
            json.put("dehelper", getJSONValue(et.getDEHelper()));
        }
        if(bIncEmpty||et.getDEId()!=null) {
            json.put("deid", getJSONValue(et.getDEId()));
        }
        if(bIncEmpty||et.getDELogicName()!=null) {
            json.put("delogicname", getJSONValue(et.getDELogicName()));
        }
        if(bIncEmpty||et.getDEName()!=null) {
            json.put("dename", getJSONValue(et.getDEName()));
        }
        if(bIncEmpty||et.getDEObject()!=null) {
            json.put("deobject", getJSONValue(et.getDEObject()));
        }
        if(bIncEmpty||et.getDEOrder()!=null) {
            json.put("deorder", getJSONValue(et.getDEOrder()));
        }
        if(bIncEmpty||et.getDEParam()!=null) {
            json.put("deparam", getJSONValue(et.getDEParam()));
        }
        if(bIncEmpty||et.getDER11DEId()!=null) {
            json.put("der11deid", getJSONValue(et.getDER11DEId()));
        }
        if(bIncEmpty||et.getDER11DEName()!=null) {
            json.put("der11dename", getJSONValue(et.getDER11DEName()));
        }
        if(bIncEmpty||et.getDEType()!=null) {
            json.put("detype", getJSONValue(et.getDEType()));
        }
        if(bIncEmpty||et.getDEUserParam()!=null) {
            json.put("deuserparam", getJSONValue(et.getDEUserParam()));
        }
        if(bIncEmpty||et.getDEVersion()!=null) {
            json.put("deversion", getJSONValue(et.getDEVersion()));
        }
        if(bIncEmpty||et.getDGRowClassHelper()!=null) {
            json.put("dgrowclasshelper", getJSONValue(et.getDGRowClassHelper()));
        }
        if(bIncEmpty||et.getDGSUMMARYHeight()!=null) {
            json.put("dgsummaryheight", getJSONValue(et.getDGSUMMARYHeight()));
        }
        if(bIncEmpty||et.getDLKHelper()!=null) {
            json.put("dlkhelper", getJSONValue(et.getDLKHelper()));
        }
        if(bIncEmpty||et.getDynamicInterval()!=null) {
            json.put("dynamicinterval", getJSONValue(et.getDynamicInterval()));
        }
        if(bIncEmpty||et.getEnableColPriv()!=null) {
            json.put("enablecolpriv", getJSONValue(et.getEnableColPriv()));
        }
        if(bIncEmpty||et.getEnableGlobalModel()!=null) {
            json.put("enableglobalmodel", getJSONValue(et.getEnableGlobalModel()));
        }
        if(bIncEmpty||et.getExitingModel()!=null) {
            json.put("exitingmodel", getJSONValue(et.getExitingModel()));
        }
        if(bIncEmpty||et.getExportIncEmpty()!=null) {
            json.put("exportincempty", getJSONValue(et.getExportIncEmpty()));
        }
        if(bIncEmpty||et.getExTableName()!=null) {
            json.put("extablename", getJSONValue(et.getExTableName()));
        }
        if(bIncEmpty||et.getGlobalModelObj()!=null) {
            json.put("globalmodelobj", getJSONValue(et.getGlobalModelObj()));
        }
        if(bIncEmpty||et.getIndexMode()!=null) {
            json.put("indexmode", getJSONValue(et.getIndexMode()));
        }
        if(bIncEmpty||et.getInfoField()!=null) {
            json.put("infofield", getJSONValue(et.getInfoField()));
        }
        if(bIncEmpty||et.getInfoFormat()!=null) {
            json.put("infoformat", getJSONValue(et.getInfoFormat()));
        }
        if(bIncEmpty||et.getInheritMode()!=null) {
            json.put("inheritmode", getJSONValue(et.getInheritMode()));
        }
        if(bIncEmpty||et.getIsDGRowEdit()!=null) {
            json.put("isdgrowedit", getJSONValue(et.getIsDGRowEdit()));
        }
        if(bIncEmpty||et.getIsEnableAudit()!=null) {
            json.put("isenableaudit", getJSONValue(et.getIsEnableAudit()));
        }
        if(bIncEmpty||et.getIsEnableDP()!=null) {
            json.put("isenabledp", getJSONValue(et.getIsEnableDP()));
        }
        if(bIncEmpty||et.getIsIndexDE()!=null) {
            json.put("isindexde", getJSONValue(et.getIsIndexDE()));
        }
        if(bIncEmpty||et.getIsLogicValid()!=null) {
            json.put("islogicvalid", getJSONValue(et.getIsLogicValid()));
        }
        if(bIncEmpty||et.getISMULTIPRINT()!=null) {
            json.put("ismultiprint", getJSONValue(et.getISMULTIPRINT()));
        }
        if(bIncEmpty||et.getISSupportFA()!=null) {
            json.put("issupportfa", getJSONValue(et.getISSupportFA()));
        }
        if(bIncEmpty||et.getIsSystem()!=null) {
            json.put("issystem", getJSONValue(et.getIsSystem()));
        }
        if(bIncEmpty||et.getKeyParams()!=null) {
            json.put("keyparams", getJSONValue(et.getKeyParams()));
        }
        if(bIncEmpty||et.getLicenseCode()!=null) {
            json.put("licensecode", getJSONValue(et.getLicenseCode()));
        }
        if(bIncEmpty||et.getLogAuditDetail()!=null) {
            json.put("logauditdetail", getJSONValue(et.getLogAuditDetail()));
        }
        if(bIncEmpty||et.getMemo()!=null) {
            json.put("memo", getJSONValue(et.getMemo()));
        }
        if(bIncEmpty||et.getMinorFieldName()!=null) {
            json.put("minorfieldname", getJSONValue(et.getMinorFieldName()));
        }
        if(bIncEmpty||et.getMinorFieldValue()!=null) {
            json.put("minorfieldvalue", getJSONValue(et.getMinorFieldValue()));
        }
        if(bIncEmpty||et.getMinorTableName()!=null) {
            json.put("minortablename", getJSONValue(et.getMinorTableName()));
        }
        if(bIncEmpty||et.getMutliMajor()!=null) {
            json.put("multimajor", getJSONValue(et.getMutliMajor()));
        }
        if(bIncEmpty||et.getNoDataInfo()!=null) {
            json.put("nodatainfo", getJSONValue(et.getNoDataInfo()));
        }
        if(bIncEmpty||et.getPrintFunc()!=null) {
            json.put("printfunc", getJSONValue(et.getPrintFunc()));
        }
        if(bIncEmpty||et.getRESERVER()!=null) {
            json.put("reserver", getJSONValue(et.getRESERVER()));
        }
        if(bIncEmpty||et.getRESERVER2()!=null) {
            json.put("reserver2", getJSONValue(et.getRESERVER2()));
        }
        if(bIncEmpty||et.getRowAmout()!=null) {
            json.put("rowamount", getJSONValue(et.getRowAmout()));
        }
        if(bIncEmpty||et.getRTInfo()!=null) {
            json.put("rtinfo", getJSONValue(et.getRTInfo()));
        }
        if(bIncEmpty||et.getSMALLICON()!=null) {
            json.put("smallicon", getJSONValue(et.getSMALLICON()));
        }
        if(bIncEmpty||et.getStorageType()!=null) {
            json.put("storagetype", getJSONValue(et.getStorageType()));
        }
        if(bIncEmpty||et.getTableName()!=null) {
            json.put("tablename", getJSONValue(et.getTableName()));
        }
        if(bIncEmpty||et.getTableSpace()!=null) {
            json.put("tablespace", getJSONValue(et.getTableSpace()));
        }
        if(bIncEmpty||et.getTipsInfo()!=null) {
            json.put("tipsinfo", getJSONValue(et.getTipsInfo()));
        }
        ...
        if(bIncEmpty||et.getUserAction()!=null) {
            json.put("useraction", getJSONValue(et.getUserAction()));
        }
        if(bIncEmpty||et.getValidFlag()!=null) {
            json.put("validflag", getJSONValue(et.getValidFlag()));
        }
        if(bIncEmpty||et.getVCFlag()!=null) {
            json.put("vcflag", getJSONValue(et.getVCFlag()));
        }
        if(bIncEmpty||et.getVerCheckTimer()!=null) {
            json.put("verchecktimer", getJSONValue(et.getVerCheckTimer()));
        }
        if(bIncEmpty||et.getVerField()!=null) {
            json.put("verfield", getJSONValue(et.getVerField()));
        }
        if(bIncEmpty||et.getVerHelper()!=null) {
            json.put("verhelper", getJSONValue(et.getVerHelper()));
        }
        if(bIncEmpty||et.getVersionCheck()!=null) {
            json.put("versioncheck", getJSONValue(et.getVersionCheck()));
        }
        if(bIncEmpty||et.getViewName()!=null) {
            json.put("viewname", getJSONValue(et.getViewName()));
        }
    }
    ...
    private static void copyTo(DataEntityBase et,IDataObject dst,boolean bIncEmpty) throws Exception {
        if(et.isACEnableDPDirty() && (bIncEmpty||et.getACEnableDP()!=null)) {
            Object obj = et.getACEnableDP();
            if(obj==null) {
                dst.set(FIELD_ACENABLEDP,null);
            } else {
                dst.set(FIELD_ACENABLEDP,obj);
            }
        }
        if(et.isACExtInfoDirty() && (bIncEmpty||et.getACExtInfo()!=null)) {
            Object obj = et.getACExtInfo();
            if(obj==null) {
                dst.set(FIELD_ACEXTINFO,null);
            } else {
                dst.set(FIELD_ACEXTINFO,obj);
            }
        }
        if(et.isACInfoFormatDirty() && (bIncEmpty||et.getACInfoFormat()!=null)) {
            Object obj = et.getACInfoFormat();
            if(obj==null) {
                dst.set(FIELD_ACINFOFORMAT,null);
            } else {
                dst.set(FIELD_ACINFOFORMAT,obj);
            }
        }
        if(et.isACInfoParamDirty() && (bIncEmpty||et.getACInfoParam()!=null)) {
            Object obj = et.getACInfoParam();
            if(obj==null) {
                dst.set(FIELD_ACINFOPARAM,null);
            } else {
                dst.set(FIELD_ACINFOPARAM,obj);
            }
        }
        if(et.isACMaxCntDirty() && (bIncEmpty||et.getACMaxCnt()!=null)) {
            Object obj = et.getACMaxCnt();
            if(obj==null) {
                dst.set(FIELD_ACMAXCNT,null);
            } else {
                dst.set(FIELD_ACMAXCNT,obj);
            }
        }
        if(et.isACObjectDirty() && (bIncEmpty||et.getACObject()!=null)) {
            Object obj = et.getACObject();
            if(obj==null) {
                dst.set(FIELD_ACOBJECT,null);
            } else {
                dst.set(FIELD_ACOBJECT,obj);
            }
        }
        if(et.isACQueryModelIdDirty() && (bIncEmpty||et.getACQueryModelId()!=null)) {
            Object obj = et.getACQueryModelId();
            if(obj==null) {
                dst.set(FIELD_ACQUERYMODELID,null);
            } else {
                dst.set(FIELD_ACQUERYMODELID,obj);
            }
        }
        if(et.isACQueryModelNameDirty() && (bIncEmpty||et.getACQueryModelName()!=null)) {
            Object obj = et.getACQueryModelName();
            if(obj==null) {
                dst.set(FIELD_ACQUERYMODELNAME,null);
            } else {
                dst.set(FIELD_ACQUERYMODELNAME,obj);
            }
        }
        if(et.isACSortDirDirty() && (bIncEmpty||et.getACSortDir()!=null)) {
            Object obj = et.getACSortDir();
            if(obj==null) {
                dst.set(FIELD_ACSORTDIR,null);
            } else {
                dst.set(FIELD_ACSORTDIR,obj);
            }
        }
        if(et.isACSortFieldDirty() && (bIncEmpty||et.getACSortField()!=null)) {
            Object obj = et.getACSortField();
            if(obj==null) {
                dst.set(FIELD_ACSORTFIELD,null);
            } else {
                dst.set(FIELD_ACSORTFIELD,obj);
            }
        }
        if(et.isBigIconDirty() && (bIncEmpty||et.getBigIcon()!=null)) {
            Object obj = et.getBigIcon();
            if(obj==null) {
                dst.set(FIELD_BIGICON,null);
            } else {
                dst.set(FIELD_BIGICON,obj);
            }
        }
        if(et.isConfigHelperDirty() && (bIncEmpty||et.getConfigHelper()!=null)) {
            Object obj = et.getConfigHelper();
            if(obj==null) {
                dst.set(FIELD_CONFIGHELPER,null);
            } else {
                dst.set(FIELD_CONFIGHELPER,obj);
            }
        }
        ...
        if(et.isDataAccObjectDirty() && (bIncEmpty||et.getDataAccObject()!=null)) {
            Object obj = et.getDataAccObject();
            if(obj==null) {
                dst.set(FIELD_DATAACCOBJECT,null);
            } else {
                dst.set(FIELD_DATAACCOBJECT,obj);
            }
        }
        if(et.isDataChgLogModeDirty() && (bIncEmpty||et.getDataChgLogMode()!=null)) {
            Object obj = et.getDataChgLogMode();
            if(obj==null) {
                dst.set(FIELD_DATACHGLOGMODE,null);
            } else {
                dst.set(FIELD_DATACHGLOGMODE,obj);
            }
        }
        if(et.isDataCtrlIntDirty() && (bIncEmpty||et.getDataCtrlInt()!=null)) {
            Object obj = et.getDataCtrlInt();
            if(obj==null) {
                dst.set(FIELD_DATACTRLINT,null);
            } else {
                dst.set(FIELD_DATACTRLINT,obj);
            }
        }
        if(et.isDataCtrlObjectDirty() && (bIncEmpty||et.getDataCtrlObject()!=null)) {
            Object obj = et.getDataCtrlObject();
            if(obj==null) {
                dst.set(FIELD_DATACTRLOBJECT,null);
            } else {
                dst.set(FIELD_DATACTRLOBJECT,obj);
            }
        }
        if(et.isDataNotifyHelperDirty() && (bIncEmpty||et.getDataNotifyHelper()!=null)) {
            Object obj = et.getDataNotifyHelper();
            if(obj==null) {
                dst.set(FIELD_DATANOTIFYHELPER,null);
            } else {
                dst.set(FIELD_DATANOTIFYHELPER,obj);
            }
        }
        if(et.isDBStorageDirty() && (bIncEmpty||et.getDBStorage()!=null)) {
            Object obj = et.getDBStorage();
            if(obj==null) {
                dst.set(FIELD_DBSTORAGE,null);
            } else {
                dst.set(FIELD_DBSTORAGE,obj);
            }
        }
        if(et.isDBVersionDirty() && (bIncEmpty||et.getDBVersion()!=null)) {
            Object obj = et.getDBVersion();
            if(obj==null) {
                dst.set(FIELD_DBVERSION,null);
            } else {
                dst.set(FIELD_DBVERSION,obj);
            }
        }
        if(et.isDEGroupDirty() && (bIncEmpty||et.getDEGroup()!=null)) {
            Object obj = et.getDEGroup();
            if(obj==null) {
                dst.set(FIELD_DEGROUP,null);
            } else {
                dst.set(FIELD_DEGROUP,obj);
            }
        }
        if(et.isDEHelperDirty() && (bIncEmpty||et.getDEHelper()!=null)) {
            Object obj = et.getDEHelper();
            if(obj==null) {
                dst.set(FIELD_DEHELPER,null);
            } else {
                dst.set(FIELD_DEHELPER,obj);
            }
        }
        ...
        if(et.isDELogicNameDirty() && (bIncEmpty||et.getDELogicName()!=null)) {
            Object obj = et.getDELogicName();
            if(obj==null) {
                dst.set(FIELD_DELOGICNAME,null);
            } else {
                dst.set(FIELD_DELOGICNAME,obj);
            }
        }
        ...
        if(et.isDEObjectDirty() && (bIncEmpty||et.getDEObject()!=null)) {
            Object obj = et.getDEObject();
            if(obj==null) {
                dst.set(FIELD_DEOBJECT,null);
            } else {
                dst.set(FIELD_DEOBJECT,obj);
            }
        }
        if(et.isDEOrderDirty() && (bIncEmpty||et.getDEOrder()!=null)) {
            Object obj = et.getDEOrder();
            if(obj==null) {
                dst.set(FIELD_DEORDER,null);
            } else {
                dst.set(FIELD_DEORDER,obj);
            }
        }
        if(et.isDEParamDirty() && (bIncEmpty||et.getDEParam()!=null)) {
            Object obj = et.getDEParam();
            if(obj==null) {
                dst.set(FIELD_DEPARAM,null);
            } else {
                dst.set(FIELD_DEPARAM,obj);
            }
        }
        if(et.isDER11DEIdDirty() && (bIncEmpty||et.getDER11DEId()!=null)) {
            Object obj = et.getDER11DEId();
            if(obj==null) {
                dst.set(FIELD_DER11DEID,null);
            } else {
                dst.set(FIELD_DER11DEID,obj);
            }
        }
        if(et.isDER11DENameDirty() && (bIncEmpty||et.getDER11DEName()!=null)) {
            Object obj = et.getDER11DEName();
            if(obj==null) {
                dst.set(FIELD_DER11DENAME,null);
            } else {
                dst.set(FIELD_DER11DENAME,obj);
            }
        }
        if(et.isDETypeDirty() && (bIncEmpty||et.getDEType()!=null)) {
            Object obj = et.getDEType();
            if(obj==null) {
                dst.set(FIELD_DETYPE,null);
            } else {
                dst.set(FIELD_DETYPE,obj);
            }
        }
        if(et.isDEUserParamDirty() && (bIncEmpty||et.getDEUserParam()!=null)) {
            Object obj = et.getDEUserParam();
            if(obj==null) {
                dst.set(FIELD_DEUSERPARAM,null);
            } else {
                dst.set(FIELD_DEUSERPARAM,obj);
            }
        }
        if(et.isDEVersionDirty() && (bIncEmpty||et.getDEVersion()!=null)) {
            Object obj = et.getDEVersion();
            if(obj==null) {
                dst.set(FIELD_DEVERSION,null);
            } else {
                dst.set(FIELD_DEVERSION,obj);
            }
        }
        if(et.isDGRowClassHelperDirty() && (bIncEmpty||et.getDGRowClassHelper()!=null)) {
            Object obj = et.getDGRowClassHelper();
            if(obj==null) {
                dst.set(FIELD_DGROWCLASSHELPER,null);
            } else {
                dst.set(FIELD_DGROWCLASSHELPER,obj);
            }
        }
        if(et.isDGSUMMARYHeightDirty() && (bIncEmpty||et.getDGSUMMARYHeight()!=null)) {
            Object obj = et.getDGSUMMARYHeight();
            if(obj==null) {
                dst.set(FIELD_DGSUMMARYHEIGHT,null);
            } else {
                dst.set(FIELD_DGSUMMARYHEIGHT,obj);
            }
        }
        if(et.isDLKHelperDirty() && (bIncEmpty||et.getDLKHelper()!=null)) {
            Object obj = et.getDLKHelper();
            if(obj==null) {
                dst.set(FIELD_DLKHELPER,null);
            } else {
                dst.set(FIELD_DLKHELPER,obj);
            }
        }
        if(et.isDynamicIntervalDirty() && (bIncEmpty||et.getDynamicInterval()!=null)) {
            Object obj = et.getDynamicInterval();
            if(obj==null) {
                dst.set(FIELD_DYNAMICINTERVAL,null);
            } else {
                dst.set(FIELD_DYNAMICINTERVAL,obj);
            }
        }
        if(et.isEnableColPrivDirty() && (bIncEmpty||et.getEnableColPriv()!=null)) {
            Object obj = et.getEnableColPriv();
            if(obj==null) {
                dst.set(FIELD_ENABLECOLPRIV,null);
            } else {
                dst.set(FIELD_ENABLECOLPRIV,obj);
            }
        }
        if(et.isEnableGlobalModelDirty() && (bIncEmpty||et.getEnableGlobalModel()!=null)) {
            Object obj = et.getEnableGlobalModel();
            if(obj==null) {
                dst.set(FIELD_ENABLEGLOBALMODEL,null);
            } else {
                dst.set(FIELD_ENABLEGLOBALMODEL,obj);
            }
        }
        if(et.isExitingModelDirty() && (bIncEmpty||et.getExitingModel()!=null)) {
            Object obj = et.getExitingModel();
            if(obj==null) {
                dst.set(FIELD_EXITINGMODEL,null);
            } else {
                dst.set(FIELD_EXITINGMODEL,obj);
            }
        }
        if(et.isExportIncEmptyDirty() && (bIncEmpty||et.getExportIncEmpty()!=null)) {
            Object obj = et.getExportIncEmpty();
            if(obj==null) {
                dst.set(FIELD_EXPORTINCEMPTY,null);
            } else {
                dst.set(FIELD_EXPORTINCEMPTY,obj);
            }
        }
        if(et.isExTableNameDirty() && (bIncEmpty||et.getExTableName()!=null)) {
            Object obj = et.getExTableName();
            if(obj==null) {
                dst.set(FIELD_EXTABLENAME,null);
            } else {
                dst.set(FIELD_EXTABLENAME,obj);
            }
        }
        if(et.isGlobalModelObjDirty() && (bIncEmpty||et.getGlobalModelObj()!=null)) {
            Object obj = et.getGlobalModelObj();
            if(obj==null) {
                dst.set(FIELD_GLOBALMODELOBJ,null);
            } else {
                dst.set(FIELD_GLOBALMODELOBJ,obj);
            }
        }
        if(et.isIndexModeDirty() && (bIncEmpty||et.getIndexMode()!=null)) {
            Object obj = et.getIndexMode();
            if(obj==null) {
                dst.set(FIELD_INDEXMODE,null);
            } else {
                dst.set(FIELD_INDEXMODE,obj);
            }
        }
        if(et.isInfoFieldDirty() && (bIncEmpty||et.getInfoField()!=null)) {
            Object obj = et.getInfoField();
            if(obj==null) {
                dst.set(FIELD_INFOFIELD,null);
            } else {
                dst.set(FIELD_INFOFIELD,obj);
            }
        }
        if(et.isInfoFormatDirty() && (bIncEmpty||et.getInfoFormat()!=null)) {
            Object obj = et.getInfoFormat();
            if(obj==null) {
                dst.set(FIELD_INFOFORMAT,null);
            } else {
                dst.set(FIELD_INFOFORMAT,obj);
            }
        }
        if(et.isInheritModeDirty() && (bIncEmpty||et.getInheritMode()!=null)) {
            Object obj = et.getInheritMode();
            if(obj==null) {
                dst.set(FIELD_INHERITMODE,null);
            } else {
                dst.set(FIELD_INHERITMODE,obj);
            }
        }
        if(et.isIsDGRowEditDirty() && (bIncEmpty||et.getIsDGRowEdit()!=null)) {
            Object obj = et.getIsDGRowEdit();
            if(obj==null) {
                dst.set(FIELD_ISDGROWEDIT,null);
            } else {
                dst.set(FIELD_ISDGROWEDIT,obj);
            }
        }
        if(et.isIsEnableAuditDirty() && (bIncEmpty||et.getIsEnableAudit()!=null)) {
            Object obj = et.getIsEnableAudit();
            if(obj==null) {
                dst.set(FIELD_ISENABLEAUDIT,null);
            } else {
                dst.set(FIELD_ISENABLEAUDIT,obj);
            }
        }
        if(et.isIsEnableDPDirty() && (bIncEmpty||et.getIsEnableDP()!=null)) {
            Object obj = et.getIsEnableDP();
            if(obj==null) {
                dst.set(FIELD_ISENABLEDP,null);
            } else {
                dst.set(FIELD_ISENABLEDP,obj);
            }
        }
        if(et.isIsIndexDEDirty() && (bIncEmpty||et.getIsIndexDE()!=null)) {
            Object obj = et.getIsIndexDE();
            if(obj==null) {
                dst.set(FIELD_ISINDEXDE,null);
            } else {
                dst.set(FIELD_ISINDEXDE,obj);
            }
        }
        if(et.isIsLogicValidDirty() && (bIncEmpty||et.getIsLogicValid()!=null)) {
            Object obj = et.getIsLogicValid();
            if(obj==null) {
                dst.set(FIELD_ISLOGICVALID,null);
            } else {
                dst.set(FIELD_ISLOGICVALID,obj);
            }
        }
        if(et.isISMULTIPRINTDirty() && (bIncEmpty||et.getISMULTIPRINT()!=null)) {
            Object obj = et.getISMULTIPRINT();
            if(obj==null) {
                dst.set(FIELD_ISMULTIPRINT,null);
            } else {
                dst.set(FIELD_ISMULTIPRINT,obj);
            }
        }
        if(et.isISSupportFADirty() && (bIncEmpty||et.getISSupportFA()!=null)) {
            Object obj = et.getISSupportFA();
            if(obj==null) {
                dst.set(FIELD_ISSUPPORTFA,null);
            } else {
                dst.set(FIELD_ISSUPPORTFA,obj);
            }
        }
        if(et.isIsSystemDirty() && (bIncEmpty||et.getIsSystem()!=null)) {
            Object obj = et.getIsSystem();
            if(obj==null) {
                dst.set(FIELD_ISSYSTEM,null);
            } else {
                dst.set(FIELD_ISSYSTEM,obj);
            }
        }
        if(et.isKeyParamsDirty() && (bIncEmpty||et.getKeyParams()!=null)) {
            Object obj = et.getKeyParams();
            if(obj==null) {
                dst.set(FIELD_KEYPARAMS,null);
            } else {
                dst.set(FIELD_KEYPARAMS,obj);
            }
        }
        if(et.isLicenseCodeDirty() && (bIncEmpty||et.getLicenseCode()!=null)) {
            Object obj = et.getLicenseCode();
            if(obj==null) {
                dst.set(FIELD_LICENSECODE,null);
            } else {
                dst.set(FIELD_LICENSECODE,obj);
            }
        }
        if(et.isLogAuditDetailDirty() && (bIncEmpty||et.getLogAuditDetail()!=null)) {
            Object obj = et.getLogAuditDetail();
            if(obj==null) {
                dst.set(FIELD_LOGAUDITDETAIL,null);
            } else {
                dst.set(FIELD_LOGAUDITDETAIL,obj);
            }
        }
        ...
        if(et.isMinorFieldNameDirty() && (bIncEmpty||et.getMinorFieldName()!=null)) {
            Object obj = et.getMinorFieldName();
            if(obj==null) {
                dst.set(FIELD_MINORFIELDNAME,null);
            } else {
                dst.set(FIELD_MINORFIELDNAME,obj);
            }
        }
        if(et.isMinorFieldValueDirty() && (bIncEmpty||et.getMinorFieldValue()!=null)) {
            Object obj = et.getMinorFieldValue();
            if(obj==null) {
                dst.set(FIELD_MINORFIELDVALUE,null);
            } else {
                dst.set(FIELD_MINORFIELDVALUE,obj);
            }
        }
        if(et.isMinorTableNameDirty() && (bIncEmpty||et.getMinorTableName()!=null)) {
            Object obj = et.getMinorTableName();
            if(obj==null) {
                dst.set(FIELD_MINORTABLENAME,null);
            } else {
                dst.set(FIELD_MINORTABLENAME,obj);
            }
        }
        if(et.isMutliMajorDirty() && (bIncEmpty||et.getMutliMajor()!=null)) {
            Object obj = et.getMutliMajor();
            if(obj==null) {
                dst.set(FIELD_MUTLIMAJOR,null);
            } else {
                dst.set(FIELD_MUTLIMAJOR,obj);
            }
        }
        if(et.isNoDataInfoDirty() && (bIncEmpty||et.getNoDataInfo()!=null)) {
            Object obj = et.getNoDataInfo();
            if(obj==null) {
                dst.set(FIELD_NODATAINFO,null);
            } else {
                dst.set(FIELD_NODATAINFO,obj);
            }
        }
        if(et.isPrintFuncDirty() && (bIncEmpty||et.getPrintFunc()!=null)) {
            Object obj = et.getPrintFunc();
            if(obj==null) {
                dst.set(FIELD_PRINTFUNC,null);
            } else {
                dst.set(FIELD_PRINTFUNC,obj);
            }
        }
        if(et.isRESERVERDirty() && (bIncEmpty||et.getRESERVER()!=null)) {
            Object obj = et.getRESERVER();
            if(obj==null) {
                dst.set(FIELD_RESERVER,null);
            } else {
                dst.set(FIELD_RESERVER,obj);
            }
        }
        if(et.isRESERVER2Dirty() && (bIncEmpty||et.getRESERVER2()!=null)) {
            Object obj = et.getRESERVER2();
            if(obj==null) {
                dst.set(FIELD_RESERVER2,null);
            } else {
                dst.set(FIELD_RESERVER2,obj);
            }
        }
        if(et.isRowAmoutDirty() && (bIncEmpty||et.getRowAmout()!=null)) {
            Object obj = et.getRowAmout();
            if(obj==null) {
                dst.set(FIELD_ROWAMOUT,null);
            } else {
                dst.set(FIELD_ROWAMOUT,obj);
            }
        }
        if(et.isRTInfoDirty() && (bIncEmpty||et.getRTInfo()!=null)) {
            Object obj = et.getRTInfo();
            if(obj==null) {
                dst.set(FIELD_RTINFO,null);
            } else {
                dst.set(FIELD_RTINFO,obj);
            }
        }
        if(et.isSMALLICONDirty() && (bIncEmpty||et.getSMALLICON()!=null)) {
            Object obj = et.getSMALLICON();
            if(obj==null) {
                dst.set(FIELD_SMALLICON,null);
            } else {
                dst.set(FIELD_SMALLICON,obj);
            }
        }
        if(et.isStorageTypeDirty() && (bIncEmpty||et.getStorageType()!=null)) {
            Object obj = et.getStorageType();
            if(obj==null) {
                dst.set(FIELD_STORAGETYPE,null);
            } else {
                dst.set(FIELD_STORAGETYPE,obj);
            }
        }
        if(et.isTableNameDirty() && (bIncEmpty||et.getTableName()!=null)) {
            Object obj = et.getTableName();
            if(obj==null) {
                dst.set(FIELD_TABLENAME,null);
            } else {
                dst.set(FIELD_TABLENAME,obj);
            }
        }
        if(et.isTableSpaceDirty() && (bIncEmpty||et.getTableSpace()!=null)) {
            Object obj = et.getTableSpace();
            if(obj==null) {
                dst.set(FIELD_TABLESPACE,null);
            } else {
                dst.set(FIELD_TABLESPACE,obj);
            }
        }
        if(et.isTipsInfoDirty() && (bIncEmpty||et.getTipsInfo()!=null)) {
            Object obj = et.getTipsInfo();
            if(obj==null) {
                dst.set(FIELD_TIPSINFO,null);
            } else {
                dst.set(FIELD_TIPSINFO,obj);
            }
        }
        ...
        if(et.isUserActionDirty() && (bIncEmpty||et.getUserAction()!=null)) {
            Object obj = et.getUserAction();
            if(obj==null) {
                dst.set(FIELD_USERACTION,null);
            } else {
                dst.set(FIELD_USERACTION,obj);
            }
        }
        ...
        if(et.isVCFlagDirty() && (bIncEmpty||et.getVCFlag()!=null)) {
            Object obj = et.getVCFlag();
            if(obj==null) {
                dst.set(FIELD_VCFLAG,null);
            } else {
                dst.set(FIELD_VCFLAG,obj);
            }
        }
        if(et.isVerCheckTimerDirty() && (bIncEmpty||et.getVerCheckTimer()!=null)) {
            Object obj = et.getVerCheckTimer();
            if(obj==null) {
                dst.set(FIELD_VERCHECKTIMER,null);
            } else {
                dst.set(FIELD_VERCHECKTIMER,obj);
            }
        }
        if(et.isVerFieldDirty() && (bIncEmpty||et.getVerField()!=null)) {
            Object obj = et.getVerField();
            if(obj==null) {
                dst.set(FIELD_VERFIELD,null);
            } else {
                dst.set(FIELD_VERFIELD,obj);
            }
        }
        if(et.isVerHelperDirty() && (bIncEmpty||et.getVerHelper()!=null)) {
            Object obj = et.getVerHelper();
            if(obj==null) {
                dst.set(FIELD_VERHELPER,null);
            } else {
                dst.set(FIELD_VERHELPER,obj);
            }
        }
        if(et.isVersionCheckDirty() && (bIncEmpty||et.getVersionCheck()!=null)) {
            Object obj = et.getVersionCheck();
            if(obj==null) {
                dst.set(FIELD_VERSIONCHECK,null);
            } else {
                dst.set(FIELD_VERSIONCHECK,obj);
            }
        }
        if(et.isViewNameDirty() && (bIncEmpty||et.getViewName()!=null)) {
            Object obj = et.getViewName();
            if(obj==null) {
                dst.set(FIELD_VIEWNAME,null);
            } else {
                dst.set(FIELD_VIEWNAME,obj);
            }
        }
    }
