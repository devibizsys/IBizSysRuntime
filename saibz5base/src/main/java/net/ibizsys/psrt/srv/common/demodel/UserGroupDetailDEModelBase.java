...
import net.ibizsys.psrt.srv.common.demodel.usergroupdetail.ac.*;
import net.ibizsys.psrt.srv.common.demodel.usergroupdetail.dataset.*;
import net.ibizsys.psrt.srv.common.demodel.usergroupdetail.dataquery.*;
...
/**
 * 实体[USERGROUPDETAIL]模型对象基类
 */
public abstract class UserGroupDetailDEModelBase extends net.ibizsys.paas.demodel.DataEntityModelBase<UserGroupDetail>  {
    ...
    */
    ...
    protected void onFillFetchQuickSearchConditions(DEDataSetCond groupCondImpl,String strQuickSearch)  throws Exception {
        ...
        //放入属性 USERGROUPDETAILNAME - 用户组成员名称
        if(true) {
            DEDataSetCond deDataSetCondImpl = new DEDataSetCond();
            deDataSetCondImpl.setCondType(IDEDataSetCond.CONDTYPE_DEFIELD);
            deDataSetCondImpl.setCondOp(ICondition.CONDOP_LIKE);
            deDataSetCondImpl.setDEFName(UserGroupDetail.FIELD_USERGROUPDETAILNAME);
