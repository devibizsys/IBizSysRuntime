...
import net.ibizsys.psrt.srv.common.demodel.tssdtasklog.ac.*;
import net.ibizsys.psrt.srv.common.demodel.tssdtasklog.dataset.*;
import net.ibizsys.psrt.srv.common.demodel.tssdtasklog.dataquery.*;

import net.ibizsys.psrt.srv.common.entity.TSSDTaskLog;
import net.ibizsys.psrt.srv.common.service.TSSDTaskLogService;

/**
 * 实体[TSSDTASKLOG]模型对象基类
 */
public abstract class TSSDTaskLogDEModelBase extends net.ibizsys.paas.demodel.DataEntityModelBase<TSSDTaskLog>  {
    ...
    */
    ...
    protected void onFillFetchQuickSearchConditions(DEDataSetCond groupCondImpl,String strQuickSearch)  throws Exception {
        ...
        //放入属性 TSSDTASKLOGNAME - 任务调度日志名称
        if(true) {
            DEDataSetCond deDataSetCondImpl = new DEDataSetCond();
            deDataSetCondImpl.setCondType(IDEDataSetCond.CONDTYPE_DEFIELD);
            deDataSetCondImpl.setCondOp(ICondition.CONDOP_LIKE);
            deDataSetCondImpl.setDEFName(TSSDTaskLog.FIELD_TSSDTASKLOGNAME);
