...
/**
 * 实体[UserDGTheme] 服务对象基类
 */
public abstract class UserDGThemeServiceBase extends net.ibizsys.psrt.srv.PSRuntimeSysServiceBase<UserDGTheme> {
    ...
    protected void onCheckEntity(boolean bBaseMode,UserDGTheme  et, boolean bCreate, boolean bTempMode,EntityError entityError) throws Exception {
        ...
        //检查属性 表格编号
        entityFieldError = onCheckField_DataGridId( bBaseMode,  et,  bCreate,  bTempMode);
        if(entityFieldError!=null) {
            entityError.register(entityFieldError);
        }
        //检查属性 表格主题模型
        entityFieldError = onCheckField_DGThemeModel( bBaseMode,  et,  bCreate,  bTempMode);
        if(entityFieldError!=null) {
            entityError.register(entityFieldError);
        }
        //检查属性 人员编号
        entityFieldError = onCheckField_PersonId( bBaseMode,  et,  bCreate,  bTempMode);
        if(entityFieldError!=null) {
            entityError.register(entityFieldError);
        }
        //检查属性 项目编号
        ...
        //检查属性 表格列定义标识
        entityFieldError = onCheckField_UserDGThemeId( bBaseMode,  et,  bCreate,  bTempMode);
        if(entityFieldError!=null) {
            entityError.register(entityFieldError);
        }
        //检查属性 表格列定义名称
        entityFieldError = onCheckField_UserDGThemeName( bBaseMode,  et,  bCreate,  bTempMode);
        if(entityFieldError!=null) {
            entityError.register(entityFieldError);
        }
        ...
        if(bBaseMode) {
            if(bCreate) {
                if(StringHelper.isNullOrEmpty(value)) {
                    ...
                    entityFieldError.setFieldName(UserDGTheme.FIELD_DATAGRIDID);
            ...
            //检查值规则[默认规则]
            strRuleInfo =onTestValueRule_DataGridId_Default( et,  bCreate,  bTempMode);
    ...
    protected EntityFieldError onCheckField_DGThemeModel(boolean bBaseMode,UserDGTheme et, boolean bCreate, boolean bTempMode) throws Exception {
        ...
        if(bBaseMode) {
            ...
            String strRuleInfo  = null;
            //检查值规则[默认规则]
            strRuleInfo =onTestValueRule_DGThemeModel_Default( et,  bCreate,  bTempMode);
            if(!StringHelper.isNullOrEmpty(strRuleInfo)) {
                EntityFieldError entityFieldError = new EntityFieldError();
                entityFieldError.setFieldName(UserDGTheme.FIELD_DGTHEMEMODEL);
                entityFieldError.setErrorType(EntityFieldError.ERROR_VALUERULE);
                entityFieldError.setErrorInfo(strRuleInfo);
                return entityFieldError;
            }
    ...
    protected EntityFieldError onCheckField_PersonId(boolean bBaseMode,UserDGTheme et, boolean bCreate, boolean bTempMode) throws Exception {
        ...
        if(bBaseMode) {
            ...
            String strRuleInfo  = null;
            //检查值规则[默认规则]
            strRuleInfo =onTestValueRule_PersonId_Default( et,  bCreate,  bTempMode);
            if(!StringHelper.isNullOrEmpty(strRuleInfo)) {
                EntityFieldError entityFieldError = new EntityFieldError();
                entityFieldError.setFieldName(UserDGTheme.FIELD_PERSONID);
                entityFieldError.setErrorType(EntityFieldError.ERROR_VALUERULE);
                entityFieldError.setErrorInfo(strRuleInfo);
                return entityFieldError;
            }
    ...
    protected EntityFieldError onCheckField_ProjectId(boolean bBaseMode,UserDGTheme et, boolean bCreate, boolean bTempMode) throws Exception {
        ...
        if(bBaseMode) {
            ...
            if(!StringHelper.isNullOrEmpty(strRuleInfo)) {
                EntityFieldError entityFieldError = new EntityFieldError();
                entityFieldError.setFieldName(UserDGTheme.FIELD_PROJECTID);
                entityFieldError.setErrorType(EntityFieldError.ERROR_VALUERULE);
                entityFieldError.setErrorInfo(strRuleInfo);
                return entityFieldError;
            }
    ...
    protected EntityFieldError onCheckField_Reserver(boolean bBaseMode,UserDGTheme et, boolean bCreate, boolean bTempMode) throws Exception {
        ...
        if(bBaseMode) {
            ...
            if(!StringHelper.isNullOrEmpty(strRuleInfo)) {
                EntityFieldError entityFieldError = new EntityFieldError();
                entityFieldError.setFieldName(UserDGTheme.FIELD_RESERVER);
                entityFieldError.setErrorType(EntityFieldError.ERROR_VALUERULE);
                entityFieldError.setErrorInfo(strRuleInfo);
                return entityFieldError;
            }
    ...
    protected EntityFieldError onCheckField_Reserver2(boolean bBaseMode,UserDGTheme et, boolean bCreate, boolean bTempMode) throws Exception {
        ...
        if(bBaseMode) {
            ...
            if(!StringHelper.isNullOrEmpty(strRuleInfo)) {
                EntityFieldError entityFieldError = new EntityFieldError();
                entityFieldError.setFieldName(UserDGTheme.FIELD_RESERVER2);
                entityFieldError.setErrorType(EntityFieldError.ERROR_VALUERULE);
                entityFieldError.setErrorInfo(strRuleInfo);
                return entityFieldError;
            }
    ...
    protected EntityFieldError onCheckField_Reserver3(boolean bBaseMode,UserDGTheme et, boolean bCreate, boolean bTempMode) throws Exception {
        ...
        if(bBaseMode) {
            ...
            if(!StringHelper.isNullOrEmpty(strRuleInfo)) {
                EntityFieldError entityFieldError = new EntityFieldError();
                entityFieldError.setFieldName(UserDGTheme.FIELD_RESERVER3);
                entityFieldError.setErrorType(EntityFieldError.ERROR_VALUERULE);
                entityFieldError.setErrorInfo(strRuleInfo);
                return entityFieldError;
            }
    ...
    protected EntityFieldError onCheckField_UserDGThemeId(boolean bBaseMode,UserDGTheme et, boolean bCreate, boolean bTempMode) throws Exception {
        ...
        if(bBaseMode) {
            if(bCreate) {
                if(StringHelper.isNullOrEmpty(value)) {
                    EntityFieldError entityFieldError = new EntityFieldError();
                    entityFieldError.setFieldName(UserDGTheme.FIELD_USERDGTHEMEID);
                    entityFieldError.setErrorType(EntityFieldError.ERROR_EMPTY);
                    return entityFieldError;
                }
            }
            ...
            String strRuleInfo  = null;
            //检查值规则[默认规则]
            strRuleInfo =onTestValueRule_UserDGThemeId_Default( et,  bCreate,  bTempMode);
            if(!StringHelper.isNullOrEmpty(strRuleInfo)) {
                EntityFieldError entityFieldError = new EntityFieldError();
                entityFieldError.setFieldName(UserDGTheme.FIELD_USERDGTHEMEID);
                entityFieldError.setErrorType(EntityFieldError.ERROR_VALUERULE);
    ...
    protected EntityFieldError onCheckField_UserDGThemeName(boolean bBaseMode,UserDGTheme et, boolean bCreate, boolean bTempMode) throws Exception {
        ...
        if(bBaseMode) {
            if(bCreate) {
                if(StringHelper.isNullOrEmpty(value)) {
                    EntityFieldError entityFieldError = new EntityFieldError();
                    entityFieldError.setFieldName(UserDGTheme.FIELD_USERDGTHEMENAME);
                    entityFieldError.setErrorType(EntityFieldError.ERROR_EMPTY);
                    return entityFieldError;
                }
            }
            ...
            String strRuleInfo  = null;
            //检查值规则[默认规则]
            strRuleInfo =onTestValueRule_UserDGThemeName_Default( et,  bCreate,  bTempMode);
            if(!StringHelper.isNullOrEmpty(strRuleInfo)) {
                EntityFieldError entityFieldError = new EntityFieldError();
                entityFieldError.setFieldName(UserDGTheme.FIELD_USERDGTHEMENAME);
                entityFieldError.setErrorType(EntityFieldError.ERROR_VALUERULE);
    ...
    protected String onTestValueRule(String strDEFieldName,String strRule,IEntity et,boolean bCreate,boolean bTempMode) throws Exception {
        if((StringHelper.compare(strDEFieldName,UserDGTheme.FIELD_USERDGTHEMEID,true)==0)
                &&(StringHelper.compare(strRule,"DEFAULT",true)==0))
            return onTestValueRule_UserDGThemeId_Default(et,bCreate,bTempMode);
        if((StringHelper.compare(strDEFieldName,UserDGTheme.FIELD_USERDGTHEMENAME,true)==0)
                &&(StringHelper.compare(strRule,"DEFAULT",true)==0))
            return onTestValueRule_UserDGThemeName_Default(et,bCreate,bTempMode);
        if((StringHelper.compare(strDEFieldName,UserDGTheme.FIELD_CREATEMAN,true)==0)
                &&(StringHelper.compare(strRule,"DEFAULT",true)==0))
            return onTestValueRule_CreateMan_Default(et,bCreate,bTempMode);
        if((StringHelper.compare(strDEFieldName,UserDGTheme.FIELD_CREATEDATE,true)==0)
                &&(StringHelper.compare(strRule,"DEFAULT",true)==0))
            return onTestValueRule_CreateDate_Default(et,bCreate,bTempMode);
        if((StringHelper.compare(strDEFieldName,UserDGTheme.FIELD_UPDATEMAN,true)==0)
                &&(StringHelper.compare(strRule,"DEFAULT",true)==0))
            return onTestValueRule_UpdateMan_Default(et,bCreate,bTempMode);
        if((StringHelper.compare(strDEFieldName,UserDGTheme.FIELD_UPDATEDATE,true)==0)
                &&(StringHelper.compare(strRule,"DEFAULT",true)==0))
            return onTestValueRule_UpdateDate_Default(et,bCreate,bTempMode);
        if((StringHelper.compare(strDEFieldName,UserDGTheme.FIELD_DATAGRIDID,true)==0)
                &&(StringHelper.compare(strRule,"DEFAULT",true)==0))
            return onTestValueRule_DataGridId_Default(et,bCreate,bTempMode);
        if((StringHelper.compare(strDEFieldName,UserDGTheme.FIELD_PROJECTID,true)==0)
                &&(StringHelper.compare(strRule,"DEFAULT",true)==0))
            return onTestValueRule_ProjectId_Default(et,bCreate,bTempMode);
        if((StringHelper.compare(strDEFieldName,UserDGTheme.FIELD_PERSONID,true)==0)
                &&(StringHelper.compare(strRule,"DEFAULT",true)==0))
            return onTestValueRule_PersonId_Default(et,bCreate,bTempMode);
        if((StringHelper.compare(strDEFieldName,UserDGTheme.FIELD_RESERVER,true)==0)
                &&(StringHelper.compare(strRule,"DEFAULT",true)==0))
            return onTestValueRule_Reserver_Default(et,bCreate,bTempMode);
        if((StringHelper.compare(strDEFieldName,UserDGTheme.FIELD_RESERVER2,true)==0)
                &&(StringHelper.compare(strRule,"DEFAULT",true)==0))
            return onTestValueRule_Reserver2_Default(et,bCreate,bTempMode);
        if((StringHelper.compare(strDEFieldName,UserDGTheme.FIELD_RESERVER3,true)==0)
                &&(StringHelper.compare(strRule,"DEFAULT",true)==0))
            return onTestValueRule_Reserver3_Default(et,bCreate,bTempMode);
        if((StringHelper.compare(strDEFieldName,UserDGTheme.FIELD_DGTHEMEMODEL,true)==0)
                &&(StringHelper.compare(strRule,"DEFAULT",true)==0))
            return onTestValueRule_DGThemeModel_Default(et,bCreate,bTempMode);
    ...
    protected String onTestValueRule_UserDGThemeId_Default(IEntity et,boolean bCreate,boolean bTempMode) throws Exception {
        try {
            if((checkFieldStringLengthRule("USERDGTHEMEID", et, bTempMode,null,false,100,true,"内容长度必须小于等于[100]")))
                return null;
    ...
    protected String onTestValueRule_UserDGThemeName_Default(IEntity et,boolean bCreate,boolean bTempMode) throws Exception {
        try {
            if((checkFieldStringLengthRule("USERDGTHEMENAME", et, bTempMode,null,false,200,true,"内容长度必须小于等于[200]")))
                return null;
    ...
    protected String onTestValueRule_DataGridId_Default(IEntity et,boolean bCreate,boolean bTempMode) throws Exception {
        try {
            if((checkFieldStringLengthRule("DATAGRIDID", et, bTempMode,null,false,200,true,"内容长度必须小于等于[200]")))
                return null;
            return "内容长度必须小于等于[200]";
        } catch(Exception ex) {
            return ex.getMessage();
    ...
    protected String onTestValueRule_ProjectId_Default(IEntity et,boolean bCreate,boolean bTempMode) throws Exception {
        try {
            if((checkFieldStringLengthRule("PROJECTID", et, bTempMode,null,false,200,true,"内容长度必须小于等于[200]")))
                return null;
            return "内容长度必须小于等于[200]";
        } catch(Exception ex) {
            return ex.getMessage();
    ...
    protected String onTestValueRule_PersonId_Default(IEntity et,boolean bCreate,boolean bTempMode) throws Exception {
        try {
            if((checkFieldStringLengthRule("PERSONID", et, bTempMode,null,false,200,true,"内容长度必须小于等于[200]")))
                return null;
            return "内容长度必须小于等于[200]";
        } catch(Exception ex) {
            return ex.getMessage();
    ...
    protected String onTestValueRule_Reserver_Default(IEntity et,boolean bCreate,boolean bTempMode) throws Exception {
        try {
            if((checkFieldStringLengthRule("RESERVER", et, bTempMode,null,false,200,true,"内容长度必须小于等于[200]")))
                return null;
            return "内容长度必须小于等于[200]";
        } catch(Exception ex) {
            return ex.getMessage();
    ...
    protected String onTestValueRule_Reserver2_Default(IEntity et,boolean bCreate,boolean bTempMode) throws Exception {
        try {
            if((checkFieldStringLengthRule("RESERVER2", et, bTempMode,null,false,200,true,"内容长度必须小于等于[200]")))
                return null;
            return "内容长度必须小于等于[200]";
        } catch(Exception ex) {
            return ex.getMessage();
    ...
    protected String onTestValueRule_Reserver3_Default(IEntity et,boolean bCreate,boolean bTempMode) throws Exception {
        try {
            if((checkFieldStringLengthRule("RESERVER3", et, bTempMode,null,false,200,true,"内容长度必须小于等于[200]")))
                return null;
            return "内容长度必须小于等于[200]";
        } catch(Exception ex) {
            return ex.getMessage();
    ...
    protected String onTestValueRule_DGThemeModel_Default(IEntity et,boolean bCreate,boolean bTempMode) throws Exception {
        try {
            if((checkFieldStringLengthRule("DGTHEMEMODEL", et, bTempMode,null,false,3000,true,"内容长度必须小于等于[3000]")))
                return null;
