 ...
 * 实体[SysAdmin] DAO对象基类
 */
public abstract class SysAdminDAOBase extends net.ibizsys.psrt.srv.PSRuntimeSysDAOBase<SysAdmin> {

    private static final long serialVersionUID = -1L;

    public SysAdminDAOBase() {
        super();
    ...
    protected String getDAOId() {
        return "net.ibizsys.psrt.srv.common.dao.SysAdminDAO";
    }
