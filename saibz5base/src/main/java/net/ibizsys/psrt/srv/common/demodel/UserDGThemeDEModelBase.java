...
import net.ibizsys.psrt.srv.common.demodel.userdgtheme.ac.*;
import net.ibizsys.psrt.srv.common.demodel.userdgtheme.dataset.*;
import net.ibizsys.psrt.srv.common.demodel.userdgtheme.dataquery.*;

import net.ibizsys.psrt.srv.common.entity.UserDGTheme;
import net.ibizsys.psrt.srv.common.service.UserDGThemeService;

/**
 * 实体[USERDGTHEME]模型对象基类
 */
public abstract class UserDGThemeDEModelBase extends net.ibizsys.paas.demodel.DataEntityModelBase<UserDGTheme>  {
    ...
    public  UserDGThemeService getRealService() {
        if(this.userDGThemeService==null) {
            try {
                this.userDGThemeService = (UserDGThemeService)ServiceGlobal.getService(getServiceId());
            } catch(Exception ex) {
            }
        }
    ...
    */
    ...
    protected void onFillFetchQuickSearchConditions(DEDataSetCond groupCondImpl,String strQuickSearch)  throws Exception {
        ...
        //放入属性 USERDGTHEMENAME - 表格列定义名称
        if(true) {
            DEDataSetCond deDataSetCondImpl = new DEDataSetCond();
            deDataSetCondImpl.setCondType(IDEDataSetCond.CONDTYPE_DEFIELD);
            deDataSetCondImpl.setCondOp(ICondition.CONDOP_LIKE);
            deDataSetCondImpl.setDEFName(UserDGTheme.FIELD_USERDGTHEMENAME);
