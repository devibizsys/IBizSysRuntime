...
import net.ibizsys.psrt.srv.common.demodel.msgaccountdetail.ac.*;
import net.ibizsys.psrt.srv.common.demodel.msgaccountdetail.dataset.*;
import net.ibizsys.psrt.srv.common.demodel.msgaccountdetail.dataquery.*;
...
/**
 * 实体[MSGACCOUNTDETAIL]模型对象基类
 */
public abstract class MsgAccountDetailDEModelBase extends net.ibizsys.paas.demodel.DataEntityModelBase<MsgAccountDetail>  {
    ...
    public  MsgAccountDetailService getRealService() {
        if(this.msgAccountDetailService==null) {
            try {
                this.msgAccountDetailService = (MsgAccountDetailService)ServiceGlobal.getService(getServiceId());
            } catch(Exception ex) {
            }
        }
    ...
    protected void prepareDEFields() throws Exception {
        ...
        if(iDEField==null) {
            ...
            deFieldModel.setValueFormat("%1$s");
            iDEFSearchMode = this.createDEFSearchMode(deFieldModel,"N_MAJORMSGACCOUNTNAME_LIKE");
            if(iDEFSearchMode==null) {
                DEFSearchModeModel defSearchModeModel = new DEFSearchModeModel();
                defSearchModeModel.setDEField(deFieldModel);
        ...
        if(iDEField==null) {
            ...
            deFieldModel.setPhisicalDEField(false);
            deFieldModel.setValueFormat("%1$s");
            iDEFSearchMode = this.createDEFSearchMode(deFieldModel,"N_MINORMSGACCOUNTNAME_LIKE");
            if(iDEFSearchMode==null) {
                DEFSearchModeModel defSearchModeModel = new DEFSearchModeModel();
                defSearchModeModel.setDEField(deFieldModel);
    ...
    */
    ...
    protected void onFillFetchQuickSearchConditions(DEDataSetCond groupCondImpl,String strQuickSearch)  throws Exception {
        ...
        //放入属性 MSGACCOUNTDETAILNAME - 组消息账户明细名称
        if(true) {
            DEDataSetCond deDataSetCondImpl = new DEDataSetCond();
            deDataSetCondImpl.setCondType(IDEDataSetCond.CONDTYPE_DEFIELD);
            deDataSetCondImpl.setCondOp(ICondition.CONDOP_LIKE);
            deDataSetCondImpl.setDEFName(MsgAccountDetail.FIELD_MSGACCOUNTDETAILNAME);
