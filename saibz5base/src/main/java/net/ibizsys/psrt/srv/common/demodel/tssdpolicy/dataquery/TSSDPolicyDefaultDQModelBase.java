...
@DEDataQueryCodes({
    @DEDataQueryCode(querycode="SELECT t1.CREATEDATE AS CREATEDATE, t1.CREATEMAN AS CREATEMAN, t1.MEMO AS MEMO, t1.TSSDPOLICYID AS TSSDPOLICYID, t1.TSSDPOLICYNAME AS TSSDPOLICYNAME, t1.TSSDPOLICYTYPE AS TSSDPOLICYTYPE, t1.UPDATEDATE AS UPDATEDATE, t1.UPDATEMAN AS UPDATEMAN FROM T_SRFTSSDPOLICY t1 ",querycodetemp="",declarecode="",dbtype="DB2",
    fieldexps={
