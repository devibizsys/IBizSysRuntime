...
/**
 * 实体[DataSyncOut] 数据对象基类
 */
public abstract class DataSyncOutBase extends net.ibizsys.paas.entity.EntityBase implements Serializable {
    ...
    private final static int INDEX_DATASYNCOUTID = 4;
    private final static int INDEX_DATASYNCOUTNAME = 5;
    private final static int INDEX_DEID = 6;
    private final static int INDEX_DENAME = 7;
    private final static int INDEX_EVENTTYPE = 8;
    private final static int INDEX_FILELIST = 9;
    ...
    static {
        ...
        fieldIndexMap.put( FIELD_DATASYNCOUTID, INDEX_DATASYNCOUTID);
        fieldIndexMap.put( FIELD_DATASYNCOUTNAME, INDEX_DATASYNCOUTNAME);
    ...
    private DataSyncOutBase proxyDataSyncOutBase = null;

    public DataSyncOutBase() {
        super();
    }
    ...
    private boolean datasyncoutidDirtyFlag = false;
    private boolean datasyncoutnameDirtyFlag = false;
    ...
    @Column(name="datasyncoutid")
    private String datasyncoutid;
    @Column(name="datasyncoutname")
    ...
    public void setDataSyncOutId(String datasyncoutid) {
        ...
        if(this.getProxyEntity()!=null) {
            this.getProxyEntity().setDataSyncOutId(datasyncoutid);
            return;
        }
        if(datasyncoutid!=null) {
            datasyncoutid = StringHelper.trimRight(datasyncoutid);
            if(datasyncoutid.length()==0) {
                datasyncoutid = null;
            }
        }
        this.datasyncoutid =  datasyncoutid;
        this.datasyncoutidDirtyFlag  = true;
    }
    ...
    public String getDataSyncOutId() {
        if(this.getProxyEntity()!=null) {
            return this.getProxyEntity().getDataSyncOutId();
        }
        return this.datasyncoutid;
    }

    /**
     *  获取属性值[数据同步发送队列标识]是否修改
     */
    public boolean isDataSyncOutIdDirty() {
        if(this.getProxyEntity()!=null) {
            return this.getProxyEntity().isDataSyncOutIdDirty();
        }
        return this.datasyncoutidDirtyFlag;
    }

    /**
     *  重置属性值[数据同步发送队列标识]
     */
    public void resetDataSyncOutId() {

        if(this.getProxyEntity()!=null) {
            this.getProxyEntity().resetDataSyncOutId();
            return;
        }

        this.datasyncoutidDirtyFlag = false;
        this.datasyncoutid = null;
    }
    /**
     *  设置属性值[数据同步发送队列名称]
     *  @param datasyncoutname
     */
    public void setDataSyncOutName(String datasyncoutname) {

        if(this.getProxyEntity()!=null) {
            this.getProxyEntity().setDataSyncOutName(datasyncoutname);
            return;
        }
        if(datasyncoutname!=null) {
            datasyncoutname = StringHelper.trimRight(datasyncoutname);
            if(datasyncoutname.length()==0) {
                datasyncoutname = null;
            }
        }
        this.datasyncoutname =  datasyncoutname;
        this.datasyncoutnameDirtyFlag  = true;
    }
    ...
    public String getDataSyncOutName() {
        if(this.getProxyEntity()!=null) {
            return this.getProxyEntity().getDataSyncOutName();
        }
        return this.datasyncoutname;
    }

    /**
     *  获取属性值[数据同步发送队列名称]是否修改
     */
    public boolean isDataSyncOutNameDirty() {
        if(this.getProxyEntity()!=null) {
            return this.getProxyEntity().isDataSyncOutNameDirty();
        }
        return this.datasyncoutnameDirtyFlag;
    }

    /**
     *  重置属性值[数据同步发送队列名称]
     */
    public void resetDataSyncOutName() {

        if(this.getProxyEntity()!=null) {
            this.getProxyEntity().resetDataSyncOutName();
            return;
        }

        this.datasyncoutnameDirtyFlag = false;
        this.datasyncoutname = null;
    }
    /**
     *  设置属性值[数据实体]
     *  @param deid
     ...
     * @param entity
     */
    private static void resetAll(DataSyncOutBase et) {
        et.resetCreateDate();
        et.resetCreateMan();
        et.resetData();
        et.resetDataKey();
        et.resetDataSyncOutId();
        et.resetDataSyncOutName();
        et.resetDEId();
        et.resetDEName();
        et.resetEventType();
        et.resetFileList();
    ...
    protected void onFillMap(HashMap<String, Object> params, boolean bDirtyOnly) {
        ...
        if(!bDirtyOnly || isDataSyncOutIdDirty()) {
            params.put(FIELD_DATASYNCOUTID,getDataSyncOutId());
        }
        if(!bDirtyOnly || isDataSyncOutNameDirty()) {
            params.put(FIELD_DATASYNCOUTNAME,getDataSyncOutName());
        }
    ...
    public Object get(String strParamName) throws Exception {
        ...
        return  DataSyncOutBase.get(this, index);
    }
     ...
     * @throws Exception
     */
    private static Object get(DataSyncOutBase et,int index) throws Exception {
        ...
        case INDEX_DATASYNCOUTID:
            return et.getDataSyncOutId();
        case INDEX_DATASYNCOUTNAME:
            return et.getDataSyncOutName();
        case INDEX_DEID:
            return et.getDEId();
        case INDEX_DENAME:
            return et.getDEName();
    ...
    public void set(String strParamName,Object objValue) throws Exception {
        ...
        DataSyncOutBase.set(this,index,objValue);
    }
     ...
     * @throws Exception
     */
    private static void set(DataSyncOutBase et,int index,Object obj) throws Exception {
        switch(index) {
        case INDEX_CREATEDATE:
        ...
        case INDEX_DATAKEY:
            ...
            return ;
        case INDEX_DATASYNCOUTID:
            et.setDataSyncOutId(DataObject.getStringValue(obj));
            return ;
        case INDEX_DATASYNCOUTNAME:
            et.setDataSyncOutName(DataObject.getStringValue(obj));
            return ;
        case INDEX_DEID:
    ...
    public boolean isNull(String strParamName) throws Exception {
        ...
        return  DataSyncOutBase.isNull(this, index);
    }
     ...
     * @throws Exception
     */
    private static boolean isNull(DataSyncOutBase et,int index) throws Exception {
        ...
        case INDEX_DATASYNCOUTID:
            return et.getDataSyncOutId()==null;
        case INDEX_DATASYNCOUTNAME:
            return et.getDataSyncOutName()==null;
        case INDEX_DEID:
    ...
    public boolean contains(String strParamName) throws Exception {
        ...
        return  DataSyncOutBase.contains(this, index);
    }
     ...
     * @throws Exception
     */
    private static boolean contains(DataSyncOutBase et,int index) throws Exception {
        ...
        case INDEX_DATASYNCOUTID:
            return et.isDataSyncOutIdDirty();
        case INDEX_DATASYNCOUTNAME:
            return et.isDataSyncOutNameDirty();
        case INDEX_DEID:
     ...
     * @throws Exception
     */
    private static  void fillJSONObject(DataSyncOutBase et,JSONObject json, boolean bIncEmpty) throws Exception {
        ...
        if(bIncEmpty||et.getDataSyncOutId()!=null) {
            json.put("datasyncoutid", getJSONValue(et.getDataSyncOutId()));
        }
        if(bIncEmpty||et.getDataSyncOutName()!=null) {
            json.put("datasyncoutname", getJSONValue(et.getDataSyncOutName()));
        }
        ...
        if(bIncEmpty||et.getFileList()!=null) {
            json.put("filelist", getJSONValue(et.getFileList()));
        }
     ...
     * @throws Exception
     */
    private static void fillXmlNode(DataSyncOutBase et,XmlNode node,boolean bIncEmpty) throws Exception {
        if(bIncEmpty||et.getCreateDate()!=null) {
        ...
        if(bIncEmpty||et.getDataSyncOutId()!=null) {
            Object obj = et.getDataSyncOutId();
            node.setAttribute("DATASYNCOUTID",(obj==null)?"":(String)obj);
        }
        if(bIncEmpty||et.getDataSyncOutName()!=null) {
            Object obj = et.getDataSyncOutName();
            node.setAttribute("DATASYNCOUTNAME",(obj==null)?"":(String)obj);
        }
        if(bIncEmpty||et.getDEId()!=null) {
    ...
    protected void onCopyTo(IDataObject dataEntity, boolean bIncludeEmtpy) throws Exception {
        DataSyncOutBase.copyTo(this,dataEntity,bIncludeEmtpy);
     ...
     * @throws Exception
     */
    private static void copyTo(DataSyncOutBase et,IDataObject dst,boolean bIncEmpty) throws Exception {
        ...
        if(et.isDataSyncOutIdDirty() && (bIncEmpty||et.getDataSyncOutId()!=null)) {
            Object obj = et.getDataSyncOutId();
            if(obj==null) {
                dst.set(FIELD_DATASYNCOUTID,null);
            } else {
                dst.set(FIELD_DATASYNCOUTID,obj);
            }
        }
        if(et.isDataSyncOutNameDirty() && (bIncEmpty||et.getDataSyncOutName()!=null)) {
            Object obj = et.getDataSyncOutName();
            if(obj==null) {
                dst.set(FIELD_DATASYNCOUTNAME,null);
            } else {
                dst.set(FIELD_DATASYNCOUTNAME,obj);
            }
        }
        ...
        if(et.isFileListDirty() && (bIncEmpty||et.getFileList()!=null)) {
            Object obj = et.getFileList();
            if(obj==null) {
                dst.set(FIELD_FILELIST,null);
            } else {
                dst.set(FIELD_FILELIST,obj);
            }
        }
    ...
    public boolean remove(String strParamName) throws Exception {
        ...
        return  DataSyncOutBase.remove(this, index);
    }
     ...
     * @throws Exception
     */
    private static boolean remove(DataSyncOutBase et,int index) throws Exception {
    ...
    */
     ...
     *  获取代理的数据对象
     */
    private DataSyncOutBase getProxyEntity() {
        return this.proxyDataSyncOutBase;
    }
    ...
    protected void onProxy(IDataObject proxyDataObject) {
        this.proxyDataSyncOutBase = null;
        if(proxyDataObject!=null && proxyDataObject instanceof DataSyncOutBase) {
            this.proxyDataSyncOutBase = (DataSyncOutBase)proxyDataObject;
        }
