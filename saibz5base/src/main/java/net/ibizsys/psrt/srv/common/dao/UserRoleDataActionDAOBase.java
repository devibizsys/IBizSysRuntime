...
/**
 * 实体[UserRoleDataAction] DAO对象基类
 */
public abstract class UserRoleDataActionDAOBase extends net.ibizsys.psrt.srv.PSRuntimeSysDAOBase<UserRoleDataAction> {

    private static final long serialVersionUID = -1L;

    public UserRoleDataActionDAOBase() {
        super();
