 ...
 * 实体[UserDict] 数据对象基类
 */
public abstract class UserDictBase extends net.ibizsys.paas.entity.EntityBase implements Serializable {
    ...
    private final static int INDEX_OWNERID = 3;
    private final static int INDEX_OWNERTYPE = 4;
    private final static int INDEX_UPDATEDATE = 5;
    private final static int INDEX_UPDATEMAN = 6;
    private final static int INDEX_USERDICTID = 7;
    private final static int INDEX_USERDICTNAME = 8;
