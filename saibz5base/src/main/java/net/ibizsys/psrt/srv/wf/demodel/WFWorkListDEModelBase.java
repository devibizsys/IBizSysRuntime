...
import net.ibizsys.psrt.srv.wf.demodel.wfworklist.ac.*;
import net.ibizsys.psrt.srv.wf.demodel.wfworklist.dataset.*;
import net.ibizsys.psrt.srv.wf.demodel.wfworklist.dataquery.*;

import net.ibizsys.psrt.srv.wf.entity.WFWorkList;
import net.ibizsys.psrt.srv.wf.service.WFWorkListService;

/**
 * 实体[WFWORKLIST]模型对象基类
 */
public abstract class WFWorkListDEModelBase extends net.ibizsys.paas.demodel.DataEntityModelBase<WFWorkList>  {
    ...
    */
    ...
    protected void onFillFetchQuickSearchConditions(DEDataSetCond groupCondImpl,String strQuickSearch)  throws Exception {
        ...
        if(true) {
            ...
            deDataSetCondImpl.setDEFName(WFWorkList.FIELD_WFWORKLISTNAME);
