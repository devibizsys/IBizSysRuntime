...
/**
 * 实体[WFUserGroup] 数据对象基类
 */
public abstract class WFUserGroupBase extends net.ibizsys.paas.entity.EntityBase implements Serializable {
    ...
    private final static int INDEX_WFUSERGROUPID = 5;
    private final static int INDEX_WFUSERGROUPNAME = 6;
