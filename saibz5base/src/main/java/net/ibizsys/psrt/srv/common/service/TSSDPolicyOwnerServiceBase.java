...
/**
 * 实体[TSSDPolicyOwner] 服务对象基类
 */
public abstract class TSSDPolicyOwnerServiceBase extends net.ibizsys.psrt.srv.PSRuntimeSysServiceBase<TSSDPolicyOwner> {
    ...
    public TSSDPolicyOwnerServiceBase () {
        super();
    ...
    protected void onCheckEntity(boolean bBaseMode,TSSDPolicyOwner  et, boolean bCreate, boolean bTempMode,EntityError entityError) throws Exception {
        ...
        //检查属性 任务时刻策略所有者标识
        entityFieldError = onCheckField_TSSDPolicyOwnerId( bBaseMode,  et,  bCreate,  bTempMode);
        if(entityFieldError!=null) {
            entityError.register(entityFieldError);
        }
        //检查属性 实际主键
        entityFieldError = onCheckField_TSSDPolicyOwnerId2( bBaseMode,  et,  bCreate,  bTempMode);
        if(entityFieldError!=null) {
            entityError.register(entityFieldError);
        }
        //检查属性 任务时刻策略所有者名称
        entityFieldError = onCheckField_TSSDPolicyOwnerName( bBaseMode,  et,  bCreate,  bTempMode);
        if(entityFieldError!=null) {
            entityError.register(entityFieldError);
        }
        //检查属性 所有者类型
        entityFieldError = onCheckField_TSSDPolicyOwnerType( bBaseMode,  et,  bCreate,  bTempMode);
        if(entityFieldError!=null) {
            entityError.register(entityFieldError);
        }
        ...
        if(bBaseMode) {
            if(bCreate) {
                if(StringHelper.isNullOrEmpty(value)) {
                    ...
                    entityFieldError.setFieldName(TSSDPolicyOwner.FIELD_TSSDPOLICYOWNERID);
            ...
            //检查值规则[默认规则]
            strRuleInfo =onTestValueRule_TSSDPolicyOwnerId_Default( et,  bCreate,  bTempMode);
    ...
    protected EntityFieldError onCheckField_TSSDPolicyOwnerId2(boolean bBaseMode,TSSDPolicyOwner et, boolean bCreate, boolean bTempMode) throws Exception {
        ...
        if(bBaseMode) {
            if(bCreate) {
                if(StringHelper.isNullOrEmpty(value)) {
                    EntityFieldError entityFieldError = new EntityFieldError();
                    entityFieldError.setFieldName(TSSDPolicyOwner.FIELD_TSSDPOLICYOWNERID2);
                    entityFieldError.setErrorType(EntityFieldError.ERROR_EMPTY);
                    return entityFieldError;
                }
            }
            ...
            String strRuleInfo  = null;
            //检查值规则[默认规则]
            strRuleInfo =onTestValueRule_TSSDPolicyOwnerId2_Default( et,  bCreate,  bTempMode);
            if(!StringHelper.isNullOrEmpty(strRuleInfo)) {
                EntityFieldError entityFieldError = new EntityFieldError();
                entityFieldError.setFieldName(TSSDPolicyOwner.FIELD_TSSDPOLICYOWNERID2);
                entityFieldError.setErrorType(EntityFieldError.ERROR_VALUERULE);
    ...
    protected EntityFieldError onCheckField_TSSDPolicyOwnerName(boolean bBaseMode,TSSDPolicyOwner et, boolean bCreate, boolean bTempMode) throws Exception {
        ...
        if(bBaseMode) {
            if(bCreate) {
                if(StringHelper.isNullOrEmpty(value)) {
                    EntityFieldError entityFieldError = new EntityFieldError();
                    entityFieldError.setFieldName(TSSDPolicyOwner.FIELD_TSSDPOLICYOWNERNAME);
                    entityFieldError.setErrorType(EntityFieldError.ERROR_EMPTY);
                    return entityFieldError;
                }
            }
            ...
            String strRuleInfo  = null;
            //检查值规则[默认规则]
            strRuleInfo =onTestValueRule_TSSDPolicyOwnerName_Default( et,  bCreate,  bTempMode);
            if(!StringHelper.isNullOrEmpty(strRuleInfo)) {
                EntityFieldError entityFieldError = new EntityFieldError();
                entityFieldError.setFieldName(TSSDPolicyOwner.FIELD_TSSDPOLICYOWNERNAME);
                entityFieldError.setErrorType(EntityFieldError.ERROR_VALUERULE);
    ...
    protected EntityFieldError onCheckField_TSSDPolicyOwnerType(boolean bBaseMode,TSSDPolicyOwner et, boolean bCreate, boolean bTempMode) throws Exception {
        ...
        if(bBaseMode) {
            if(bCreate) {
                if(StringHelper.isNullOrEmpty(value)) {
                    EntityFieldError entityFieldError = new EntityFieldError();
                    entityFieldError.setFieldName(TSSDPolicyOwner.FIELD_TSSDPOLICYOWNERTYPE);
                    entityFieldError.setErrorType(EntityFieldError.ERROR_EMPTY);
                    return entityFieldError;
                }
            }
            ...
            String strRuleInfo  = null;
            //检查值规则[默认规则]
            strRuleInfo =onTestValueRule_TSSDPolicyOwnerType_Default( et,  bCreate,  bTempMode);
            if(!StringHelper.isNullOrEmpty(strRuleInfo)) {
                EntityFieldError entityFieldError = new EntityFieldError();
                entityFieldError.setFieldName(TSSDPolicyOwner.FIELD_TSSDPOLICYOWNERTYPE);
                entityFieldError.setErrorType(EntityFieldError.ERROR_VALUERULE);
    ...
    protected String onTestValueRule(String strDEFieldName,String strRule,IEntity et,boolean bCreate,boolean bTempMode) throws Exception {
        if((StringHelper.compare(strDEFieldName,TSSDPolicyOwner.FIELD_TSSDPOLICYOWNERID,true)==0)
                &&(StringHelper.compare(strRule,"DEFAULT",true)==0))
            return onTestValueRule_TSSDPolicyOwnerId_Default(et,bCreate,bTempMode);
        if((StringHelper.compare(strDEFieldName,TSSDPolicyOwner.FIELD_TSSDPOLICYOWNERNAME,true)==0)
                &&(StringHelper.compare(strRule,"DEFAULT",true)==0))
            return onTestValueRule_TSSDPolicyOwnerName_Default(et,bCreate,bTempMode);
        if((StringHelper.compare(strDEFieldName,TSSDPolicyOwner.FIELD_TSSDPOLICYOWNERTYPE,true)==0)
                &&(StringHelper.compare(strRule,"DEFAULT",true)==0))
            return onTestValueRule_TSSDPolicyOwnerType_Default(et,bCreate,bTempMode);
        if((StringHelper.compare(strDEFieldName,TSSDPolicyOwner.FIELD_CREATEMAN,true)==0)
                &&(StringHelper.compare(strRule,"DEFAULT",true)==0))
            return onTestValueRule_CreateMan_Default(et,bCreate,bTempMode);
        if((StringHelper.compare(strDEFieldName,TSSDPolicyOwner.FIELD_CREATEDATE,true)==0)
                &&(StringHelper.compare(strRule,"DEFAULT",true)==0))
            return onTestValueRule_CreateDate_Default(et,bCreate,bTempMode);
        if((StringHelper.compare(strDEFieldName,TSSDPolicyOwner.FIELD_UPDATEMAN,true)==0)
                &&(StringHelper.compare(strRule,"DEFAULT",true)==0))
            return onTestValueRule_UpdateMan_Default(et,bCreate,bTempMode);
        if((StringHelper.compare(strDEFieldName,TSSDPolicyOwner.FIELD_UPDATEDATE,true)==0)
                &&(StringHelper.compare(strRule,"DEFAULT",true)==0))
            return onTestValueRule_UpdateDate_Default(et,bCreate,bTempMode);
        if((StringHelper.compare(strDEFieldName,TSSDPolicyOwner.FIELD_TSSDPOLICYOWNERID2,true)==0)
                &&(StringHelper.compare(strRule,"DEFAULT",true)==0))
            return onTestValueRule_TSSDPolicyOwnerId2_Default(et,bCreate,bTempMode);

        return super.onTestValueRule( strDEFieldName, strRule, et,bCreate, bTempMode);
    }

    /**
     * 判断值规则[任务时刻策略所有者标识][默认规则]
     * @param et 当前数据对象
    ...
    protected String onTestValueRule_TSSDPolicyOwnerId_Default(IEntity et,boolean bCreate,boolean bTempMode) throws Exception {
        try {
            if((checkFieldStringLengthRule("TSSDPOLICYOWNERID", et, bTempMode,null,false,100,true,"内容长度必须小于等于[100]")))
                return null;
    ...
    protected String onTestValueRule_TSSDPolicyOwnerName_Default(IEntity et,boolean bCreate,boolean bTempMode) throws Exception {
        try {
            if((checkFieldStringLengthRule("TSSDPOLICYOWNERNAME", et, bTempMode,null,false,200,true,"内容长度必须小于等于[200]")))
                return null;
    ...
    protected String onTestValueRule_TSSDPolicyOwnerType_Default(IEntity et,boolean bCreate,boolean bTempMode) throws Exception {
        try {
            if((checkFieldStringLengthRule("TSSDPOLICYOWNERTYPE", et, bTempMode,null,false,100,true,"内容长度必须小于等于[100]")))
                return null;
            return "内容长度必须小于等于[100]";
        } catch(Exception ex) {
            return ex.getMessage();
    ...
    protected String onTestValueRule_TSSDPolicyOwnerId2_Default(IEntity et,boolean bCreate,boolean bTempMode) throws Exception {
        try {
            if((checkFieldStringLengthRule("TSSDPOLICYOWNERID2", et, bTempMode,null,false,100,true,"内容长度必须小于等于[100]")))
                return null;
            return "内容长度必须小于等于[100]";
        } catch(Exception ex) {
            return ex.getMessage();
