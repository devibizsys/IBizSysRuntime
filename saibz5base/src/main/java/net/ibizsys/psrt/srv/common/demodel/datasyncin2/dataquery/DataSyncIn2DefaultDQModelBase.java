...
@DEDataQueryCodes({
    @DEDataQueryCode(querycode="SELECT t1.CREATEDATE AS CREATEDATE, t1.CREATEMAN AS CREATEMAN, t1.DATAKEY AS DATAKEY, t1.DATASYNCIN2ID AS DATASYNCIN2ID, t1.DATASYNCIN2NAME AS DATASYNCIN2NAME, t1.DEID AS DEID, t1.DENAME AS DENAME, t1.ERROR AS ERROR, t1.EVENTTYPE AS EVENTTYPE, t1.FILEFLAG AS FILEFLAG, t1.SYNCAGENT AS SYNCAGENT, t1.UPDATEDATE AS UPDATEDATE, t1.UPDATEMAN AS UPDATEMAN FROM T_SRFDATASYNCIN2 t1 ",querycodetemp="",declarecode="",dbtype="DB2",
    fieldexps={
    ...
    conds={}),
    @DEDataQueryCode(querycode="SELECT t1.`CREATEDATE` AS `CREATEDATE`, t1.`CREATEMAN` AS `CREATEMAN`, t1.`DATAKEY` AS `DATAKEY`, t1.`DATASYNCIN2ID` AS `DATASYNCIN2ID`, t1.`DATASYNCIN2NAME` AS `DATASYNCIN2NAME`, t1.`DEID` AS `DEID`, t1.`DENAME` AS `DENAME`, t1.`ERROR` AS `ERROR`, t1.`EVENTTYPE` AS `EVENTTYPE`, t1.`FILEFLAG` AS `FILEFLAG`, t1.`SYNCAGENT` AS `SYNCAGENT`, t1.`UPDATEDATE` AS `UPDATEDATE`, t1.`UPDATEMAN` AS `UPDATEMAN` FROM `T_SRFDATASYNCIN2` t1 ",querycodetemp="",declarecode="",dbtype="MYSQL5",
    fieldexps={
        @DEDataQueryCodeExp(name="DATA",expression="t1.`DATA`")
        ,@DEDataQueryCodeExp(name="LOGICDATA",expression="t1.`LOGICDATA`")
        ,@DEDataQueryCodeExp(name="CREATEDATE",expression="t1.`CREATEDATE`")
    ...
    conds={}),
    @DEDataQueryCode(querycode="SELECT t1.CREATEDATE AS CREATEDATE, t1.CREATEMAN AS CREATEMAN, t1.DATAKEY AS DATAKEY, t1.DATASYNCIN2ID AS DATASYNCIN2ID, t1.DATASYNCIN2NAME AS DATASYNCIN2NAME, t1.DEID AS DEID, t1.DENAME AS DENAME, t1.ERROR AS ERROR, t1.EVENTTYPE AS EVENTTYPE, t1.FILEFLAG AS FILEFLAG, t1.SYNCAGENT AS SYNCAGENT, t1.UPDATEDATE AS UPDATEDATE, t1.UPDATEMAN AS UPDATEMAN FROM T_SRFDATASYNCIN2 t1 ",querycodetemp="",declarecode="",dbtype="ORACLE",
    fieldexps={
        @DEDataQueryCodeExp(name="DATA",expression="t1.DATA")
        ,@DEDataQueryCodeExp(name="LOGICDATA",expression="t1.LOGICDATA")
        ,@DEDataQueryCodeExp(name="CREATEDATE",expression="t1.CREATEDATE")
    ...
    conds={}),
    @DEDataQueryCode(querycode="SELECT t1.[CREATEDATE] AS [CREATEDATE], t1.[CREATEMAN] AS [CREATEMAN], t1.[DATAKEY] AS [DATAKEY], t1.[DATASYNCIN2ID] AS [DATASYNCIN2ID], t1.[DATASYNCIN2NAME] AS [DATASYNCIN2NAME], t1.[DEID] AS [DEID], t1.[DENAME] AS [DENAME], t1.[ERROR] AS [ERROR], t1.[EVENTTYPE] AS [EVENTTYPE], t1.[FILEFLAG] AS [FILEFLAG], t1.[SYNCAGENT] AS [SYNCAGENT], t1.[UPDATEDATE] AS [UPDATEDATE], t1.[UPDATEMAN] AS [UPDATEMAN] FROM [T_SRFDATASYNCIN2] t1 ",querycodetemp="",declarecode="",dbtype="SQLSERVER",
    fieldexps={
        @DEDataQueryCodeExp(name="DATA",expression="t1.[DATA]")
        ,@DEDataQueryCodeExp(name="LOGICDATA",expression="t1.[LOGICDATA]")
        ,@DEDataQueryCodeExp(name="CREATEDATE",expression="t1.[CREATEDATE]")
