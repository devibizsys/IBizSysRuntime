...
@DEDataQuery(id="04008F5E-55CA-4B7D-84AF-FA4CC7357A05",name="CurOrg")
@DEDataQueryCodes({
 ...
 *  实体数据查询 [当前组织]模型基类
 */
public abstract class OrgUserCurOrgDQModelBase extends net.ibizsys.paas.demodel.DEDataQueryModelBase {

    public OrgUserCurOrgDQModelBase() {
        super();

        this.initAnnotation(OrgUserCurOrgDQModelBase.class);
    }
