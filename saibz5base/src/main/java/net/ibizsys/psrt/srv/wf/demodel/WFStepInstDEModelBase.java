...
import net.ibizsys.psrt.srv.wf.demodel.wfstepinst.ac.*;
import net.ibizsys.psrt.srv.wf.demodel.wfstepinst.dataset.*;
import net.ibizsys.psrt.srv.wf.demodel.wfstepinst.dataquery.*;

import net.ibizsys.psrt.srv.wf.entity.WFStepInst;
import net.ibizsys.psrt.srv.wf.service.WFStepInstService;

/**
 * 实体[WFSTEPINST]模型对象基类
 */
public abstract class WFStepInstDEModelBase extends net.ibizsys.paas.demodel.DataEntityModelBase<WFStepInst>  {
    ...
    */
    ...
    protected void onFillFetchQuickSearchConditions(DEDataSetCond groupCondImpl,String strQuickSearch)  throws Exception {
        ...
        //放入属性 WFSTEPINSTNAME - 工作流步骤子实例名称
        if(true) {
            DEDataSetCond deDataSetCondImpl = new DEDataSetCond();
            deDataSetCondImpl.setCondType(IDEDataSetCond.CONDTYPE_DEFIELD);
            deDataSetCondImpl.setCondOp(ICondition.CONDOP_LIKE);
            deDataSetCondImpl.setDEFName(WFStepInst.FIELD_WFSTEPINSTNAME);
