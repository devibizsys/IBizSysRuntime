...
@DEDataQueryCodes({
    @DEDataQueryCode(querycode="SELECT t1.CREATEDATE AS CREATEDATE, t1.CREATEMAN AS CREATEMAN, t1.UPDATEDATE AS UPDATEDATE, t1.UPDATEMAN AS UPDATEMAN, t1.WFACTORID AS WFACTORID, t1.WFACTORNAME AS WFACTORNAME, t1.WFACTORPARAM AS WFACTORPARAM, t1.WFACTORPARAM2 AS WFACTORPARAM2, t1.WFACTORTYPE AS WFACTORTYPE FROM T_SRFWFACTOR t1 ",querycodetemp="",declarecode="",dbtype="DB2",
    fieldexps={
    ...
    conds={}),
    @DEDataQueryCode(querycode="SELECT t1.CREATEDATE AS CREATEDATE, t1.CREATEMAN AS CREATEMAN, t1.UPDATEDATE AS UPDATEDATE, t1.UPDATEMAN AS UPDATEMAN, t1.WFACTORID AS WFACTORID, t1.WFACTORNAME AS WFACTORNAME, t1.WFACTORPARAM AS WFACTORPARAM, t1.WFACTORPARAM2 AS WFACTORPARAM2, t1.WFACTORTYPE AS WFACTORTYPE FROM T_SRFWFACTOR t1 ",querycodetemp="",declarecode="",dbtype="MYSQL5",
    fieldexps={
        @DEDataQueryCodeExp(name="PARAMS",expression="t1.PARAMS")
        ,@DEDataQueryCodeExp(name="CREATEDATE",expression="t1.CREATEDATE")
        ,@DEDataQueryCodeExp(name="CREATEMAN",expression="t1.CREATEMAN")
    ...
    conds={}),
    @DEDataQueryCode(querycode="SELECT t1.CREATEDATE AS CREATEDATE, t1.CREATEMAN AS CREATEMAN, t1.UPDATEDATE AS UPDATEDATE, t1.UPDATEMAN AS UPDATEMAN, t1.WFACTORID AS WFACTORID, t1.WFACTORNAME AS WFACTORNAME, t1.WFACTORPARAM AS WFACTORPARAM, t1.WFACTORPARAM2 AS WFACTORPARAM2, t1.WFACTORTYPE AS WFACTORTYPE FROM T_SRFWFACTOR t1 ",querycodetemp="",declarecode="",dbtype="ORACLE",
    fieldexps={
        @DEDataQueryCodeExp(name="PARAMS",expression="t1.PARAMS")
        ,@DEDataQueryCodeExp(name="CREATEDATE",expression="t1.CREATEDATE")
        ,@DEDataQueryCodeExp(name="CREATEMAN",expression="t1.CREATEMAN")
    ...
    conds={}),
    @DEDataQueryCode(querycode="SELECT t1.CREATEDATE AS CREATEDATE, t1.CREATEMAN AS CREATEMAN, t1.UPDATEDATE AS UPDATEDATE, t1.UPDATEMAN AS UPDATEMAN, t1.WFACTORID AS WFACTORID, t1.WFACTORNAME AS WFACTORNAME, t1.WFACTORPARAM AS WFACTORPARAM, t1.WFACTORPARAM2 AS WFACTORPARAM2, t1.WFACTORTYPE AS WFACTORTYPE FROM T_SRFWFACTOR t1 ",querycodetemp="",declarecode="",dbtype="SQLSERVER",
    fieldexps={
        @DEDataQueryCodeExp(name="PARAMS",expression="t1.PARAMS")
        ,@DEDataQueryCodeExp(name="CREATEDATE",expression="t1.CREATEDATE")
        ,@DEDataQueryCodeExp(name="CREATEMAN",expression="t1.CREATEMAN")
