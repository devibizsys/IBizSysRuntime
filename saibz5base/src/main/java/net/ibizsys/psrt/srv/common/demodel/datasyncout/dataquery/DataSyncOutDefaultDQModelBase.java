...
@DEDataQueryCodes({
    @DEDataQueryCode(querycode="SELECT t1.CREATEDATE AS CREATEDATE, t1.CREATEMAN AS CREATEMAN, t1.DATAKEY AS DATAKEY, t1.DATASYNCOUTID AS DATASYNCOUTID, t1.DATASYNCOUTNAME AS DATASYNCOUTNAME, t1.DEID AS DEID, t1.DENAME AS DENAME, t1.EVENTTYPE AS EVENTTYPE, t1.SYNCAGENT AS SYNCAGENT, t1.UPDATEDATE AS UPDATEDATE, t1.UPDATEMAN AS UPDATEMAN FROM T_SRFDATASYNCOUT t1 ",querycodetemp="",declarecode="",dbtype="DB2",
    fieldexps={
    ...
    conds={}),
    @DEDataQueryCode(querycode="SELECT t1.CREATEDATE AS CREATEDATE, t1.CREATEMAN AS CREATEMAN, t1.DATAKEY AS DATAKEY, t1.DATASYNCOUTID AS DATASYNCOUTID, t1.DATASYNCOUTNAME AS DATASYNCOUTNAME, t1.DEID AS DEID, t1.DENAME AS DENAME, t1.EVENTTYPE AS EVENTTYPE, t1.SYNCAGENT AS SYNCAGENT, t1.UPDATEDATE AS UPDATEDATE, t1.UPDATEMAN AS UPDATEMAN FROM T_SRFDATASYNCOUT t1 ",querycodetemp="",declarecode="",dbtype="MYSQL5",
    fieldexps={
        @DEDataQueryCodeExp(name="DATA",expression="t1.DATA")
        ,@DEDataQueryCodeExp(name="FILELIST",expression="t1.FILELIST")
        ,@DEDataQueryCodeExp(name="LOGICDATA",expression="t1.LOGICDATA")
    ...
    conds={}),
    @DEDataQueryCode(querycode="SELECT t1.CREATEDATE AS CREATEDATE, t1.CREATEMAN AS CREATEMAN, t1.DATAKEY AS DATAKEY, t1.DATASYNCOUTID AS DATASYNCOUTID, t1.DATASYNCOUTNAME AS DATASYNCOUTNAME, t1.DEID AS DEID, t1.DENAME AS DENAME, t1.EVENTTYPE AS EVENTTYPE, t1.SYNCAGENT AS SYNCAGENT, t1.UPDATEDATE AS UPDATEDATE, t1.UPDATEMAN AS UPDATEMAN FROM T_SRFDATASYNCOUT t1 ",querycodetemp="",declarecode="",dbtype="ORACLE",
    fieldexps={
        @DEDataQueryCodeExp(name="DATA",expression="t1.DATA")
        ,@DEDataQueryCodeExp(name="FILELIST",expression="t1.FILELIST")
        ,@DEDataQueryCodeExp(name="LOGICDATA",expression="t1.LOGICDATA")
    ...
    conds={}),
    @DEDataQueryCode(querycode="SELECT t1.CREATEDATE AS CREATEDATE, t1.CREATEMAN AS CREATEMAN, t1.DATAKEY AS DATAKEY, t1.DATASYNCOUTID AS DATASYNCOUTID, t1.DATASYNCOUTNAME AS DATASYNCOUTNAME, t1.DEID AS DEID, t1.DENAME AS DENAME, t1.EVENTTYPE AS EVENTTYPE, t1.SYNCAGENT AS SYNCAGENT, t1.UPDATEDATE AS UPDATEDATE, t1.UPDATEMAN AS UPDATEMAN FROM T_SRFDATASYNCOUT t1 ",querycodetemp="",declarecode="",dbtype="SQLSERVER",
    fieldexps={
        @DEDataQueryCodeExp(name="DATA",expression="t1.DATA")
        ,@DEDataQueryCodeExp(name="FILELIST",expression="t1.FILELIST")
        ,@DEDataQueryCodeExp(name="LOGICDATA",expression="t1.LOGICDATA")
