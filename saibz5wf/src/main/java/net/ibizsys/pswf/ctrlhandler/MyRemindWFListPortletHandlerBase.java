...
public abstract class MyRemindWFListPortletHandlerBase extends CustomPortletHandlerBase
{
	...
	protected AjaxActionResult onFetch() throws Exception
	{
		...
		sql.append(" select t1.*,t4.WFWORKFLOWID,t4.WFWORKFLOWNAME,t5.WFPLOGICNAME,t5.WFSTEPNAME,t3.USERDATA4,t6.WFUSERNAME from t_srfwfreminder t1 " +
				" inner join t_srfwfstepactor t2 on t1.WFSTEPACTORID = t2.WFSTEPACTORID " +
				" inner join t_srfwfinstance t3 on t2.WFSTEPID = t3.ACTIVESTEPID " +
				" inner join T_SRFWFWORKFLOW t4 on t3.WFWORKFLOWID = t4.WFWORKFLOWID " +
				" inner join T_SRFWFSTEP t5 on t5.WFSTEPID = t2.WFSTEPID " +
				" inner join T_SRFWFUSER t6 on t6.WFUSERID = t1.WFUSERID " +
