...
public class WFTraceChartPage extends Page
{
	...
	protected void onInit() throws Exception
	{
		...
		sql.append("select t1.* from t_srfwfstep t1 " +
				" where t1.WFINSTANCEID =?   order by t1.tracestep " );
		...
		{
			if(!DataObject.getBoolValue(iEntity,WFStep.FIELD_ISINTERACTIVE,false))
				continue;
