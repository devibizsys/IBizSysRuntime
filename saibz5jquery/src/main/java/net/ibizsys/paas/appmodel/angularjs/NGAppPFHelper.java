...
public class NGAppPFHelper extends AppPFHelperBase
{
	...
	/* (non-Javadoc)
	 * @see net.ibizsys.paas.appmodel.AppModeHelperBase#onFillAppViewJSONObject(net.ibizsys.paas.appmodel.IAppViewModel, net.sf.json.JSONObject)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.ibizsys.paas.appmodel.AppPFHelperBase#mapRealAppUrl(java.lang.String)
	 */
	@Override
