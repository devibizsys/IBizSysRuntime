...
public class DRBarJSTreeRender extends JSTreeRenderBase implements IDRBarRender
{
	...
	/* (non-Javadoc)
	 * @see net.ibizsys.paas.ctrlhandler.IDRBarRender#fillFetchResult(net.ibizsys.paas.ctrlmodel.IDRBarModel, net.ibizsys.paas.web.MDAjaxActionResult)
	 */
	@Override
	...
	public static JSONObject toJSONObject(IDRBarModel iDRBarModel,IDRCtrlItem iExpBarItem,JSONObject jsonObject)throws Exception
	{
		...
		jsonObject.put(TREENODE_TEXT, iExpBarItem.getText());
