...
{
	/* (non-Javadoc)
	 * @see net.ibizsys.paas.ctrlhandler.ITreeRender#getNodeId(net.ibizsys.paas.web.IWebContext)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.ibizsys.paas.ctrlhandler.ITreeRender#fillFetchResult(net.ibizsys.paas.ctrlmodel.ITreeModel, net.ibizsys.paas.web.MDAjaxActionResult, net.ibizsys.paas.control.tree.ITreeNode)
	 */
	@Override
	...
	//	jsonObject.put(TREENODE_TEXTCLS, iTreeNode.getTextCls());
		if(!StringHelper.isNullOrEmpty(iTreeNode.getIconCssClass()))
		{
			...
			if(!StringHelper.isNullOrEmpty(iTreeNode.getIcon()))
			{
